...
if(isset($_POST['submit'])){
	...
	if(count($YearArr)>0){
		foreach($YearArr as $Key => $Value){
			...
			$IndId	= $IndIdArr[$Key];
			if($IndId == ""){
				$InsertQuery	=  "insert into monthly_index set year = '$Year', matid = '', mat_code = '$DescId', mat_category = '10CA', jan = '$Jan', feb = '$Feb', mar = '$Mar', 
				...
				$InsertQuery	=  "update monthly_index set year = '$Year', matid = '', mat_code = '$DescId', mat_category = '10CA', jan = '$Jan', feb = '$Feb', mar = '$Mar', 
									apr = '$Apr', may = '$May', jun = '$Jun', jul = '$Jul', aug = '$Aug', sep = '$Sep', oct = '$Oct', nov = '$Nov', dece = '$Dec', 
...
$RowCount = 0;
$SelectQuery1 = "select a.*, b.mat_desc from monthly_index a inner join material b on (a.mat_code = b.mat_code) where a.mat_category = '10CA' order by a.year desc";
									...
									<tr class="irow">
										...
										<td  class="labeldisplay">
											<select name="cmb_description0" id="cmb_description0" class="TextBoxDy">
												<option value="">----Select----</option>
												<?php echo $objBind->BindEscMaterial('','10CA','ALL'); ?>
											</select>
										</td>
