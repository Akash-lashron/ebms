...
if($_POST["html"] == "Generate") { 
		...
		$is_finalbill = ($_POST['rad_finalbill']);
	...
	$_SESSION["rbn"] = $rbn;
    header('Location: AbstMBook_Final_Bill.php'); }
?>
...
<div class="container">
  <table width="1000"  bgcolor="#E8E8E8" border="0" cellpadding="0" cellspacing="0" align="center" >
	...
	<!-- <tr>
        <td>&nbsp;</td>
        <td  class="label">Is Final Bill </td>
        <td  class="labeldisplay">
		<input type="radio" name="rad_finalbill" id="rad_finalbill_yes" value="Y" > Yes
		<input type="radio" name="rad_finalbill" id="rad_finalbill_no" value="N" checked="checked"> No
		</td>
		<td>&nbsp;</td>
		<td>&nbsp;</td>
	</tr>
