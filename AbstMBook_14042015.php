...
$msg = '';
$abstsheetid=$_SESSION["abstsheetid"]; $abstmbno=$_SESSION["abstmbno"];$abstmbpage=$_SESSION["abstmbpage"];
...
FROM   sheet WHERE sheet_id ='$abstsheetid' ";
//echo $query;
...
?>
            ...
            <table width='100%'   border='1' cellpadding='0' cellspacing='0' align='left'id='mbookdetail'>
               ...
               $TotalValue =0;$TotalDeduct=0;$TotalSinceLast=0;$linenumber=0;
  ...
  <td  align='right' width='90' class='labelboldright'><?php echo number_format((($lastMeasurement+$previousquantity)* $schduledt[0]), 2, '.', ''); ?></td>
  ...
  <td  align='right' width='100' class='labelboldright'><?php if($runn_acc_bill_no  > 1) { echo $previousquantity * $schduledt[0]; }?></td>
  <td  align='right' width='80' class='labelboldright'> <?php echo $currentqty;?><?php //echo number_format($mbtotal, 3, '.', '');?></td>
  <td  align='right' width='80' class='labelboldright'><?php echo number_format(($lastMeasurement * $schduledt[0]), 2, '.', ''); ?><?php //$value=(number_format($BR, 2, '.', '') - number_format($BR, 2, '.', '')); echo  number_format($value, 2, '.', '');?></td>
  <td  align='left' width='80' class='labelboldright'></td>
</tr>
...
<tr>
  ...
  <td  align='right' width='90' class='labelsmall'><?php echo  number_format($TotalValue, 2, '.', '');  ?></td>
...
<!--                  <div class="right"> <p><b>page:<?php //echo $pages; ?> </b></p>     </div>-->
  ...
  <td  align='left' width='80' class='labelsmall'>&nbsp;</td>
                            ...
                            $T =$T + number_format((($lastMeasurement+$previousquantity)) , 2, '.', '');
                            $SinceLast = $SinceLast +($lastMeasurement * $schduledt[0]);
                            $sdivid = $List->subdivid;
                            $mbtotal = $List->mbtotal;
                            $pageno++; $linenumber++;
                            $DeductpreviousQty =$DeductpreviousQty+$previousquantity;
                            $DeductpreviousAmt =$DeductpreviousAmt+($previousquantity * $schduledt[0]);
                        }
                    }
                    ?>
                                  <tr>
  <td  align='left' width='61'   class='labelboldright '></td>
  <td  align='left' width='160'   class='labelboldright'bgcolor="#00CCFF">Total</td>
  ...
  <td  align='right' width='75'  class='labelboldright'><?php echo $schduledt[0];?></td>
  <td  align='left' width='50' class='labelboldright'><?php echo $schduledt[1];?></td>
  <td  align='right' width='90' class='labelsmall'><?php echo  number_format($Total, 2, '.', '');  ?></td>
  <td  align='left' width='100' class='labelsmall'></td>
  <td  align='left' width='100' class='labelsmall'><?php echo $DeductpreviousQty;?></td>
  <td  align='right' width='100' class='labelsmall'><?php echo number_format($DeductpreviousAmt, 2, '.', '');  ?></td>
  <td  align='left' width='80' class='labelsmall'>&nbsp;</td>
  <td  align='right' width='80' class='labelsmall'><?php echo  number_format($Total, 2, '.', '');  ?></td>
  <td  align='left' width='80' class='labelsmall'>&nbsp;</td>
</tr>
                 <tr>
  <td  align='left' width='60'   class='labelsmall'>&nbsp;</td>
  ...
  <td  align='left' width='75'  class='labelsmall'>&nbsp;</td>
  <td  align='left' width='50' class='labelsmall'>&nbsp;</td>
  <td  align='right' width='90' class='labelsmall' bgcolor="#F781F3"><?php  $TotalValueCost= number_format($T, 2, '.', ''); echo $T;//number_format($TotalValue, 2, '.', '');  ?></td>
  <td  align='left' width='80' class='labelsmall'>&nbsp;</td>
  <td  align='left' width='100' class='labelsmall'>&nbsp;</td>
  <td  align='right' width='100' class='labelsmall'><?php echo "0.00"; ?></td>
  <td  align='left' width='80' class='labelsmall'>&nbsp;</td>
  <td  align='right' width='80' class='labelsmall' bgcolor="#F781F3"><?php $TotalDeductCost =number_format($SinceLast, 2, '.', ''); echo  $SinceLast;//;number_format($TotalDeduct, 2, '.', '');  ?></td>
  <td  align='left' width='80' class='labelsmall'>&nbsp;</td>
</tr> 
                                 <tr>
  <td  align='left' width='60'   class='labelsmall'>&nbsp;</td>
  ...
  <td  align='left' width='75'  class='labelsmall'>&nbsp;</td>
  <td  align='left' width='50' class='labelsmall'>&nbsp;</td>
  <td  align='right' width='90' class='labelsmall' bgcolor="#F5A9A9"><?php $LessOverallRebateValue =number_format($T, 2, '.', '') * 0.005; echo  $LessOverallRebateValue;  ?></td>
  <td  align='left' width='80' class='labelsmall'>&nbsp;</td>
  <td  align='left' width='100' class='labelsmall'>&nbsp;</td>
  <td  align='right' width='100' class='labelsmall'><?php echo "0.00"; ?></td>
  <td  align='left' width='80' class='labelsmall'>&nbsp;</td>
  <td  align='right' width='80' class='labelsmall' bgcolor="#F5A9A9"><?php  $LessOverallRebateDeduct = number_format($T, 2, '.', '') * 0.005;  echo  $LessOverallRebateDeduct; ?></td>
  <td  align='left' width='80' class='labelsmall'>&nbsp;</td>
</tr> 
                                 <tr>
  <td  align='left' width='60'   class='labelsmall'>&nbsp;</td>
  ...
  <td  align='right' width='100' class='labelsmall'><?php echo "0.00"; ?></td>
  <td  align='left' width='80' class='labelsmall'>&nbsp;</td>
  <td  align='right' width='80' class='labelsmall'  bgcolor="#A9D0F5"><?php echo  number_format($TotalDeductCost - $LessOverallRebateDeduct, 2, '.', '');?></td>
  <td  align='left' width='80' class='labelsmall'>&nbsp;</td>
</tr> 
