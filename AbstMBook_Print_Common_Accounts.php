...
<?php if($prev_item_flag == "NI"){ ?>
		...
		?>
		<tr class="labelprint">
			<td colspan="3" align="right">Less Over All Rebate : <?php echo $SuppRebateperc; ?>%&nbsp; <i class='fa fa-inr' style=' width:4px; height:5px; font-weight:normal;'></i>&nbsp;&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
