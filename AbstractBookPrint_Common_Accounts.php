...
if($_POST["submit"] == " View ") 
{
	...
	header('Location: AbstMBook_Print_Common_Accounts.php?workno='.$workno); 
}
            ...
            <div class="container_12">
                <div class="grid_12">
                    <blockquote class="bq1">
                        <div class="title">Abstract Measurement Book-View</div>
                 ...
                 <tr>
					...
					<option value="">---------------------------------Select---------------------------------</option>
						...
						<?php echo $objBind->BindWorkOrderNo_ACCOUNTS(0); ?>
					</select></td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
				...
				<!--<tr>
                    <td>&nbsp;</td>
                    <td  class="label">No. of empty page to print </td>
                    <td  class="labeldisplay">
					<input type="text" name="txt_empty_page" id="txt_empty_page" value="" class="textboxdisplay" style="width:400px;"/>
					</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
                <tr><td>&nbsp;</td><td></td><td id="val_emptypage" style="color:red"></td></tr>-->
               <!-- <tr> 
                    <td>&nbsp;</td> 
