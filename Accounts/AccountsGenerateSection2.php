...
$sheetid = 2;//$_SESSION['sheetid'];
$rbn_sec = 8;//$_SESSION['rbn_sec'];
...
<script>
	...
	$(function(){
		...
		$.fn.checkdate = function(event) { 
			//var wordordernovalue = document.form.wordorderno.value; //alert();
...
<script>
var page = "MBKG";
var page_url = "AccountsGenerateSection3.php";
var bg = bg || false;
if(!bg){
								...
								<div data-wizard-init>
								 ...
								 <div class="steps-content" align="center" id="printSection">
									...
									<table width="100%" class="tableA" align="center">	
										<tr>
											<td colspan="2" align="center">BARCF - Accounts Section (Works), NRB, FRFCF, Kalpakkam</td>
										</tr>
										<tr>
										...
										<tr class="label">
											...
											<td align="left" style="white-space:normal"><?php echo $work_name; ?> </td>
										</tr>
										<tr class="label">
											<td align="left">Technical Sanction No.</td>
											<td align="left"><?php echo $tech_sanction; ?> </td>
										</tr>
										<tr class="label">
										...
										<tr class="label">
											<td align="left" style="border-right:none;">CGST <span style="float:right">Rs.</span></td>
											<td align="left" style="border-left:none;"> <div style="width:175px; text-align:right"><?php echo IND_money_format($cgst_amt); ?></div></td>
										</tr>
										<tr class="label">
											<td align="left" style="border-right:none;">SGST <span style="float:right">Rs.</span></td>
											<td align="left" style="border-left:none;"> <div style="width:175px; text-align:right"><?php echo IND_money_format($sgst_amt); ?></div></td>
										</tr>
										<tr class="label">
											<td align="left" style="border-right:none;">Income Tax <span style="float:right">Rs.</span></td>
											<td align="left" style="border-left:none;"> <div style="width:175px; text-align:right"><?php echo IND_money_format($incometax_amt); ?></div></td>
										</tr>
									
										<!--<tr class="label">
											<td align="left" style="border-right:none;">Surcharge on IT <span style="float:right">Rs.</span></td>
											<td align="left" style="border-left:none;"> <div style="width:175px; text-align:right"><?php //echo $incometax_amt; ?></div></td>
										</tr>-->
									
										<tr class="label">
											<td align="left" style="border-right:none;">Cess on IT & SC <span style="float:right">Rs.</span></td>
											<td align="left" style="border-left:none;"> <div style="width:175px; text-align:right"><?php echo IND_money_format($it_cess_amt); ?></div></td>
										</tr>
										
										<tr class="label">
											<td align="left" style="border-right:none;">HCESS on IT & SC  <span style="float:right">Rs.</span></td>
											<td align="left" style="border-left:none;"> <div style="width:175px; text-align:right"><?php echo IND_money_format($it_edu_amt); ?></div></td>
										</tr>
										<tr class="label">
											<td align="left" style="border-right:none;">Labour Welfare Cess:  <span style="float:right">Rs.</span></td>
											<td align="left" style="border-left:none;"> <div style="width:175px; text-align:right"><?php echo IND_money_format($lw_cess_amt); ?></div></td>
										</tr>
										<tr class="label">
											<td align="left" style="border-right:none;">Int on Mobi Adv:  <span style="float:right">Rs.</span></td>
											<td align="left" style="border-left:none;"> <div style="width:175px; text-align:right"><?php echo IND_money_format($mob_adv_amt); ?></div></td>
										</tr>
										<tr class="label">
											<td align="left" style="border-right:none;">Security Deposit:  <span style="float:right">Rs.</span></td>
											<td align="left" style="border-left:none;"> <div style="width:175px; text-align:right"><?php echo IND_money_format($sd_amt); ?></div></td>
										</tr>
										<tr class="label">
										...
										<tr class="label">
											...
											<td align="left" style="border-left:none;"> <div style="width:175px; text-align:right"><?php echo IND_money_format($sec_adv_amount); ?></div></td>
										</tr>
										<tr class="label">
										...
										<tr class="label">
											...
											<td align="left" style="border-left:none;"> <div style="width:175px; text-align:right"><?php echo IND_money_format($electricity_cost); ?></div></td>
										</tr>
										<tr class="label">
											<td align="left" style="border-right:none;">Water Charge (-) <span style="float:right">Rs.</span></td>
											<td align="left" style="border-left:none;"> <div style="width:175px; text-align:right"><?php echo IND_money_format($water_cost); ?></div></td>
										</tr>
										<tr class="label">
											<td align="left" style="border-right:none;">Mobilization Advance Recovery (-) <span style="float:right">Rs.</span></td>
											<td align="left" style="border-left:none;"> <div style="width:175px; text-align:right"><?php echo IND_money_format($mob_adv_amt); ?></div></td>
										</tr>
										<tr class="label">
											<td align="left" style="border-right:none;">Net Total <span style="float:right">Rs.</span></td>
											<td align="left" style="border-left:none;"> <div style="width:175px; text-align:right"><?php echo IND_money_format($NetTotal); ?></div></td>
										</tr>
									</table>
...
$(function() {
	$("#btn_previous1").click(function(){
		...
		var rbn = $('#txt_rbn').val();
		$(location).attr('href', "AccountsGenerateSection1.php?sheetid="+sheetid+"&rbn="+rbn)
	});
