...
<script>
var page = "MBKG";
var page_url = "AccountsGenerateSection5.php";
var bg = bg || false;
if(!bg){
								   ...
								   <style>
									...
									<div data-step="4" align="center">
										<table width="100%" class="tableA" align="center">
											<tr class="label">
												<td colspan="2" align="center">Government Of India<br>Deportment Of Atomic Energy<br>Fast Reactor Fuel Cycle Facility<br>NRB, BARCF</td>
											</tr>
											...
											<tr class="label">
												...
												<td align="left">:&nbsp;&nbsp;<?php echo $NetTotal; ?></td>
											</tr>
...
$(function() {
	$("#btn_previous1").click(function(){
		...
		var rbn = $('#txt_rbn').val();
		$(location).attr('href', "AccountsGenerateSection3.php?sheetid="+sheetid+"&rbn="+rbn)
	});
