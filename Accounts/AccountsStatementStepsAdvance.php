...
$msg = '';
if($_GET['m'] == 1){
	$msg = "75% Payment not created for this RAB..!!";
}
            ...
            <div class="container_12">
                <div class="grid_12">
                    <blockquote class="bq1" style="overflow:auto">
                        ...
                        <form name="form" method="post" action="MopMemoForStatementsAdv.php">
						<div class="row">
										...
										<div class="face-static">
											...
											<div class="card-body padding-1 ChartCard" id="CourseChart">
												<div class="divrowbox pt-2">
													...
													<div class="div12">
														<input type="hidden" name="txt_pay_type" id="txt_pay_type" class="textboxdisplay" value="APAY">
			...
			BootstrapDialog.show({
				...
				buttons: [{
					...
					action: function(dialog1) {
						window.location.href = "AccountsStatementStepsAdvance.php";
					}
				}]
			});
		}
