...
gst_rate = '$gst_rate_acco', gst_rate_civil = '$gst_rate_civil', 
gst_amount = '$gst_amt_acco', gst_amount_civil = '$gst_amt_civil', 
sgst_tds_perc = '$sgst_perc_acco', sgst_tds_perc_civil = '$sgst_perc_civil', 
sgst_tds_amt = '$sgst_acco', sgst_tds_amt_civil = '$sgst_civil', 
cgst_tds_perc = '$cgst_perc_acco', cgst_tds_perc_civil = '$cgst_perc_civil', 
cgst_tds_amt = '$cgst_acco', cgst_tds_amt_civil = '$cgst_civil', 
igst_tds_perc = '$igst_perc_acco', igst_tds_perc_civil = '$igst_perc_civil', 
igst_tds_amt = '$igst_acco', igst_tds_amt_civil = '$igst_civil', 
...
is_ldc_appl = '$is_ldc_acco', is_ldc_appl_civil = '$is_ldc_civil',
pan_type = '$pan_type_acco', pan_type_civil = '$pan_type_civil',
...
/*for($i=0; $i<count($Rec_desc); $i++)
{
	...
	active = '1',
	modifieddate = NOW()";
	$insert_memo_payment_sql = mysqli_query($dbConn,$insert_memo_payment_query);
}
*/
