...
//$ContDetQuery = "SELECT a.*, b.*, a.contid as contid FROM contractor a LEFT JOIN contractor_bank_detail b ON (a.contid = b.contid) WHERE ((b.bk_dt_status = 'DA' AND b.bk_dt_status != 'AAO') OR (b.bk_dt_status IS NULL AND b.bk_dt_status IS NULL)) ORDER BY a.contid ASC";
if($_SESSION['levelid'] >= $DecMinHighLevelAppr){ 
	$ContDetQuery = "SELECT a.*, b.*, a.contid as contid FROM contractor a LEFT JOIN contractor_bank_detail b ON (a.contid = b.contid) WHERE (b.bk_dt_status = 'DA' AND b.bk_dt_conf_status != 'AAO') ORDER BY a.contid ASC";
}else{
	$ContDetQuery = "SELECT a.*, b.*, a.contid as contid FROM contractor a LEFT JOIN contractor_bank_detail b ON (a.contid = b.contid) WHERE (b.bk_dt_status = '' OR b.bk_dt_status IS NULL OR b.bk_dt_conf_status != 'AAO') ORDER BY a.contid ASC";
}
//echo $DecMinHighLevelAppr;exit;
									...
									<div class="div12">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="center">&nbsp;Bidder Details - Waiting For Confirmation</div>
																	...
																	<table width="100%" align="center" class="dataTable table2excel">
																		<thead>
																			<tr>
																				...
																				<th  valign="middle">Contractor Name</th>
																				<th  valign="middle">Contractor Address</th>
																				<th valign="middle">GST No.</th>
																				<th valign="middle">PAN No.</th>
																		...
																		<tbody>
																			...
																			<tr class='labeldisplay'>
																				...
																				<td rowspan= <?php echo $ContRowSpan ?> valign='middle' class='tdrow' align = 'justify'><?php echo $BDValue->addr_contractor; ?></td>
																				...
																				<td rowspan= <?php echo $ContRowSpan ?> valign='middle' class='tdrow' align = 'center'>
																					<input type="button" data-url="Bidders?coneditid=<?php echo $BDValue->contid; ?>&pageid=2" class="BtnHref btn btn-info" Value="View Details">
																				</td>
																			</tr>
																			<?php 
																					$y++;  $SNO++;
												...
												<div align="center"><br/>
													...
													<button type="button" data-url="Bidders" class="btn btn-info BtnHref" id="AddNewBtn" style="">Create New</button>
												</div>
...
$(document).ready(function(){ 
	...
	$(window).load(function() {
		$("#DataTables_Table_0_wrapper").prepend('<button type="button" data-url="Bidders" class="AddNewBtn BtnHref" id="AddNewBtn" style=""><i class="fa fa-plus" style="font-size:13px; padding-top:2px;"></i> Create New</button>');
	});
