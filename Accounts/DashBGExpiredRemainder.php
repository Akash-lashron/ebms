...
WHERE b.inst_type = 'BG' AND b.inst_status != 'R'  AND b.inst_exp_date < '$CurrDate'";
...
if($ImpDetIds != ''){
    ...
    WHERE b.bfdid IN ($ImpDetIds) AND b.inst_type = 'BG' AND b.inst_exp_date < '$CurrDate'
									...
									<div class="div12">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="center">Bank Guarantee Expired Reminder</div>
																...
																<table width="100%" align="center" class="dataTable table2excel mgtb-8">
																	<thead>
																		...
																		<tr>
																			...
																			<th rowspan="2" valign="middle">BG Amount</th>
																			<th colspan="8" valign="middle">BG Detail</th>
																			
																		</tr>
																		<tr>
																			<th valign="middle">BG For</th>
