...
INNER JOIN contractor d ON (b.contid = d.contid) WHERE b.inst_type = 'BG' AND b.status != 'R' AND a.tr_id IN ($TrIdVal)";
									...
									<div class="div10">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="center">EMD-Bank Guarantee Return Reminder</div>
