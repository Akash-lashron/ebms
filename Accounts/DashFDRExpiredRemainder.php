...
WHERE b.inst_type = 'FDR' AND b.inst_status != 'R'  AND b.inst_exp_date < '$CurrDate'";
...
if($ImpTrIds != ''){
$WorkQuery = "SELECT sch_comp_date,work_ext_date FROM works WHERE tr_id IN ($ImpTrIds)";// AND '$CurrDate' <= sch_comp_date + INTERVAL 8 MONTH OR ('$CurrDate' <= work_ext_date + INTERVAL 8 MONTH AND work_ext_date != '0000-00-00' AND work_ext_date IS NOT NULL)";
//echo $WorkQuery;exit;
...
if($ImpDetIds != ''){
	...
	WHERE b.bfdid IN ($ImpDetIds) AND b.inst_type = 'FDR' AND b.inst_exp_date < '$CurrDate'
	ORDER BY c.tr_id  ASC";
									...
									<div class="div12">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="center">FDR Expired Reminder</div>
																...
																<table width="100%" align="center" class="dataTable table2excel mgtb-8">
																	<thead>
																		...
																		<tr>
																			...
																			<th rowspan="2" valign="middle" nowrap="nowrap">CC NO.</th>
																			...
																			<th rowspan="2" valign="middle">FDR Amount</th>
																			<th colspan="8" valign="middle">FDR Detail</th>
																			
																		</tr>
																		<tr>
																			<th valign="middle">FDR For</th>
																	...
																	<tbody>
																		...
																		if($RowCount == 1){ foreach($PGDataArr as $PGkey => $PGValue){ 
																			...
																			$InstDate = "";
																			if(($PGValue->inst_date != "")&&($PGValue->inst_date != null)&&($PGValue->inst_date != "0000-00-00")){
																				$InstDate = dt_display($PGValue->inst_date);
																			}
																			$InstExtenDate = "";
																			if(($PGValue->work_ext_date != "")&&($PGValue->work_ext_date != null)&&($PGValue->work_ext_date != "0000-00-00")){
																				$InstExtenDate = dt_display($PGValue->work_ext_date);
																			}
																			$InstExpDate = "";
																			if(($PGValue->inst_exp_date != "")&&($PGValue->inst_exp_date != null)&&($PGValue->inst_exp_date != "0000-00-00")){
																				$InstExpDate = dt_display($PGValue->inst_exp_date);
																			}
																			$InstSchCompDate = "";
																			if(($PGValue->sch_comp_date != "")&&($PGValue->sch_comp_date != null)&&($PGValue->sch_comp_date != "0000-00-00")){
																				$InstSchCompDate = dt_display($PGValue->sch_comp_date);
																			}
																			if($x == 0){ 
																		?>
																		<tr class='labeldisplay'>
																			<td rowspan= <?php echo $TrRowspan ?> class='tdrowbold' valign='middle' align='center'><?php echo $SNO; ?></td>
																			<td rowspan= <?php echo $TrRowspan ?> valign='middle' class='tdrow' align = 'center'><?php echo $PGValue->ccno; ?></td>
																			...
																			<td rowspan= <?php echo $TrRowspan ?> valign='middle' class='tdrow' align = 'justify'><?php echo $InstSchCompDate; ?></td>
																			<td rowspan= <?php echo $TrRowspan ?> valign='middle' class='tdrow' align = 'justify'><?php echo $InstExtenDate; ?></td>
																			...
																			<td class='tdrow' align='center' valign='middle'><?php echo $PGValue->inst_purpose; ?></td>
																			<td class='tdrow' align='left' valign='middle'><?php echo $PGValue->inst_serial_no; ?></td>
																			<td class='tdrow' align='center' valign='middle'><?php echo $InstDate; ?></td>
																			<td class='tdrow' align='center' valign='middle'><?php echo $InstExpDate; ?></td>
																		...
																		<?php $PrevTrId = $PGValue->tr_id; $PrevContId = $PGValue->contid; } }else{ ?>
																			<tr class='labeldisplay'>
																				<td colspan='14' class='tdrow' align='center' valign='middle'>No Records Found</td>
																			</tr>
																			<?php } ?>
																	</tbody>
																</table>
