...
WHERE b.inst_purpose = 'PG'AND b.inst_type = 'BG' AND b.inst_status != 'R'  AND b.inst_exp_date < '$CurrDate'";
...
if($ImpDetIds != ''){
    ...
    WHERE b.bfdid IN ($ImpDetIds) AND b.inst_type = 'BG' AND b.inst_purpose = 'PG'  AND b.inst_exp_date < '$CurrDate'
									...
									<div class="div12">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="center">PG-Bank Guarantee Expired Reminder</div>
