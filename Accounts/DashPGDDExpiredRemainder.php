...
WHERE b.inst_purpose = 'PG'AND b.inst_type = 'DD' AND b.inst_status != 'R'  AND b.inst_exp_date < '$CurrDate'";
...
if($ImpDetIds != ''){
    ...
    WHERE b.bfdid IN ($ImpDetIds) AND b.inst_type = 'DD' AND b.inst_purpose = 'PG'  AND b.inst_exp_date < '$CurrDate'	ORDER BY c.tr_id  ASC";
