...
if(isset($_POST['btn_save']) == " Save "){
	...
	/*foreach($Hoamastr as $Key => $Value){
		//print_r($Hoamastr);exit;
		$DeletID = 0;
		$Hoamas  = $Value;//$Hoamastr[$Key];
		if(in_array($Hoamas, $ShrtcdIDstr)){
			$DeletID = 1;
		}
		if($DeletID == 0){
			$Deletequery    = "DELETE FROM shortcode_master WHERE shortcode_id='$Hoamas' AND fin_year='$FinYear'";
										...
										<div class="face-static">
											...
											<div class="card-body padding-1 ChartCard" id="CourseChart">
												<div class="divrowbox pt-3">
													...
													<div class="div3 pd-lr-1">
														<div class="lboxlabel-sm">Description Heading</div>
														<div>
														   	<select class="group selectlgbox" name="cmb_desc" id="cmb_desc">
														   		<option value="">---Select---</option>
																<option value="REC">Recovery</option>
																<option value="PAY">Payment</option>
																<option value="REP">Receipt</option>
														   	</select>
														</div>
													</div>
															...
															<div class="card-body padding-1">
																	...
																	<table class="dataTable etable " align="center" width="100%" id="pgtable1">
																		<tr class="label" style="background-color:#FFF">
																			<th align="center">Description Details Main Heading </th>
																			<th align="center">Description Details Sub Heading </th>
																		...
																		<tr>
																			...
																			<td align="center">
																				<select name="cmb_shortcode_<?php echo $MasteID; ?>[]" id ="cmb_shortcode[]"  class="tboxsmclass ShortCode labeldisplay"> 
																					<?php echo $objBind->BindHoaWithFullCode(0); ?>
																				</select>
																			</td>
																			<td align="center">
																				<select name="cmb_shortcode_<?php echo $MasteID; ?>[]" id ="cmb_shortcode[]"  class="tboxsmclass ShortCode labeldisplay"> 
																		...
																		if($rs_date_sql == true){
																			while($List = mysqli_fetch_object($rs_date_sql)){
																				...
																				$slectshort =  "SELECT shortcode_id FROM hoa_master WHERE 
																		...
																		<tr>
																			...
																			if($Flag == "Y"){ 
																			?>
																			<td align="center">Code already Mapped with HOA</td>
																			<?php
																			}else{
																			?>
