									...
									<div class="div12">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="center">&nbsp;EMD Register <span class="ralignbox fright"><span class="xldownload" id="exportToExcel"> Download Excel <i class="fa fa-download"></i> </span></span></div>
												<div class="card-body padding-1 ChartCard" id="CourseChart">
													<div class="divrowbox pt-2">
														<div class="table-responsive dt-responsive ResultTable">
															<div class="table-responsive dt-responsive rtabdiv" id="table-stmt">
																<table id="example" class="display rtable mgtb-8 example" style="width:100%">
																	<thead>
																		<tr>
																			...
																			if($RowCount == 1){ foreach($EmDDataArr as $Emdkey => $EmdValue){ 
																				...
																				?>
																					<tr class='labeldisplay'>
																						...
																						<td rowspan="<?php echo $TrRowspan; ?>" class='tdrow' align='right' valign='middle'>
																						<?php 
																						if($EmdValue->emd_lot_amt == 0){	
																							echo "Emd Exemption";
																						}else{
																							echo round($EmdValue->emd_lot_amt);	//IndianMoneyFormat($EmdValue->emd_lot_amt); 
																						}
																						?>
																						</td> 
																						<td rowspan="<?php echo $ContRowSpan; ?>" class='tdrow' align='left' valign='middle'>
																						<?php 
																						echo $EmdValue->name_contractor; 
																						?>
																						</td>
																						...
																						if($EmdValue->emd_lot_amt == 0){	
																							...
																							echo dt_display($EmdValue->issue_dt); 
																						}
																						?>
																						</td>
																						<td class='tdrow' align='center' valign='middle'>
																						...
																						if($EmdValue->emd_lot_amt == 0){	
																							...
																							echo dt_display($EmdValue->valid_dt); 
																						}
																						?>
																						</td>
																						...
																						if($EmdValue->emd_lot_amt == 0){	
																							...
																							echo round($EmdValue->emd_amt);	//IndianMoneyFormat($EmdValue->emd_amt); 
																						}
																						?>
																						</td>
																						<?php
																						if($EmdValue->emd_lot_amt == 0){
																						?>	
																								<td class='tdrow' align='right' valign='middle' nowrap='nowrap'></td>
																						<?php
																						}else{
																							 if($EmdValue->status == 'R'){ ?>
