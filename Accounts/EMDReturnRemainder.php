...
WHERE a.tr_id = b.tr_id AND a.emd_lot_amt != 0";
...
INNER JOIN contractor d ON (b.contid = d.contid) WHERE b.status != 'R' AND a.tr_id IN ($TrIdVal)";
									...
									<div class="div12">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="center">EMD Release Reminder <span class="ralignbox fright"><span class="xldownload" id="exportToExcel"> Download Excel <i class="fa fa-download"></i> </span></span></div>
																...
																<table width="100%" align="center" class="dataTable table2excel mgtb-8 example">
																	<thead>
																		...
																		<tr>
																			...
																			<th rowspan="2" valign="middle">Bidder's Name</th>
