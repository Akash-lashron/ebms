...
$TRArr=array();
/* $MasterQuery1 = "SELECT a.tr_id, a.globid, a.contid
FROM emd_master a
...
INNER JOIN contractor d ON (a.contid = d.contid) WHERE b.status != 'R' AND a.tr_id IN ($TrIdVal)";*/
$MasterQuery = "SELECT a.*, b.*, c.tr_no, c.work_name, d.name_contractor FROM emd_master a 
INNER JOIN emd_detail b ON (a.emid = b.emid) 
INNER JOIN tender_register c ON (a.tr_id = c.tr_id) 
INNER JOIN contractor d ON (a.contid = d.contid) WHERE b.status = 'R'";
									...
									<div class="div10">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="center">EMD Return Reports</div>
