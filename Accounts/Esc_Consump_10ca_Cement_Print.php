...
if($_POST["submit"] == " View ") 
{
	...
	header('Location: Esc_Consump_10ca_Cement_Print_Page.php?sheetid='.$sheetid.'&quarter='.$quarter);
}
  ...
  <!--==============================Content=================================-->
        <div class="content">
   		...
   		<div style="text-align:center; height:45px; line-height:45px;" class="printbutton">
			...
			<input type="submit" class="btn btn-info" data-type="submit" value=" View " name="submit" id="submit"/>
			</div>
		</div>
        </form>
      </blockquote>
