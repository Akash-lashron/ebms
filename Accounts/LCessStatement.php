...
if(isset($_POST['btn_view'])){
	...
	if(($FromToDateVal == 2) && ($YearMonthVal == 2)){
		...
		if($FromToDateVal == 2){
			$sql_date= "SELECT * FROM memo_payment_accounts_edit WHERE lw_cess_amt != 0 AND payment_dt BETWEEN '" . $fromdt . "' and '" . $todt . "' ORDER BY payment_dt ASC;";
			//"select * from memo_payment_accounts_edit where alloted_place='" . $name . "' and 
			//			checkin_date between '" . $fromdt . "' and '" . $todt . "'";
			$heading= 'BETWEEN ' . dt_display($fromdt) . ' AND ' . dt_display($todt);
		}
		if($YearMonthVal == 2){
			if($month == 'ALL'){
				$sql_date = "SELECT * FROM memo_payment_accounts_edit WHERE lw_cess_amt != 0 AND YEAR(payment_dt) =" . $year . " ORDER BY payment_dt ASC;";
				//$mon=strtoupper(date("M",mktime(0,0,0,($month+1),0,0)));
				$heading='FOR - '. $year;	
			}else{
				$sql_date = "SELECT * FROM memo_payment_accounts_edit WHERE lw_cess_amt != 0 AND MONTH(payment_dt)=" . $month . " AND YEAR(payment_dt) =" . $year ." ORDER BY payment_dt ASC;";
				$mon=strtoupper(date("M",mktime(0,0,0,($month+1),0,0)));
				$heading='FOR - ' . $mon . '/' . $year;	
			}
		}
									...
									<div class="div6">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="center">LABOUR CESS RECOVERY STATEMENT</div>
							...
							<div class="row">
								...
								<div class="box-container box-container-lg">
									<div class="div12">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="left">&nbsp;Labour Cess Recovery Statement <span id="CourseChartDuration"></span></div>
												<div class="card-body padding-1 ChartCard" id="CourseChart">
													<div class="divrowbox pt-2">
									...
									<div class="div12" id="appendrow">
										<div class="card cabox">
											<div class="face-static">
												...
												<div class="card-header inkblue-card" align="center">LABOUR CESS RECOVERY STATEMENT <?php echo $heading; ?> <span class="ralignbox fright"><span class="xldownload" id="exportToExcel"> Download Excel <i class="fa fa-download"></i> </span></span></div>
												<div class="card-body padding-1 ChartCard" id="CourseChart">
													<div class="divrowbox pt-2">
														<div class="table-responsive dt-responsive ResultTable">
																...
																<?php if($report==true){ ?>
																	...
																	<table class="table dataTable rtable table2excel example" border="1" width="100%" align="center">
																		<tr>
																			...
																			<td class="colhead">NAME OF WORK</td>
																			<td class="colhead">DATE OF PAYMENT</td>
																			<td class="colhead">BILL VALUE</td>
																			<td class="colhead">LABOUR CESS AMOUNT</td>
																		</tr>
																			<?php
																			$TotSumBillVal = 0;
																			if($rs_date_sql == true){
																				...
																				while($List = mysqli_fetch_object($rs_date_sql)){
																					...
																					$RabNo 	= $List->rbn;
																					$LcessAmt 	 = $List->lw_cess_amt;
																					$LcessAmtIMF = round($List->lw_cess_amt);		//IndianMoneyFormat($List->lw_cess_amt);
																					$DispPayDate = dt_display($List->payment_dt);
																					$BillValue 	 = round($List->abstract_net_amt);		//IndianMoneyFormat($List->abstract_net_amt);
																					
																					$sql_select="SELECT work_name,contid,short_name,computer_code_no FROM sheet WHERE sheet_id ='" . $SheetId . "'";
																					...
																					while($List1 = mysqli_fetch_assoc($sql_selectSql)){
																						...
																						while($List2 = mysqli_fetch_object($sql_selectSql1)){
																							...
																							echo "<td class='labelcenter' nowrap='nowrap'>" .  $DispPayDate . "</td>";
																							echo "<td class='labelright' nowrap>". $BillValue ."</td>";
																							echo "<td class='labelright' nowrap='nowrap'>" . $LcessAmtIMF . "</td>";
																							echo "</tr>";
																						}
																					}
																					$TotSumBillVal = $TotSumBillVal+$LcessAmt;
																					$sno++;
																				}
																				...
																				echo "<td class='labelcenter'></td>";
																				echo "<td class='labelcenter'></td>";
																				echo "<td class='labelright'>TOTAL</td>";
