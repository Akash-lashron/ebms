...
if(isset($_POST['btnSave']) == " Submit "){
	...
	$SaveAdvanceAmt 	= $_POST['txt_pay_amt'];
	...
	$SayAdvAmt = 0;
	if($SaveAdvPerc != "" && $SaveAdvPerc != NULL && $SaveAdvPerc != 0){
		if($SaveAdvanceAmt != NULL && $SaveAdvanceAmt != '' && $SaveAdvanceAmt != 0){
			$SayAdvAmt = $SaveAdvanceAmt;
		}else{
			$SayAdvAmt = $SavePayableAmt;
		}
	}else{
		$SayAdvAmt = $SaveTotNetPayAmt;
	}
	
	$MopId = ""; //$MopDate = date("Y-m-d");
	$SelectQuery 	= "SELECT * FROM memo_payment_accounts_edit WHERE sheetid = '$SaveSheetId' AND rbn = '$SaveRbn' AND is_adv_pay = 'Y'";
	...
	$DeleteQuery 	= "DELETE FROM memo_payment_accounts_edit WHERE sheetid = '$SaveSheetId' AND rbn = '$SaveRbn' AND is_adv_pay = 'Y'";
	$DeleteSql 		= mysqli_query($dbConn,$DeleteQuery);
	
	$DeleteQuery 	= "DELETE FROM mop_rec_dt WHERE sheetid = '$SaveSheetId' AND rbn = '$SaveRbn' AND mopid = '$MopId' AND is_adv_pay = 'Y'";
	$DeleteSql 		= mysqli_query($dbConn,$DeleteQuery);
	...
	if(count($SaveRecDescArr)>0){
		foreach($SaveRecDescArr as $Key => $Value){
			...
			rec_perc = '$SaveRecPerc', rec_amt = '$SaveRecAmt', shortcode_id = '$SaveRecHoaScodeId', is_adv_pay = 'Y', createdby = '".$_SESSION['sid']."', createdon = NOW()";
	...
	$InsertQuery 	= "INSERT INTO memo_payment_accounts_edit SET mop_date = '$MopDate', sheetid = '$SaveSheetId', rbn = '$SaveRbn', contid = '$SaveContId', cbdtid = '$SaveBankId', 
					  ...
					  pan_type = '' ".$ResStr.", net_payable_amt = '$SaveTotNetPayAmt',  
					  edit_flag = 'EDIT', mop_type = 'RAB', hoa = '$SaveWorkHoa', hoaid = '$SaveWorkHoaId', is_adv_pay = 'Y', adv_perc = '$SaveAdvPerc', adv_amt = '$SayAdvAmt', 
					  bill_mode = '$SaveBillMode', staffid = '".$_SESSION['sid']."', userid = '".$_SESSION['userid']."', modifieddate = NOW()";
	$InsertSql 		= mysqli_query($dbConn,$InsertQuery);
	$MopId = mysqli_insert_id($dbConn);
	
	$UpdateQuery1 	= "UPDATE abstractbook SET is_adv_pay = 'Y', adv_perc = '$SaveAdvPerc', adv_amt = '$SayAdvAmt' WHERE sheetid = '$SaveSheetId' AND rbn = '$SaveRbn'";
	$UpdateSql1 	= mysqli_query($dbConn,$UpdateQuery1);
	
	$SelectQuery2 	= "SELECT * FROM abstractbook WHERE sheetid = '$SaveSheetId' AND rbn = '$SaveRbn' AND is_adv_pay = 'Y'";
	$SelectSql2 	= mysqli_query($dbConn,$SelectQuery2);
	if($SelectSql2 == true){
		if(mysqli_num_rows($SelectSql2)>0){
			$AbstList 	  = mysqli_fetch_object($SelectSql2);
			$DeleteQuery2 = "DELETE FROM abstractbook_dt WHERE sheetid = '$SaveSheetId' AND rbn = '$SaveRbn' AND is_adv_pay = 'Y'";
			$DeleteSql2   = mysqli_query($dbConn,$DeleteQuery2);
			$InsertQuery2 = "INSERT INTO abstractbook_dt SET abs_book_date = '$AbstList->abs_book_date', sheetid = '$AbstList->sheetid', rbn = '$AbstList->rbn', fromdate = '$AbstList->fromdate',
			todate = '$AbstList->todate', mbookno = '$AbstList->mbookno', mbookpage = '$AbstList->mbookpage', upto_date_total_amount = '$AbstList->upto_date_total_amount', dpm_total_amount = '$AbstList->dpm_total_amount',
			slm_total_amount = '$AbstList->slm_total_amount', total_rec_amt = '$AbstList->total_rec_amt', secured_adv_amt = '$AbstList->secured_adv_amt', mob_adv_amt = '$AbstList->mob_adv_amt', pl_mac_adv_amt = '$AbstList->pl_mac_adv_amt', 
			hire_charges = '$AbstList->hire_charges', total_rec_rel_amt = '$AbstList->total_rec_rel_amt', paid_amount = '$AbstList->paid_amount', upto_date_total_amount_esc = '$AbstList->upto_date_total_amount_esc',
			dpm_total_amount_esc = '$AbstList->dpm_total_amount_esc', slm_total_amount_esc = '$AbstList->slm_total_amount_esc', mbookno_esc = '$AbstList->mbookno_esc', mbookpage_esc = '$AbstList->mbookpage_esc',
			pass_order_date = '$AbstList->pass_order_date', pass_order_pin = '$AbstList->pass_order_pin', pass_order_pin_amt = '$AbstList->pass_order_pin_amt', upto_dt_sd_rec_amt = '$AbstList->upto_dt_sd_rec_amt',
			this_bill_sd_rec_amt = '$AbstList->this_bill_sd_rec_amt', rab_flag = '$AbstList->rab_flag', is_rab = '$AbstList->is_rab', is_final_bill = '$AbstList->is_final_bill', is_sec_adv = '$AbstList->is_sec_adv',
			is_mob_adv = '$AbstList->is_mob_adv', is_esc = '$AbstList->is_esc', is_adv_pay = '$AbstList->is_adv_pay', adv_perc = '$AbstList->adv_perc', adv_amt = '$SayAdvAmt',
			pass_order_dt = '$AbstList->pass_order_dt', pass_order_cr_by = '$AbstList->pass_order_cr_by', pass_order_cr_level = '$AbstList->pass_order_cr_level',
			pay_order_dt = '$AbstList->pay_order_dt', pay_order_cr_by = '$AbstList->pay_order_cr_by', pay_order_cr_level = '$AbstList->pay_order_cr_level', payment_dt = '$AbstList->payment_dt',
			payment_dt_cr_by = '$AbstList->payment_dt_cr_by', payment_cr_level = '$AbstList->payment_cr_level', rab_status = '$AbstList->rab_status', staffid = '$AbstList->staffid', active = '$AbstList->active'";
								...
								<div class="div12">
									<div class="card cabox" style="margin-bottom:1px;">
										<div class="face-static">
											<div class="card-header inkblue-card" align="left">&nbsp;Advance Payment</div>
															...
															<div class="innerdiv2">
																<div class="row" align="center">
																	<div class="div12 pd-lr-1">
																		...
																		<div>
																			<input type="text" name="txt_upto_dt_amt" id="txt_upto_dt_amt" class="dynamicboxlg inp disable" required />
																		</div>
																	</div>
																	<div class="div12 pd-lr-1">
																		<div class="lboxlabel">Deduct Previous Value &#8377;</div>
																		<div>
																			<input type="text" name="txt_ded_prev_amt" id="txt_ded_prev_amt" class="dynamicboxlg inp disable" required />
																		</div>
																	</div>
																	<div class="div12 pd-lr-1">
																		<div class="lboxlabel">Since Last Bill Value &#8377;</div>
																		<div>
																			<input type="text" name="txt_bill_value" id="txt_bill_value" class="dynamicboxlg inp disable" required />
																		</div>
																	</div>
																	<div class="div12 pd-lr-1">
																		<div class="lboxlabel">Add/Deduct Secured Advance &#8377;</div>
																		<div>
																			<input type="text" name="txt_sec_adv_amt" id="txt_sec_adv_amt" class="dynamicboxlg inp disable" required />
																		</div>
																	</div>
																	<div class="div12 pd-lr-1">
																		<div class="lboxlabel">Mobilization Advance &#8377;</div>
																		<div>
																			<input type="text" name="txt_mob_adv_amt" id="txt_mob_adv_amt" class="dynamicboxlg inp disable" required />
																		</div>
																	</div>
																	<div class="div12 pd-lr-1">
																		<div class="lboxlabel">Escalation &#8377;</div>
																		<div>
																			<input type="text" name="txt_esc_amt" id="txt_esc_amt" class="dynamicboxlg inp disable" required />
																		</div>
																	</div>
																	<div class="div12 pd-lr-1">
																		<div class="lboxlabel">P&M Advance &#8377;</div>
																		<div>
																			<input type="text" name="txt_pm_adv_amt" id="txt_pm_adv_amt" class="dynamicboxlg inp disable" required />
																		</div>
																	</div>
																	<div class="div12 pd-lr-1">
																		<div class="lboxlabel">Net Total (Pass Order Amount) &#8377;</div>
																		<div>
																			<input type="text" name="txt_net_amt" id="txt_net_amt" class="dynamicboxlg inp disable" required />
																		</div>
																	</div>
																</div>
															</div>
														...
														<div class="div12" align="center">
															<div class="innerdiv2">
																<div class="row" align="center">
																	...
																	<div class="div4 pd-lr-1">
																		<div class="lboxlabel">Upto Dt. SD Rec. &#8377; <font class="efont ptr SDData">[<i class="fa fa-folder-open-o" style="font-size:13px; top:1px; position:relative"></i>]</font></div>
																		<div>
																...
																<div class="div3 pd-lr-1">
																	...
																	<div class="div8">
																		<input type="text" name="txt_adv_perc" id="txt_adv_perc" value="" class="dynamicboxlg disable" />
																	</div>
																	<div class="div4 lboxlabel">(%)</div>
																</div>
																<div class="div3 pd-lr-1">
																	<div class="lboxlabel">&nbsp;Advance Amt. &#8377;</div>
																	<div>
																		<input type="text" name="txt_net_pay_adv_amt" id="txt_net_pay_adv_amt" class="dynamicboxlg disable" />
																	</div>
																</div>
																<div class="div3 pd-lr-1">
																	<div class="lboxlabel">&nbsp;Amt. Released &#8377;</div>
																	<div>
																		<input type="text" name="txt_pay_amt" id="txt_pay_amt" class="dynamicboxlg disable" />
...
$(function() {
	...
	$("body").on("change","#txt_pay_amt", function(event){
		var AdvPayAmt = $("#txt_pay_amt").val();
		var ActAdvAmt = $("#txt_net_pay_adv_amt").val();
		if(Number(AdvPayAmt) > Number(ActAdvAmt)){
			BootstrapDialog.alert("Amt. Released should be less than or equal to "+ActAdvAmt);
			$("#txt_pay_amt").val('');
		}
	});
				...
				if(data != null){
					...
					if((StatusData != null)&&(BillErr == 0)){
						if(StatusData['bill_comp_status'] == "C"){
							...
							BillErr = 1;
						}else if((AbstCcno == '')&&(StatusData['bill_curr_level'] == StatusData['bill_level_flag'])&&(StatusData['bill_curr_level'] != "C")){
					...
					if(IsBillReg == 1){
						...
						if(RECData != null){
							...
							$("#RecTable").find('tr:last').prev().after(RowStr);
							CalcTotalRec();
							if(RECData['is_adv_pay'] == "Y"){
								var AdvPerc   = RECData['adv_perc'];
								var SayAdvAmt = RECData['adv_amt'];
								
								$("#ch_is_advance").trigger( "click" );
								$("#txt_pay_amt").val(SayAdvAmt); 
							}
						}
					}
				}
