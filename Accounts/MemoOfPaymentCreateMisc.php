...
if(isset($_POST['btnSave'])){
	...
	$SaveBillNo 	= $_POST['txt_bill_no'];
	$SaveBillDt 	= dt_format($_POST['txt_bill_dt']);
	...
	$SavePayableAmt 	= $SaveTotNetPayAmt;//$_POST['txt_net_pay_adv_amt'];
	...
	//echo $SaveBillNo;exit;
	if($SaveNatClaimId == "OTH"){
		$SaveNatClaim = $_POST['txt_others'];
		$NatureDupErr = 0;
		$SelectQueryA = "select * from miscell_items WHERE mis_item_desc = '$SaveNatClaim' AND mop_type = 'MISC'";
		$SelectSqlA   = mysqli_query($dbConn,$SelectQueryA);
		if($SelectSqlA == true){
			if(mysqli_num_rows($SelectSqlA)>0){
				$NatureDupErr = 1;
				$ListA = mysqli_fetch_object($SelectSqlA);
				$SaveNatClaimId = $ListA->mis_item_id;
				$SaveNatClaim 	= $ListA->mis_item_desc;
			}
		}
		if($NatureDupErr == 0){
			$InsertQueryA 		= "INSERT INTO miscell_items SET mis_item_desc = '$SaveNatClaim', mop_type = 'MISC', active = 1";
			$InsertQueryExeA	= mysqli_query($dbConn,$InsertQueryA);
			$SaveNatClaimId 	= mysqli_insert_id($dbConn);
		}
	}
	...
	$InsertQuery 	= "INSERT INTO memo_payment_accounts_edit SET mop_date = '$MopDate', mis_item_id = '$SaveNatClaimId', misc_ref_no = '$SaveRefNo', abstract_net_amt = '$SaveNetAmt', bill_no = '$SaveBillNo', 
					  bill_dt = '$SaveBillDt', contid = '$SaveContId', cbdtid = '$SaveBankId', bill_amt_gst = '$SaveBillAmtGst', bill_amt_it = '$SaveBillAmtIt', 
					  ...
					  edit_flag = 'EDIT', mop_type = 'MISC', hoa = '$SaveHoaNo', hoaid = '$SaveHoaId', shcode_id = '$SaveSCodeId', staffid = '".$_SESSION['sid']."', userid = '".$_SESSION['userid']."', modifieddate = NOW()";
	...
	voucher_for = 'MISC', memoid = '$MopId', creator_flag = 'ACC'";
	//echo $InsertQuery;exit;
	$InsertSql 	= mysqli_query($dbConn,$InsertQuery);*/
	
	if($InsertSql == true){
		$msg = "Miscellaneous data saved successfully";
		$success = 1;
	}else{
		$msg = "Error : Miscellaneous data not saved";
		$success = 0;
	}
}
?>
										...
										<div class="div12">
											<div class="card cabox" style="margin-bottom:1px;">
												<div class="face-static">
													<div class="card-header inkblue-card" align="left">&nbsp;Miscellaneous Memo of Payment</div>
																		...
																		<div class="row" align="center">
																			...
																			<div class="div12 smlboxlabel">
																				...
																				<div class="div1 pd-lr-1">
																					...
																					<div>
																						<input type="text" name="txt_sr_no" id="txt_sr_no" class="dynamicboxlg inp" required />
																					</div>
																				</div>
																				<div class="div1 pd-lr-1">
																					<div class="lboxlabel">&nbsp;RAB</div>
																					<div>
																						<input type="text" name="txt_rbn" id="txt_rbn" class="dynamicboxlg inp" required />
																					</div>
																				</div>-->
																				<div class="div3 pd-lr-1">
																					<div class="lboxlabel">&nbsp;Reference No.</div>
																					<div>
																						<input type="text" name="txt_ref_no" id="txt_ref_no" class="dynamicboxlg" required />
																				...
																				<div class="div3 pd-lr-1">
																					...
																					<div>
																						<select name="cmb_nature_claim" id="cmb_nature_claim" class="dynamicboxlg">
																							<option value=""> -- Select --</option>
																							<?php echo $objBind->BindAllMiscellItems(0,""); ?>
																							<option value="OTH">Others</option>
																						</select>
																						<input type="hidden" name="txt_nature_claim" id="txt_nature_claim" class="dynamicboxlg inp" />
																					</div>
																				</div>
																				<div class="div3 pd-lr-1 oth hide">
																					<div class="lboxlabel">Other Miscellaneous Description</div>
																					<div>
																						<input type="text" name="txt_others" id="txt_others" class="dynamicboxlg" />
																					</div>
																				</div>
																				<div class="div1 pd-lr-1">
																					<div class="lboxlabel">&nbsp;Bill No.</div>
																					<div>
																						<input type="text" name="txt_bill_no" id="txt_bill_no" class="dynamicboxlg" required />
																					</div>
																				</div>
																				<div class="div2 pd-lr-1">
																					<div class="lboxlabel">&nbsp;Bill Date</div>
																					<div>
																						<input type="text" name="txt_bill_dt" id="txt_bill_dt" class="dynamicboxlg datepicker" required />
																					</div>
																				</div>
																				<div class="div3 pd-lr-1">
																					<div class="lboxlabel">&nbsp;HOA</div>
																					<div>
																						<select name="cmb_hoa" id="cmb_hoa" class="dynamicboxlg">
																							<option value="">---- Select ----</option>
																							<?php echo $objBind->BindHoaWithSCode(''); ?>
																						</select>
																				...
																				<!--<div class="div2 pd-lr-1">
																					<div class="lboxlabel">&nbsp;</div>
																					<div>
																						<a data-url="WorkMaster"><font class="efont ptr BankData">(Click here to go to Work Master)</font></a>
																					</div>
																				</div>-->
																			</div>
																		</div>
																	...
																	<div class="innerdiv2">
																		<div class="row" align="center">
																			<div class="div12 pd-lr-1">
																				...
																				<div>
																					<input type="hidden" name="txt_contractor" id="txt_contractor" class="dynamicboxlg inp" required />
																			...
																			<div class="div9 pd-lr-1">
																				...
																				<div>
																					<input type="text" name="txt_pan_no" id="txt_pan_no" readonly="" class="dynamicboxlg inp" />
																				</div>
																			</div>
																			<div class="div3 pd-lr-1">
																				<div class="lboxlabel">IT (%)</div>
																				<div>
																					<input type="text" name="txt_it_perc" id="txt_it_perc" class="dynamicboxlg inp" />
																				</div>
																			</div>
																			<div class="div3 pd-lr-1">
																			...
																			<div class="div6 pd-lr-1">
																				...
																				<div>
																					<input type="text" name="txt_gst_no" id="txt_gst_no" readonly="" class="dynamicboxlg inp" />
																				</div>
																			</div>
																			<div class="div3 pd-lr-1">
																				<div class="lboxlabel">GST Rate</div>
																				<div>
																					<input type="text" name="txt_gst_rate" id="txt_gst_rate" class="dynamicboxlg BillGst inp" />
																				</div>
																			</div>
																			<div class="div3 pd-lr-1">
																				<div class="lboxlabel">Inc./ Exc.</div>
																				<div>
																					<select name="cmb_gst_inc_exc" id="cmb_gst_inc_exc" class="dynamicboxlg BillGst inp">
																						<option value=""> --  Select --</option>
																	...
																	<div class="innerdiv2">
																		<div class="row" align="center">
																			<div class="div4 pd-lr-1">
																				<div class="lboxlabel">Net Amount  &#8377;</div>
																				<div>
																					<input type="text" name="txt_net_amt" id="txt_net_amt" class="dynamicboxlg BillGst inp" required />
																				</div>
																			</div>
																			<div class="div4 pd-lr-1">
																				<div class="lboxlabel">Bill Amount for GST &#8377;</div>
																				<div>
																					<input type="text" name="txt_bill_amt_gst" id="txt_bill_amt_gst" class="dynamicboxlg inp" />
																				</div>
																			</div>
																			<div class="div4 pd-lr-1">
																				<div class="lboxlabel">Bill Amount for IT &#8377;</div>
																				<div>
																					<input type="text" name="txt_bill_amt_it" id="txt_bill_amt_it" class="dynamicboxlg inp" />
																				</div>
																			</div>
																			<div class="row smclearrow"></div>
																		...
																		<div class="div6 pd-lr-1">
																			<div class="lboxlabel">Net Payable Amount &#8377;</div>
																			<div>
																		...
																		<div class="row smclearrow"></div>
																		<div class="row smclearrow"></div>
																		<div class="div12 cboxlabel">
																		<input type="submit" name="btnSave" id="btnSave" class="btn btn-info" value=" Submit ">
																		<a href="MopMiscList.php" class="btn btn-info" name="btn_view" id="btn_view"> View All </a>
																		</div>
																		<div class="row smclearrow"></div>
...
$(function() {
		...
		if(KillEvent == 0){
			...
			if(RefNo == ""){
				...
				BootstrapDialog.confirm({
					...
					message: 'Are you sure want to save Miscellaneous data ?',
	...
	$("body").on("change","#cmb_nature_claim", function(event){
		$("#txt_nature_claim").val('');
		$(".oth").addClass("hide");
		$("#txt_others").prop('required',false);
		if($(this).val() != ''){
			var NatureClaim = $("#cmb_nature_claim option:selected").text();
			$("#txt_nature_claim").val(NatureClaim);
			var NatureClaimVal = $(this).val();
			if(NatureClaimVal == "OTH"){
				$(".oth").removeClass("hide");
				$("#txt_others").prop('required',true);
			}
		}
	});
	...
	$("body").on("change","#txt_net_amt", function(event){
		CalcTotalRec();
	});
			...
			success: function (data) {   //alert(data['computer_code_no']);
				if(data != null){
					...
					if(CONTData != null){
						...
						/*$("#txt_ldc_cert_no").addClass('disable');
						$("#txt_ldc_amt").addClass('disable');
						$("#txt_ldc_valid_to").addClass('disable');
						$("#txt_ldc_status").addClass('disable');*/
