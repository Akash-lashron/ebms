...
if(isset($_POST['btnSave'])){
	...
	if($DupExist == 0){
		$InsertQuery 	= "INSERT INTO memo_payment_accounts_edit SET mis_item_id = '$SavePaymentFor', misc_ref_no = '$SaveRefNo', contid = '$SaveContId', cbdtid = '$SaveBankId', 
						  net_payable_amt = '$SaveNetAmt', edit_flag = 'EDIT', mop_type = '$SaveMopType', remarks = '$SaveRemarks', lcess_fdate = '$SaveFromDate', lcess_tdate = '$SaveToDate', 
