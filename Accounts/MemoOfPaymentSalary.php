										...
										<div class="div12">
											<div class="card cabox" style="margin-bottom:1px;">
												<div class="face-static">
													<div class="card-header inkblue-card" align="left">&nbsp;Memo of Payment - Salary</div>
																				...
																				<div class="div4 pd-lr-1">
																					...
																					<div>
																						<select name="cmb_payment_for" id="cmb_payment_for" class="dynamicboxlg inp" required>
																							<?php echo $objBind->BindAllMiscellItems(0,'SAL'); ?>
																						</select>
																						<input type="hidden" name="txt_mop_type" id="txt_mop_type" value="SAL" />
																						<input type="hidden" name="txt_misc_module" id="txt_misc_module" value="SAL" />
																					</div>
																				</div>
																				<div class="div4 pd-lr-1">
																		...
																		<div class="row" align="center">
																			...
																			<div class="row" align="center">
																				<div class="div12 pd-lr-1" align="center">
																					...
																					<a href="MopSalaryList.php" class="btn btn-info" name="btn_view" id="btn_view"> View All </a>
																				</div>
																			</div>
																			<div class="row clearrow"></div>
																		</div>
