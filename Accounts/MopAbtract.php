			...
			if($SelectSql1 == true){
				if(mysqli_num_rows($SelectSql1)>0){
					while($List1 = mysqli_fetch_object($SelectSql1)){
						...
						//$HoaScodeArr = array();
						$ShortCode = "";
						$SelectQuery1A = "select * from shortcode_master where shortcode_id IN ($HoaSCodeId)";
							...
							<div class="box-container box-container-lg">
								...
								<div class="div2">
									<div class="card" style="margin-top:2px;">
										<a data-url="MopMemoForStatements?sheetid=<?php echo $sheetid; ?>&rbn=<?php echo $rbn; ?>&paytype=<?php echo $paytype; ?>">
										...
										<a data-url="MopAbtract?sheetid=<?php echo $sheetid; ?>&rbn=<?php echo $rbn; ?>&paytype=<?php echo $paytype; ?>">
										<div class="face-static tabbtn tabbtn-active">
											<div class="card-body padding-1">
												<div class="row">
													<i class="fa fa-check-square-o" style="font-size:14px"></i>&nbsp;&nbsp;Abstract
												</div>                         
											</div>
										</div>
										</a>
										<a data-url="MopCodingSheet?sheetid=<?php echo $sheetid; ?>&rbn=<?php echo $rbn; ?>&paytype=<?php echo $paytype; ?>">
										<div class="face-static tabbtn">
											<div class="card-body padding-1">
												<div class="row">
													Coding Sheet
										...
										<a data-url="MopRecoveryParticulars?sheetid=<?php echo $sheetid; ?>&rbn=<?php echo $rbn; ?>&paytype=<?php echo $paytype; ?>">
										<div class="face-static tabbtn">
											<div class="card-body padding-1">
												<div class="row">
																		...
																		<div class="row" align="center">
																			<div class="steps-content" align="center" id="printSection" style="width:875px">
																				...
																				<div class="TablePart" align="center">
																					<table width="100%" class="tableM" align="center" style="width:875px">
																						<tr class="">
																							<td colspan="4" align="center" class="cboxlabel">
																								...
																								<span style="float:center"><b>BARC, NRB, FRFCF - ACCOUNTS</b></span><br/><br/>
																							   	<span style="float:center"><b>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;ABSTRACT </b></span>
																						...
																						<tr>
																							<td colspan="4" class="cboxlabel">
																								...
																								<span style="float:right"><b>SL. No.</b>&nbsp;&nbsp;:&nbsp; <?php echo $BillRegNo;?> &nbsp;&nbsp;<b>Date</b> :&nbsp;&nbsp; <?php if($AccList->pay_order_dt != '0000-00-00'){ echo $pay_order_dt; }else{ echo '&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;'; }//$work_order_date; ?></span>
																							</td>
																						</tr>
																					...
																					<table width="100%" class="tableM" align="center">
																						<!--<tr>
																							...
																							<td align="right" width="130px" class="nobdrlr"><?php echo IND_money_format($upto_date_total_amount); ?></td>
																							<td align="left" width="100px" class="blabel" style="border-left:none;">&nbsp;</td>
																						</tr>
																						
																						<tr>
																							<td align="left" colspan="4" style="border-right:none;" nowrap="nowrap" class="blabel">B. ADD/DEDUCT Secure Advance  </td>
																							<td align="left" width="30px" class="blabel nobdrlr">: Rs.</td>
																							<td align="right" width="130px" class="nobdrlr"><?php echo IND_money_format($sec_adv_amount); ?></td>
																							<td align="left" width="100px" class="blabel" style="border-left:none;">&nbsp;</td>
																						</tr>-->
																						...
																						<!--<tr>
																							...
																							<td align="left" width="30px" class="blabel nobdrlr">: Rs.</td>
																							<td align="right" width="130px" class="nobdrlr"><?php echo IND_money_format($GrandTotal); ?></td>
																							<td align="left" width="100px" class="blabel" style="border-left:none;">&nbsp;</td>
																						</tr>
																						...
																						<tr>
																							...
																							<td align="left" width="30px" class="blabel nobdrlr">: Rs.</td>
																							<td align="right" width="130px" class="nobdrlr"><?php echo IND_money_format($dpm_total_amount); ?></td>
																							<td align="left" width="100px" class="blabel" style="border-left:none;">&nbsp;</td>
																						</tr>-->
																						...
																						<!--<tr>
																							...
																							<td align="left" width="30px" class="blabel nobdrlr">: Rs.</td>
																							<td align="right" width="130px" class="nobdrlr"><?php echo IND_money_format($NetTotal); ?></td>
																							<td align="left" width="100px" class="blabel" style="border-left:none;">&nbsp;</td>
																						</tr>-->
														
													
																						<tr>
																							<td align="left" colspan="8" class="blabel">FINAL CHARGES :</td>
																					...
																					<table width="100%" class="tableM" align="center">-->
																						...
																						<?php } ?>
																						<?php if($mob_adv_amt_rec > 0){ $TotalRecovery  = $TotalRecovery + $mob_adv_amt_rec; ?>
																						<tr class="label">
																							<td align="left" width="25px" class="labelmedium" style="border-right:none;">&nbsp;</td>
																						...
																						<?php } ?>
																						<?php if($pl_mac_adv_rec > 0){ $TotalRecovery  = $TotalRecovery + $pl_mac_adv_rec; ?>
																						<tr class="label">
																							<td align="left" width="25px" class="labelmedium" style="border-right:none;">&nbsp;</td>
																						...
																						<?php } ?>
																						<?php if(($adv_amt > 0)&&($IsAdvPayFlag != 'Y')){ $TotalRecovery  = $TotalRecovery + $adv_amt; ?>
																						<tr class="label">
																							<td align="left" width="25px" class="labelmedium" style="border-right:none;">&nbsp;</td>
																						...
																						<tr>
																							<td align="left" colspan="4" style="border-right:none;" nowrap="nowrap" class="blabel">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Total </td>
																							<td align="left" width="30px" class="blabel nobdrlr">: Rs.</td>
																							<td align="right" width="130px" class="nobdrlr blabel"><?php echo IND_money_format($NetTotal); ?></td>
																							<td align="left" width="100px" class="blabel" style="border-left:none;">&nbsp;</td>
																						</tr>
																					...
																					<div class="prdiv" style="min-height:20px;">
																						...
																						<div style="width:20%; float:left" class="labelmedium blabel">&nbsp;</div>
																						<div style="width:20%; float:left" class="labelmedium blabel">AAO</div>
																						<div style="width:20%; float:left" class="labelmedium blabel">&nbsp;</div>
																						<div style="width:20%; float:left" class="labelmedium blabel">SAO / DCA</div>
																						<br/>
																					</div>
																					...
																					<div style="min-height:20px;">
																						<br/><br/><br/><br/>
																						<div style="width:33%; float:left" class="labelmedium blabel">Delaing Assistant</div>
																						<div style="width:33%; float:left" class="labelmedium blabel">AAO</div>
																						<div style="width:33%; float:left" class="labelmedium blabel">DCA</div>
																						<br/>
																					</div>-->
