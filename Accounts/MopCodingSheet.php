...
if(($sheetid != "")&&($rbn != "")){
	...
	$SCodeRecArr = array();
	$AccSelectSCodeQuery = "select a.*, b.shortcode from mop_rec_dt a inner join shortcode_master b on (a.shortcode_id = b.shortcode_id) where a.sheetid = '$sheetid' and a.rbn = '$rbn' and a.rec_type = 'B' ORDER BY mrhid ASC";
								...
								<div class="div2">
									<div class="card" style="margin-top:2px;">
										...
										<div class="face-static tabbtn tabbtn-active">
											<div class="card-body padding-1">
												<div class="row">
													<i class="fa fa-check-square-o" style="font-size:14px"></i>&nbsp;&nbsp;Coding Sheet
												</div>                         
											</div>
										</div>
										</a>
																			...
																			<div class="steps-content" align="center" id="printSection">
																				...
																				<div class="TablePart" align="center">
																					<table width="100%" class="tableM" align="center">
																						<tr class="">
																							<td colspan="4" align="center" class="cboxlabel">
																								...
																								<span style="float:center"><b>BARC, NRB, FRFCF - ACCOUNTS</b></span><br/><br/>
																							   	<span style="float:center"><b>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;CODING SHEET </b></span>
																						...
																						<tr>
																							<td colspan="4" class="cboxlabel">
																								...
																								<span style="float:center"><b>Month</b> : <?php if($AccList->pay_order_dt != '0000-00-00'){ echo date("F-Y",strtotime($pay_order_dt)); } ?> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<b>Vr. No. & Date </b>&nbsp;&nbsp;:&nbsp;</span>
																							</td>
																						</tr>
																						...
																						<?php if($other_recovery_3_amt != 0){ $TotalRecovery  = $TotalRecovery + $other_recovery_3_amt; $CodeAmount = $CodeAmount - $other_recovery_3_amt; } ?>
																					...
																					if($SelectPayRecMasterSql == true){
																						if(mysqli_num_rows($SelectPayRecMasterSql)>0){
																							while($PayRecMasterList = mysqli_fetch_object($SelectPayRecMasterSql)){
																								if($PayRecMasterList->rec_type == 'A' || $PayRecMasterList->rec_type == 'B'){
																									if($PayRecMasterList->prcode == "IT"){
																										$PayRecMasterList->pr_desc = "INCOME TAX";
																									}
																									if($PayRecMasterList->prcode == "CGST"){
																										$PayRecMasterList->pr_desc = "TDS ON CGST";
																									}
																									if($PayRecMasterList->prcode == "SGST"){
																										$PayRecMasterList->pr_desc = "TDS ON SGST";
																									}
																									if($PayRecMasterList->prcode == "IGST"){
																										$PayRecMasterList->pr_desc = "TDS ON IGST";
																									}
																									if($PayRecMasterList->prcode == "EC"){
																										$PayRecMasterList->pr_desc = "ELECTRICITY REC.";
																									}
																									if($PayRecMasterList->prcode == "WC"){
																										$PayRecMasterList->pr_desc = "WATER REC.";
																									}
																									$PartABRecArr[$PayRecMasterList->prcode] = $PayRecMasterList->pr_desc;
																								}
																							}
																						}
																					}
																					...
																					<table width="100%" class="tableM" align="center">
																						...
																						if($IsAdvPayFlag != 'Y'){
																							if(count($SCodeRecArr)>0){ 
																								foreach($SCodeRecArr as $SCodeRecKey => $SCodeRecValue){ 
																									...
																									*/
																									if(isset($PartABRecArr[$SCodeRecKey])){
																										$SCodeRecKey = $PartABRecArr[$SCodeRecKey];
																									}
																						?>
																						<tr class="label">
																						...
																						/*
																						if($is_adv_pay != 'Y'){
																							$FinalCodeAmt = $adv_amt;
																						}else{
																						*/
																							$FinalCodeAmt = $CodSheetChequeAmt;
																						// }
																						?>
																						<tr class="label">
																							...
																							<td align="right" class="blabel" style="border-left:none;"><span class="blabel" style="float:left">Rs.</span><?php echo IND_money_format($FinalCodeAmt); ?></td>
																						</tr>
