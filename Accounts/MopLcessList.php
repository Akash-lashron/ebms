...
$ContNameArr = array();
$TrueValue = 0;
$MopSdRecQuery = "SELECT * FROM memo_payment_accounts_edit WHERE mop_type = 'LCESS' ORDER BY memoid DESC";
									...
									<div class="div12">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="center">Memo Of Payment Labour Cess - View</div>
												<div class="card-body padding-1 ChartCard" id="CourseChart">
													<div class="divrowbox pt-2">
																...
																<table width="100%" align="center" class="dataTable table2excel mgtb-8">
								                                  <thead>
																	<tr>
																		...
																		<th valign="middle">LCESS Payable Amount ( &#8377; )</th>
																...
																<tbody>
																	<tr class='labeldisplay'>
																		...
																		<td valign='middle' class='tdrow' align='center'>
																			...
																			<!--<a data-url="MopLcessPrint?id=<?php echo $List->memoid; ?>" class=" BtnHref btn btn-info" name="btn_print" id="btn_print" style="margin-top:0px;">
																				View & Print
																			</a>-->
																		</td>
																	</tr>
														...
														<div align="center">
															...
															<a data-url="MemoOfPaymentLCess" class="btn btn-info" name="view" id="view">Back</a>
														</div>
													</div>
												</div>
											</div>
								...
								BootstrapDialog.show({
									...
									buttons: [{
										...
										action: function(dialog) {
											window.location.href = 'MopLcessList.php';
										}
									}]
								});
							}
