												...
												<div class="divrowbox pt-2">
													<div class="table-responsive dt-responsive ResultTable">
														<div class="table-responsive dt-responsive rtabdiv" id="table-stmt">
															<div class="card-header inkblue-card" align="center"> Memo Of Payment Labour Cess </div>
															<!--	<ul class="steps">
															...
															<div class="steps-content" align="center" id="printSection">
																...
																<table width="100%" class="tableA" align="center">
																	...
																	<tr>
																		<td class="label" colspan="2" style="text-align:center">BILL FOR MISCELLANEOUS PAYMENTS - LABOUR CESS FOR THE PERIOD OF <?php echo dt_display($lcess_fdate); ?> - <?php echo dt_display($lcess_tdate); ?></td>
																	</tr>
																	<tr class="label">
