...
$CCnoArr = array();
$TrueValue = 0;
$MopSdRecQuery = "SELECT a.*, b.mis_item_desc FROM memo_payment_accounts_edit a INNER JOIN miscell_items b ON (a.mis_item_id = b.mis_item_id) WHERE a.mop_type ='MISC' ORDER BY a.memoid DESC";
												...
												<div class="card-body padding-1 ChartCard" id="CourseChart">
													<div class="divrowbox pt-2">
																...
																<table width="100%" align="center" class="dataTable table2excel mgtb-8">
																	<thead>
																		<tr>
																			...
																			<th valign="middle">Nature of Claim</th>
																	...
																	<tbody>
																		<tr class='labeldisplay'>
																			...
																			<td class='tdrowbold' valign='middle' align='left'><?php echo $List->mis_item_desc; ?></td>
																			<td valign='middle' class='tdrow' align = 'left'><?php echo $List->misc_ref_no; ?></td>
																			<td valign='middle' class='tdrow' align = 'left'><?php echo $ContNameArr[$List->contid]; ?></td>
																			<td valign='middle' class='tdrow' align = 'left'><?php echo $HoaNameDispay; ?></td>
														...
														<div align="center">
															...
															<a data-url="MemoOfPaymentCreateMisc" class="btn btn-info" name="view" id="view">Back</a>
														</div>
													</div>
												</div>
											</div>
