								...
								<div class="div2">
									<div class="card" style="margin-top:2px;">
										...
										<div class="face-static tabbtn tabbtn-active">
											<div class="card-body padding-1">
												<div class="row">
													<i class="fa fa-check-square-o" style="font-size:14px"></i>&nbsp;&nbsp;Recovery Particulars
												</div>                         
											</div>
										</div>
										</a>
																			...
																			<div class="steps-content" align="center" id="printSection">
																				...
																				<div class="TablePart" align="center">
																						...
																						<tr class="">
																							<td colspan="4" align="center" class="cboxlabel">
																								...
																								<span style="float:center"><b>BARC, NRB, FRFCF - ACCOUNTS</b></span><br/><br/>
																							   	<span style="float:center"><b>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;RECOVERY PARTICULARS </b></span>
																					...
																					<table width="100%" class="tableM" align="center">
																						...
																						<tr>
																							<td align="left" colspan="4" style="border-right:none;" nowrap="nowrap" class="blabel">Bill Value &nbsp;&nbsp;</td>
																							<td align="left" width="30px" class="blabel nobdrlr">: Rs.</td>
																					...
																					<table width="100%" class="tableM" align="center">-->
																						...
																						<tr class="label">
																							<td align="left" width="25px" class="labelmedium" style="border-right:none;">&nbsp;</td>
																							<td align="left" width="330px" class="labelmedium nobdrlr">[<?php echo $rcb; $rcb++; ?>]  INCOME TAX @ <?php echo $incometax_percent; ?> % On (<?php echo IND_money_format($NetTotal); ?> )</td>
																							<td align="left" width="30px" class="labelmedium nobdrlr">: Rs.</td>
																					...
																					<br/>
																					<div class="prdiv" style="min-height:150px;">
																						<br/><br/><br/><br/>
																						<div style="width:33%; float:left;" class="labelmedium blabel">
																							Kalpakkam - 603102
																							<br/> <?php echo date("d.m.Y"); ?>
																						</div>
																						<div style="width:33%; float:left" class="labelmedium blabel">&nbsp;</div>
																						<div style="width:33%; float:left" class="labelmedium blabel">Assistant Accounts Officer<br/>NRB, FRFCF</div>
																						<br/>
																					</div>
