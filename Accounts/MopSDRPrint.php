												...
												<div class="divrowbox pt-2">
													<div class="table-responsive dt-responsive ResultTable">
														<div class="table-responsive dt-responsive rtabdiv" id="table-stmt">
															<div class="card-header inkblue-card" align="center"> Memo Of Payment SD Release </div>
															<!--	<ul class="steps">
															...
															<div class="steps-content" align="center" id="printSection">
																...
																<table width="100%" class="tableA" align="center">
																	...
																	<tr class="label">
																		<td colspan="2">
																			<span style="float:left">C C No : <?php echo $ccno
																			; ?></span>
																			<span style="float:right">Date : <?php if(($mop_date != '0000-00-00')&&($mop_date != NULL)){ echo dt_display($mop_date); }else{ echo date("d/m/Y"); } ?>&nbsp;&nbsp;</span>
																		</td>
																	</tr>
																	<tr>
																		<td class="label" colspan="2" style="text-align:center">BILL FOR MISCELLANEOUS PAYMENTS <?php if($MiscItName != ''){ echo " - ".strtoupper($MiscItName); } ?></td>
																	</tr>
																	<tr class="label">
																		<td align="left" width="250px" style="border-right:none;">Name of Work </td>
																		<td align="left" style="border-left:none;">: &nbsp;<?php echo $work_name; ?></td>
																	</tr>
																	<tr class="label">
																		<td align="left" width="250px" style="border-right:none;">Head Of Account </td>
																	...
																	<!--<tr class="label">
																		<td align="left" style="border-right:none;">Bill No. & Date </td>
																		<td align="left" style="border-left:none;">: &nbsp;<?php if($rbn != NULL){ ?> RAB : <?php echo $rbn; ?> <?php if($work_order_date != ""){ echo "&"; } ?><?php if($work_order_date != ""){ echo dt_display($work_order_date); } }?></td>
																	</tr>-->
																	<tr class="label">
																		<td align="left" style="border-right:none;">Amount Payable (Rs) </td>
																		<td align="left" style="border-left:none;">: &nbsp;Rs. <?php echo IND_money_format($net_payable_amt);?></td>
																	</tr>
																	<!--	<tr class="label">
																	...
																	<!--	<tr class="label">
																		<td align="left" colspan="2"> Payable Rs in Words :<br>
																			<?php //echo GetIndianMoneyFormatWord($slm_total_amount); ?>
																			<br><br>
																		</td>
																	</tr>	-->
																	<tr class="label">
														...
														<div class="row printbutton" align="center">
															<div class="row smclearrow">&nbsp;</div>
															<input type="button" name="btn_back" value=" Back " id="btn_back" class="btn btn-info" onClick="goBack();" />
															<input type="button" name="btn_print" value=" Print " id="btn_print" class="btn btn-info" onClick="PrintBook();" />
														</div>
													</div>
												</div>
											</div>
