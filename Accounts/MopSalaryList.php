...
$ContNameArr = array();
$TrueValue = 0;
$MopSdRecQuery = "SELECT * FROM memo_payment_accounts_edit WHERE mop_type = 'SAL' ORDER BY memoid DESC";
									...
									<div class="div12">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="center">Memo Of Payment Salary - View</div>
															...
															<div class="table-responsive dt-responsive rtabdiv" id="table-stmt">
																<table width="100%" align="center" class="dataTable table2excel mgtb-8">
								                                  <thead>
																	<tr>
																		...
																		<th valign="middle">Ref No.</th>
																		<th valign="middle">Head Of Account</th>
																		<th valign="middle">Name Of Payee</th>
																		<th valign="middle">From Date</th>
																		<th valign="middle">To Date</th>
																		<!--<th valign="middle">Bill Amount</br>( &#8377; )</th>
																		<th valign="middle">Bill No. & Bill Date</th>-->
																		<th valign="middle">Salary Paid Amount ( &#8377; )</th>
																...
																<tbody>
																	...
																	<tr class='labeldisplay'>
																		...
																		<td valign='middle' class='tdrow' align = 'justify'><?php echo $List->misc_ref_no; ?></td>
																		...
																		<td class='tdrow' align='right' valign='justify'><?php echo dt_display($List->lcess_fdate); ?></td>
																		<td class='tdrow' align='right' valign='justify'><?php echo dt_display($List->lcess_tdate); ?></td>
																		<!--<td class='tdrow' align='right' valign='justify'><?php echo IndianMoneyFormat($List->abstract_net_amt); ?></td>
																		...
																		<td valign='middle' class='tdrow' align='center'>
																			<!--<a data-url="#" class=" BtnHref btn btn-info" name="btn_edit" id="btn_edit">
																				Edit
																			</a>-->
																			<input type="button" name="btnDelete" id="btnDelete" class="btn btn-info" data-id="<?php echo $List->memoid; ?>" value="DELETE">
																			<!--<a data-url="MopSalaryPrint?id=<?php echo $List->memoid; ?>" class=" BtnHref btn btn-info" name="btn_print" id="btn_print" style="margin-top:0px;">
																				View & Print
																			</a>-->
																		</td>
																	</tr>
