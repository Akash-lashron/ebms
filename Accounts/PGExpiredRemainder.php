...
//echo $oneMonthAgo->format('Y-m-d');exit;
//$CurrDate =  $oneMonthAgo->format('Y-m-d');
$TodatDate = date('Y-m-d');
$CurrDate = date('Y-m-d', strtotime($TodatDate. ' + 1 month'));
//echo $CurrDate;exit;
$MasterQuery1 = "SELECT a.tr_id, b.bfdid, b.inst_exp_date FROM loi_entry a INNER JOIN bg_fdr_details b ON ( a.loa_pg_id = b.master_id ) WHERE b.inst_purpose = 'PG' AND b.inst_status != 'R'";
...
$PgRetMasterQuery = "SELECT a.*, b.*, c.tr_no, c.work_name, d.name_contractor,e.sch_comp_date,e.ccno FROM loi_entry a 
...
INNER JOIN works e ON (c.tr_id = e.tr_id) WHERE b.bfdid IN ($ImpDetIds)";
									...
									<div class="div12">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="center">PG Expiry Remainder List</div>
												<div class="card-body padding-1 ChartCard" id="CourseChart">
													<div class="divrowbox pt-2">
														<div class="table-responsive dt-responsive ResultTable">
															<div class="table-responsive dt-responsive rtabdiv" id="table-stmt">

																<table width="100%" align="center" class="dataTable table2excel mgtb-10">
																	<thead>
