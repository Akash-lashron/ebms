...
$CurrDate = date('Y-m-d', strtotime($TodatDate. ' + 1 month'));
$MasterQuery1 = "SELECT a.sheet_id, b.bfdid, b.inst_exp_date FROM sheet a INNER JOIN bg_fdr_details b ON ( a.sheet_id = b.master_id ) WHERE b.inst_purpose = 'SD' AND b.inst_status != 'R'";
...
if($MasterQuery1sql == true){
	if(mysqli_num_rows($MasterQuery1sql)>0){
		while($List10 = mysqli_fetch_object($MasterQuery1sql)){
			...
			$OrginalExpDate = $List10->inst_exp_date;
			$ExpDate = date('Y-m-d', strtotime($OrginalExpDate. ' - 1 month'));
...
if ($ImpTrIds !=null){
$WorkQuery = "SELECT sch_comp_date FROM works WHERE sheetid IN ($ImpTrIds)";
...
$PgRetMasterQuery ="select sheet.*,bg_fdr_details.*, contractor.name_contractor from sheet 
					...
					WHERE bg_fdr_details.inst_status != 'R' and bg_fdr_details.bfdid IN ($ImpDetIds)
									...
									<div class="div12">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="center">SD Expiry Remainder</div>
																...
																<table width="100%" align="center" class="dataTable table2excel mgtb-8">
																	<thead>
																		...
																		<tr>
																			...
																			<th rowspan="2" valign="middle">Schecduled Date<br> of Completion</th>
																			<th rowspan="2" valign="middle">Schecduled Date<br> of Completion<br>+ 8 Months</th>
																	...
																	<tbody>
																		...
																		<tr class='labeldisplay'>
																			...
																			<td rowspan= <?php echo $TrRowspan ?> valign='middle' class='tdrow' align = 'justify'><?php echo dt_display($PGValue->date_of_completion); ?></td>
																			<td rowspan= <?php echo $TrRowspan ?> valign='middle' class='tdrow' align = 'justify'><?php echo dt_display(date('Y-m-d', strtotime($PGValue->sch_comp_date. ' + 8 months'))); ?></td>
