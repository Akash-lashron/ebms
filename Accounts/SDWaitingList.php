...
include "common.php";
$PageName = $PTPart1.$PTIcon.'SD Waiting List';
...
INNER JOIN bg_fdr_details c ON (a.sheet_id = c.master_id) WHERE c.inst_purpose='SD' AND  c.inst_status='EIC' AND  c.approved_session !='ACC'";
									...
									<div class="div12">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="center">SD Waiting For Confirmation </div>
																...
																<table width="100%" align="center" class="dataTable table2excel mgtb-8">
																	...
																	<tbody>
																		...
																		<tr class='labeldisplay'>
																			...
																			<td class='tdrow' align='center' rowspan="<?php echo $TrRowspan; ?>" valign='middle'><input type="button" data-url="SDConfirmation?id=<?php echo $PGValue->sheet_id; ?>" class="BtnHref btn btn-info" Value="View Details "></td>
