...
$WorksCCQuery = "SELECT globid,ccno FROM works";
...
INNER JOIN bg_fdr_details c ON (a.sheet_id = c.master_id) WHERE c.inst_purpose='SD' AND c.inst_status='R'";
									...
									<div class="div12">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="center">SD Release Register <span class="ralignbox fright"><span class="xldownload" id="exportToExcel"> Download Excel <i class="fa fa-download"></i> </span></span></div>
																...
																<table width="100%" align="center" class="dataTable table2excel mgtb-8 example">
																	<thead>
																		...
																		<tr>
																			...
																			<th colspan="5" valign="middle">SD Detail</th>
																	...
																	<tbody>
																		...
																		<tr class='labeldisplay'>
																			...
																			<td rowspan= <?php echo $TrRowspan ?> valign='middle' class='tdrow' align = 'justify'><?php echo $WorksCCNoDataArr[$PGValue->globid]; ?></td>
																			...
																			<td rowspan= <?php echo $ContRowSpan ?> valign='middle' class='tdrow' align = 'justify'><?php if($PGValue->inst_status != 'R'){ echo 'Not-Released'; }else{ echo 'Released'; } ?></td>
																		</tr>
																		<?php 
																				$x++; $y++;  $SNO++;
																			}else{
