...
include "common.php";
$PageName = $PTPart1.$PTIcon.'Schedule of Rate';
$GlobGr1Id = 2; $GlobGr2Id = '';
...
<script type="text/javascript">
    ...
    <body class="page1" id="top" oncontextmenu="return false"onload="noBack();" onpageshow="if (event.persisted) noBack();" onUnload="">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data" name="form" id="form1">
					...
					<div class="grid_12" align="center">
						...
						<blockquote class="bq1" style="overflow:auto">
							<div class="row">
								...
								<div class="div6" align="center">
									<div class="innerdiv2">
										...
										<div class="row innerdiv" align="center">
											...
											<div class="row">
												<?php include("MainDataEntryFormHCMD.php"); ?>
												<?php include("SubDataEntryFormHCMD.php"); ?>
											</div>
								...
								<div class="div3" align="center">
									<?php include("CommonAdditionDeductionHCMD.php"); ?>
								</div>
							</div>
						</blockquote>
					</div>
			...
			<?php include("CalculationSheetHCMD.php"); ?> 
            <!--==============================footer=================================-->
...
<script src="js/CommonJSLibraryHCMD.js"></script>
<script>
