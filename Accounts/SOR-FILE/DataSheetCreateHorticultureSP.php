...
include "common.php";
$PageName = $PTPart1.$PTIcon.'Schedule of Rate'.$PTIcon.'Supplying & Planting';
$GlobGr1Id = 1; $GlobGr2Id = '';
...
<script type="text/javascript">
    ...
    <body class="page1" id="top" oncontextmenu="return false"onload="noBack();" onpageshow="if (event.persisted) noBack();" onUnload="">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data" name="form" id="form1">
						...
						<blockquote class="bq1" style="overflow:auto">
							<div class="row">
										...
										<div class="row innerdiv group-div" align="center">
											...
											<div class="row clearrow">
												<select class="text" style="width:648px;height:21px; display:none;" name="cmb_group[]" ID="cmb_group0" data-group="0">
													<?php echo $objBind->BindGroupHCI($GlobGr1Id); ?>
												</select>
											</div>
											<div class="row">
											...
											<div class="row" id="gr-append">
												...
												<div class="div9" align="center">
													<select name="cmb_group[]" id="cmb_group2" class="sboxsmclass group" data-group="2"> 
														...
														<?php echo $objBind->BindGroup2NoSubLevelHC($GlobGr1Id,$GlobGr2Id); ?>
													</select>
								...
								<div class="div6" align="center">
									<div class="innerdiv2">
										<div class="row divhead head-p" align="center">Main Data / Sub-Data - Item Details</div>
										<div class="row innerdiv" align="center">
											...
											?>
											<div class="row lboxlabel" style="display:none">
												&emsp;<input type="radio" name="rad_type" id="rad_new" checked="checked" value="N" class="rad_type" style="margin:0px;">&nbsp; New Main Data
												&emsp;&emsp;&emsp;
												<input type="radio" name="rad_type" id="rad_merge" <?php echo $SDStr; ?> value="M" class="rad_type" style="margin:0px;">&nbsp; Merge With Sub-Data
											</div>
											<div class="row">
												<?php include("MainDataEntryFormHCSP.php"); ?>
												<?php include("SubDataEntryFormHCSP.php"); ?>
											</div>
											<div class="row clearrow new <?php echo $NewHideClass; ?>"></div>
											<div class="row lboxlabel new <?php echo $NewHideClass; ?>" style="display:none">
												&emsp;
											...
											<?php //include("DisposalQtySectionHC.php"); ?>
											<div class="erow" style="display:none"></div>
								...
								<div class="div3" align="center">
									<?php include("CommonAdditionDeductionHCSP.php"); ?>
								</div>
							</div>
						</blockquote>
					</div>
			...
			<?php include("CalculationSheetHCSP.php"); ?> 
            <!--==============================footer=================================-->
...
<script src="js/CommonJSLibraryHCSP.js"></script>
<script>
