...
<script type="text/javascript">
    ...
    <body class="page1" id="top" oncontextmenu="return false"onload="noBack();" onpageshow="if (event.persisted) noBack();" onUnload="">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data" name="form" id="form1">
            ...
            <!--==============================Content=================================-->
			<div class="content">
				<?php include "MainMenu.php"; ?><!---  Alert -->
									...
									<div class="innerdiv2">
										...
										<div class="row innerdiv" align="center">
											...
											<div class="row lboxlabel new <?php echo $NewHideClass; ?>">
												&emsp;
												<input type="radio" name="calc_type" id="with_calc" class="calc_type" value="WC">&nbsp; With Calculation
												&emsp;&emsp;&emsp;
												<input type="radio" name="calc_type" id="without_calc" class="calc_type" value="WOC" checked="checked">&nbsp; Without Calculation
											</div>
