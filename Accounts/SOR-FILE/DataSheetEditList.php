					...
					<div class="grid_12" align="center">
						<blockquote class="bq1 stable" style="overflow:auto">
							<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="color1 dataTable">
								<thead>
									<tr>
										<th align="center" colspan="8" style="background:#136BCA; color:#ffffff; border-color:#136BCA">Data Sheet List Edit - <?php echo $PageTile; ?></th>
									</tr>
									<tr>
										<th>&nbsp;SNo.&nbsp;&nbsp;</th>
									...
									<tr>
										...
										<td align="center">
											...
											<?php 
												...
												if($List->new_merge == "M"){ 
													$ViewUrl = "DataSheetViewMerge?dsid=".$DsId."&refid=".$List->ref_id;
										 		}else{ 
													$ViewUrl = "DataSheetViewNew?dsid=".$DsId."&refid=".$List->ref_id;
										 		}
										 	?>
										</td>
										...
										<td align="center">
										<?php if($List->ds_release == "Y"){ ?>
											<button type="button" title="Datasheet already confirmed. Unable to edit" class="btn fa-btn-e"><i class="fa fa-edit"></i></button>
										<?php }else{ ?>
											<button type="button" title="Edit" class="btn fa-btn-e gEdit" data-id="<?php echo $List->ref_id; ?>" data-url="<?php echo $EdtUrl; ?>"><i class="fa fa-edit"></i></button>
										<?php } ?>
										</td>
										<td align="center">
										...
										<td align="center">
										<?php if($List->ds_release == "Y"){ ?>
											<span class="fa-btn-con" title="Confirmed"><i class="fa fa-check-circle-o"></i></span>
										<?php }else{ ?>
											<span class="fa-btn-ncon" title="Waiting for confirmation"><i class="fa fa-info-circle"></i></span>
										<?php } ?>
										</td>
									</tr>
								<?php $Slno++; } } ?>
							...
							<div class="row" align="center">
								<a data-url="ScheduleRates" class="btn btn-info">Back</a>
							</div>
						</blockquote>
