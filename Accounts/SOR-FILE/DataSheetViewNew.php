						...
						<blockquote class="bq1 stable" style="overflow:auto">
							<div class="row">
										...
										<div class="row innerdiv group-div" align="center">
											...
											<table class="dstable table2excel" width="95%">
												...
												?>
													...
													<tr>
														<td class="div-tdcell">&nbsp;</td>
														<td class="div-tdcell ltext" colspan="3">Add <?php echo IndianMoneyFormat($DefValPercArr[1]); ?> % <?php echo $DefValNameArr[1]; ?></td>
													...
													<tr>
														<td class="div-tdcell">&nbsp;</td>
														<td class="div-tdcell ltext" colspan="3"><?php echo $DefValCodeArr[6]; ?> = (<?php echo $DefValPercArr[6]; ?> * WC)</td>
														<td class="div-tdcell">&nbsp;</td>
													...
													<tr>
														<td class="div-tdcell">&nbsp;</td>
														<td class="div-tdcell ltext" colspan="3">Add <?php echo $DefValPercArr[2]; ?> % for <?php echo $DefValNameArr[2]; ?> on (X)</td>
													...
													<tr>
														<td class="div-tdcell">&nbsp;</td>
														<td class="div-tdcell ltext" colspan="3"><?php echo $DefValPercArr[3]; ?> % <?php echo $DefValNameArr[3]; ?> on Y</td>
													...
													<tr>
														<td class="div-tdcell">&nbsp;</td>
														<td class="div-tdcell ltext" colspan="3"><?php echo $DefValPercArr[4]; ?> % <?php echo $DefValNameArr[4]; ?> on W</td>
														<td class="div-tdcell ctext"><?php echo $DefValCodeArr[4]; ?></td>
													...
													<tr>
														<td class="div-tdcell">&nbsp;</td>
														<td class="div-tdcell ltext" colspan="3">Add <?php echo $DefValPercArr[5]; ?> % <?php echo $DefValNameArr[5]; ?> on W per 1 unit</td>
														<td class="div-tdcell ctext">&nbsp;</td>
								...
								<div class="div12" align="center">
									<?php if(isset($_GET['Action']) == 'C'){ ?>
									<a data-url="DataSheetConfirmWaitingList" class="btn btn-info">Back</a>
									<?php }else{ ?>
