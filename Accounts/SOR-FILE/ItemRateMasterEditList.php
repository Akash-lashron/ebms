...
$SelectQuery = "select * from item_master where par_id != 0 order by item_code asc"; 
									...
									<table align="center" class="table itemtable formtable" width="100%">
										<thead>
											<tr>
												...
												<td colspan="2" class="fhead"><input type="text" name="txt_wef_date" id="txt_wef_date" class="tboxclass" value="<?php //echo $List->price; ?>" required style="text-align:left"></td>
											</tr>
											<tr>
										...
										<?php $SNo = 1; if($RowCount == 1){ while($List = mysqli_fetch_object($SelectSql)){ ?>
											<tr>
												...
												<td nowrap="nowrap" class="cboxlabel"><?php echo $List->item_code; ?></td>
												<td width="60%" class="lboxlabel"><?php echo $List->item_desc; ?></td>
												<td class="cboxlabel">
													<input type="text" name="txt_item_rate[]" id="txt_item_rate" class="tboxclass itemRate" value="<?php echo $List->price; ?>" onKeyPress="return isNumberWithTwoDecimal(event,this);" maxlength="11" autocomplete="off" readonly="">
