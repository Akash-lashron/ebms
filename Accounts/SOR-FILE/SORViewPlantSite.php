...
include "common.php";
$PageName = $PTPart1.$PTIcon.'Abstract'.$PTIcon."Plant Site";
	...
	if (isset($category['parent_cats'][$parent])) {
		foreach ($category['parent_cats'][$parent] as $cat_id) {
			...
			if($IsDataSheet == 1){
				...
				$html .= "<tr class='labeldisplay'><td class='tdrowbold' valign='middle' align='center'>" . $category['categories'][$cat_id]['type'] ."</td><td valign='middle' class='tdrow'>". $category['categories'][$cat_id]['group_desc'] . "</td><td class='tdrow' align='center' valign='middle'>".$DMUnit."</td><td class='tdrow' align='right' valign='middle'>".IndianMoneyFormat($IGCAR)."</td></tr>";
			}
			//if(isset($category['parent_cats'][$cat_id])){
			if($IsDataSheet == 0){
					...
					<div class="grid_12" align="center">
						...
						<blockquote class="bq1 stable" style="overflow:auto">
							...
							<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="color1 dataTable">
								<thead>
									<tr>
										<th align="center" colspan="4" style="background:#136BCA; color:#ffffff; border-color:#136BCA">SOR View - Plant Site</th>
									</tr>
									<tr>
