	...
	if (isset($category['parent_cats'][$parent])) {
		foreach ($category['parent_cats'][$parent] as $cat_id) {
			if (!isset($category['parent_cats'][$cat_id])) {
				...
				$html .= "<tr class='labeldisplay'><td class='tdrowbold' valign='middle' align='center'>" . $category['categories'][$cat_id]['type'] ."</td><td valign='middle' class='tdrow'>". $category['categories'][$cat_id]['group_desc'] . "<br/><textarea name='txt_short_note_".$category['categories'][$cat_id]['id']."' class='tboxsmclass' style='width:100%'>".$category['categories'][$cat_id]['short_desc']."</textarea><input type='hidden' name='txt_group_id[]' value='".$category['categories'][$cat_id]['id']."'></td><td class='tdrow' align='center' valign='middle'>".$DMUnit."</td><td class='tdrow' align='right' valign='middle'>".$TSRate."</td><td class='tdrow' align='right' valign='middle'>".$IGCAR."</td></tr>";
