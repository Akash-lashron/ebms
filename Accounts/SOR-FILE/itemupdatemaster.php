...
else
{
	...
	<table width="1000" border="1" align="center" cellpadding="0" cellspacing="0" class="color2">
		...
		<tr class="labelboldcenter" height="25">
			<td colspan="4">With effects from : <input type="text" name="txt_wef_date" id="txt_wef_date" value="" class="datapicker"></td>
		</tr>
		<tr class="labelboldcenter" height="25">
			<td>S.No</td>
			<td>Name</td>
		...
		$sql_level3="select * from item_master where item_id like '" . $_POST['cmb_single_level2'] . "%'
						and char_length(item_id) = '9' order by item_desc";
		$rs_level3=mysqli_query($dbConn,$sql_level3,$conn);
