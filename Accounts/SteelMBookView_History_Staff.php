...
$selectmbookno_query = mysqli_query($dbConn,$selectmbookno_sql);
$cnt = mysqli_num_rows($selectmbookno_query);
if(mysqli_num_rows($selectmbookno_query) == 1)
{
	$mbookno = @mysqli_result($selectmbookno_query,0,'mbno');
	$mpage = @mysqli_result($selectmbookno_query,0,'startpage');
}
if(mysqli_num_rows($selectmbookno_query) == 2)
{
	while($MBookList = mysqli_query($dbConn,$selectmbookno_query))
	{
