						...
						<div class="row">
							<div class="box-container box-container-lg">
											...
											<div class="card-body padding-1">
												<div class="taxrow">
													<div class="row">
														...
														<div class="row smclearrow"><div class="smheadclearrow"><span class="spanhead">Contractor & Bank Details</span></div></div>
														<div class="div6 pd-lr-1">
															<div class="lboxlabel smlabel">Contractor Name</div>
															<div>
														...
														<div class="div3 pd-lr-1">
															<div class="lboxlabel smlabel">PAN Number</div>
															<div>
																<input type="text" name="txt_pan_no" id="txt_pan_no" class="tboxsmclass" required />
															</div>
														</div>
														<div class="div3 pd-lr-1">
															<div class="lboxlabel smlabel">GST Number</div>
															<div>
														...
														<div class="row smclearrow"></div>
														<div class="div3 pd-lr-1">
															<div class="lboxlabel smlabel">Bank Account No.</div>
															<div>
																<input type="text" name="txt_bank_acc" id="txt_bank_acc" class="tboxsmclass" required />
															</div>
														</div>
														<div class="div3 pd-lr-1">
															<div class="lboxlabel smlabel">Bank Name</div>
															<div>
																<input type="text" name="txt_bank_name" id="txt_bank_name" class="tboxsmclass" required />
															</div>
														</div>
														<div class="div3 pd-lr-1">
															<div class="lboxlabel smlabel">Branch</div>
															<div>
																<input type="text" name="txt_branch" id="txt_branch" class="tboxsmclass" required />
															</div>
														</div>
														<div class="div3 pd-lr-1">
															<div class="lboxlabel smlabel">IFSC</div>
															<div>
																<input type="text" name="txt_ifsc" id="txt_ifsc" class="tboxsmclass" required />
															</div>
														</div>
														<div class="row smclearrow"><div class="smheadclearrow"><span class="spanhead">Bill Details</span></div></div>
														<div class="div3 pd-lr-1">
															<div class="lboxlabel smlabel">Bill Value</div>
															<div>
																<input type="text" name="txt_bill_value" id="txt_bill_value" class="tboxsmclass" required />
															</div>
														</div>
														<div class="div3 pd-lr-1">
															<div class="lboxlabel smlabel">Bill Amount for IT</div>
															<div>
																<input type="text" name="txt_bill_amt_it" id="txt_bill_amt_it" class="tboxsmclass" required />
															</div>
														</div>
														<div class="div3 pd-lr-1">
															<div class="lboxlabel smlabel">Bill Amount for GST</div>
															<div>
																<input type="text" name="txt_bill_amt_gst" id="txt_bill_amt_gst" class="tboxsmclass" required />
															</div>
														</div>
														<div class="div3 pd-lr-1">
															<div class="lboxlabel smlabel">Is Advance Payment ?</div>
															<div>
																<div class="div2" style="padding-top:3px;" align="center"><input type="checkbox" name="ch_is_advance" id="ch_is_advance" value=""></div>
																<div class="div10"><input type="text" name="txt_adv_amt" id="txt_adv_amt" class="tboxsmclass" required /></div>
															</div>
														</div>
														...
														<div class="div12 lboxlabel">
															...
															<input type="checkbox" name="rad_rab_for[]" id="rad_rab_for_sa" class="" value=""> Sec. Advance&nbsp;&nbsp; 
															<input type="checkbox" name="rad_rab_for[]" id="rad_rab_for_mob" class="" value=""> Mob. Advance &nbsp;&nbsp;
								...
								<div class="div4">
									<div class="card" style="margin-top:2px;">
										<div class="face-static">
											<div class="card-header inkblue-card">Voucher <span id="CourseChartDuration"></span></div>
											<div class="card-body padding-1">
												<div class="row">
