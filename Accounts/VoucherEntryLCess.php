								...
								<div class="div2">
									<div class="card" style="margin-top:2px;">
										...
										<div class="face-static tabbtn tabbtn-active">
											<div class="card-body padding-1">
												<div class="row">
													<i class="fa fa-check-square-o" style="font-size:14px"></i>&nbsp;&nbsp;Labour Cess Voucher	
												</div>                         
											</div>
										</div>
										</a>
								...
								<div class="div12">
									<div class="card cabox" style="margin-bottom:1px;">
										<div class="face-static">
											<div class="card-header inkblue-card" align="left">&nbsp;Labour Cess Voucher</div>
																		...
																		<div class="div4 pd-lr-1">
																			...
																			<div>
																				<select name="cmb_nature_claim" id="cmb_nature_claim" class="dynamicboxlg inp">
																					<option value="LCESS" selected="selected">LCESS</option>
