...
if(isset($_POST['btnSave'])){
	...
	if($InsertSql == true){
		$msg = "Miscellaneous Voucher data saved successfully";
		$success = 1;
	}else{
		$msg = "Error : Miscellaneous Voucher data not saved";
		$success = 0;
	}
}
?>
								...
								<div class="div2">
									<div class="card" style="margin-top:2px;">
										...
										<div class="face-static tabbtn tabbtn-active">
											<div class="card-body padding-1">
												<div class="row">
													<i class="fa fa-check-square-o" style="font-size:14px"></i>&nbsp;&nbsp;Miscellaneous Voucher
												</div>                         
											</div>
										</div>
										</a>
								...
								<div class="div12">
									<div class="card cabox" style="margin-bottom:1px;">
										<div class="face-static">
											<div class="card-header inkblue-card" align="left">&nbsp;Miscellaneous Voucher</div>
																...
																<div class="row" align="center">
																	...
																	<div class="div12 smlboxlabel">
																		...
																		<div class="div6 pd-lr-1">
																			...
																			<div>
																				<select name="cmb_nature_claim" id="cmb_nature_claim" class="dynamicboxlg inp">
