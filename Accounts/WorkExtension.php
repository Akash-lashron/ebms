...
if($SheetId != ''){
	...
	if($SelectSheetSql == true){
		if(mysqli_num_rows($SelectSheetSql)>0){
			$List = mysqli_fetch_object($SelectSheetSql);
	...
	$SelectWoExtSql = mysqli_query($dbConn,$SelectWoExtQuery);
	if($SelectWoExtSql == true){
		if(mysqli_num_rows($SelectWoExtSql)>0){
			$ExtCount = 1;
		}
	}
}
													...
													<div class="div12" align="center">
														<div class="innerdiv2">
															<div class="row" align="center">
																...
																if($ExtCount > 0){
																	$Slno = 1;
																	while($ExtList = mysqli_fetch_object($SelectWoExtSql)){
																?>
																		<div class="row smclearrow"></div>
																		<div class="div4 pd-lr-1">
