													...
													<div class="card-body padding-1 ChartCard" id="CourseChart">
														<div class="divrowbox pt-2">
															<div class="table-responsive dt-responsive ResultTable">
											                    ...
											                    <div class="div2 dataFont">CCODE</div>
										                        <div class="div4">
												              ...
												              <div class="row clearrow"></div>
													          <div class="div2 dataFont">Technical Sanction No.</div>
												              <div class="div3">
													               <input type="text" class="tboxsmclass" name='text_techsanctionno' required id='text_techsanctionno' value="">
												              </div>
												              <div class="div3 dataFont" align="center">&nbsp;&nbsp;HOA Code&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&emsp;</div>
												              <div class="div3">
													        ...
													        <div class="row clearrow"></div>
													        <div class="div2 dataFont" align="center">Agreement Date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&emsp;</div>
													        <div class="div3">
														     <input type="text" class="tboxsmclass datepicker" name='txt_agreementdate' id='txt_agreementdate' required  value="">
													        </div>
													        <div class="div3 dataFont" align="center">&nbsp;&nbsp;Scheduled Date of Completion &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&emsp;</div>
													       <div class="div4">
														   ...
														   <div class="row clearrow"></div>
														   <div class="div2 dataFont">Enggineer IC No.</div>
														   <div class="div4">
										                   ...
										                   <div class="row clearrow"></div>
												           <div class="row">
												              <div class="div4 dataFont">&nbsp;Contractor Address</div>
														      <div class="div4">
												  	     ...
												  	     <div class="row clearrow"></div>
														 <div class="row">
												       		<div class="div4 dataFont">&nbsp;Contractor State</div>
															<div class="div4">
														...
														<div class="row clearrow"></div>
														    <table class="dataTable etable " align="center" width="100%" id="PGTable">
																...
																<tr>
																	...
																	<td align="center"><input type="text" name="instrunum_0" id ="instrunum_0" class="tboxclass" style="width:110px;"></td>
																	<td align="center"><input type="text" class="tboxclass" style="width:100px;" name="txt_bankname_pg_0" id="txt_bankname_pg_0"></td>
																	<td align="center"><input type="text"  placeholder="DD/MM/YYYY"  class="tboxclass datepicker date"style="width:100px;" readonly name="txt_date_pg_0" id="txt_date_pg_0"></td>
																	<td align="center"><input type="text" placeholder="DD/MM/YYYY" class="tboxclass datepicker expdate" style="width:100px;" readonly name="txt_expir_date_pg_0" id="txt_expir_date_pg_0"></td>
																	<td align="center"><input type="text"class="tboxclass" style="width:100px;" name="txt_part_amt_0" id="txt_part_amt_0"></td>
																	<td align="center"><input type="button"  class="fa btn btn-info" name="pg_add" id="pg_add"  value="ADD" class="fa btn btn-info"></td>
																</tr>
													        ...
													        <div class="row clearrow"></div>
															<div class="div1 dataFont">&nbsp;&nbsp;&nbsp;</div>
															<div class="div3 dataFont">GST Rate on Work Order %</div>
															<div class="div2">
																	<input type="text" class="tboxsmclass" name='txt_gst_value' required id='txt_gst_value' value="">
															</div>
															<div class="div1 dataFont">&nbsp;&nbsp;&nbsp;</div>
															<div class="div2 dataFont">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LCESS Applicable</div>
															<div class="div2 dataFont">
															   <input type="radio" class="dataFont lcess_app" name="lcess_app" value="Y" id="lcess_app_y" />
																<label for="y">YES</label>
																<input type="radio" class="dataFont lcess_app" name="lcess_app" value="N" id="lcess_app_n" />
																<label for="z">NO</label>
															</div>
														    <div class="row clearrow"></div>
													    	<div class="div1 dataFont">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
															<div class="div3 dataFont">&nbsp;Security Deposit %</div>
															<div class="div2">
																	<input type="text" class="tboxsmclass" name='txt_sd_per' required id='txt_sd_per' value="">
															</div>
															<div class="div1 dataFont">&nbsp;&nbsp;&nbsp;</div>
															<div class="div2 dataFont">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Total SD Value(&#8377;)</div>
															<div class="div2 dataFont">
															   <input type="text" class="tboxsmclass" name='txt_sd_value' required id='txt_sd_value' value="">
															</div>
															<div class="row clearrow"></div>
															<div class="div1 dataFont">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
															<div class="div3 dataFont">Upto Date Security Deposit</div>
															<div class="div5">
															...
															<div class="row clearrow"></div>
															<div class="div1 lboxlabel">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
															<div class="div3 dataFont">Upto Date Value of Work</div>
															<div class="div5">
															...
															<div class="row clearrow"></div>
															<div class="div1 dataFont">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
															<div class="div3 dataFont">Last Payment Date</div>
															<div class="div5">
