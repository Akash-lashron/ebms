															...
															<div class="table-responsive dt-responsive rtabdiv" id="table-stmt">
																...
																<!--<div class="row clearrow"></div> -->
																	...
																	<div class="col-status" data-id='A'><div class="well well-sm well-A <?php if($View == "A"){ ?> active <?php } ?>"><span class="rlable-pink">Total Work List</span></div></div>
																		<?php foreach($AllDispArr as $key => $value){ ?>
																			<div class="col-status" data-id='<?php echo $key; ?>'><div class="well well-sm well-A <?php if($View == "$key"){ ?> active <?php } ?>"><span class="rlable-pink"><?php echo $value; ?></span></div></div>
																		<?php } ?>
																	</div>
																</div>
																<!--<div class="row clearrow"></div>-->
