									...
									<div class="div12">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="center">CST Confirm And CCNO. Creation</div>
																		...
																		if($sheetsqlquery == true){
																			if(mysqli_num_rows($sheetsqlquery)>0){
																				while($List=mysqli_fetch_object($sheetsqlquery)){
																					...
																					asort($ContPosiArr);   $L = 0;   $PrevContAmt = '';
																					foreach($ContPosiArr as $ContKey => $ContValue){
																						$TotalAmt = $ContDataArr[$TendrId][$ContKey][2];
																						if($TotalAmt == $PrevContAmt){
																							if($L == 0){
																								$L = 1;
																							}else{
																								$L = $L;
