        ...
        $last_id = mysql_insert_id();
			...
			{ // Loop to get all sheets in a file.
				...
				{ // checking sheet not empty
                    for ($j = 5; $j <= count($data->sheets[$i][cells]); $j++) 
					{ // loop used to get each row of the sheet
                        ...
                        } // cond for qty and rate and per not empty
                                   //// }
                           //// }
                            $previd = $eid;
                        //}
                        ...
                        } // cond for if name not empty
                    } // if cond for eid not empty and name not empty
