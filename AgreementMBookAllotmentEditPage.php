...
if(isset($_POST['Submit'])){
	...
	if(count($GenCheck) > 0){
		...
		foreach($GenCheck as $Value){
			...
			$Mbno 		= $ExpGMBStr[1];
			if($Mbno != ''){
				$InsertQuery = "delete from agreementmbookallotment where sheetid='$sheetid' and allotmentid='$MbId'";
...
if($_GET['sheetid'] != ''){
	...
	$SelectQuery  =  "SELECT agreementmbookallotment.mbno, agreementmbookallotment.mbooktype, agreementmbookallotment.allotmentid FROM agreementmbookallotment
...
<script type="text/javascript">
	...
	function goBack()
	{
		url = "AgreementMBookAllotmentEdit.php";
