     ...
     { 
		...
		function addrow()
		{
			...
			var txt_box1 = document.createElement("input");
				txt_box1.name = "txt_base_index_desc[]";
				txt_box1.id = "txt_base_index_desc"+index;
			...
			var txt_box2 = document.createElement("input");
				txt_box2.name = "txt_base_index[]";
				txt_box2.id = "txt_base_index"+index;
			...
			var cmb_box1 = document.createElement("select");
				cmb_box1.name = "cmb_index_type[]";
				cmb_box1.id = "cmb_index_type"+index;
				cmb_box1.setAttribute('class', "extraItemTextbox"); 
				cell3.appendChild(cmb_box1);
			var option1 = document.createElement("option");
				option1.value = 	"";
                option1.text 	= 	"------Select------";
				cmb_box1.appendChild(option1);
			var option2 = document.createElement("option");
				option2.value = 	"10CA";
                option2.text 	= 	"10 CA";
				cmb_box1.appendChild(option2);
			var option3 = document.createElement("option");
				option3.value = 	"10CC";
                option3.text 	= 	"10 CC";
				cmb_box1.appendChild(option3);
				
				cmb_box1.onblur = (function (ind) {
					return function() {
					//calculateAmount(this,ind,"qty","slm")
						//ValidateSlm();
					};
			...
			var txt_box3 = document.createElement("input");
				txt_box3.name = "txt_escal_prec[]";
				txt_box3.id = "txt_escal_prec"+index;
				txt_box3.setAttribute('class', "extraItemTextbox"); 
				cell4.appendChild(txt_box3);
			...
			var txt_box4 = document.createElement("input");
				txt_box4.name = "txt_escal_prec_name[]";
				txt_box4.id = "txt_escal_prec_name"+index;
				txt_box4.setAttribute('class', "extraItemTextbox"); 
				cell5.appendChild(txt_box4);
                ...
                <div class="container_12">
                    <div class="grid_12">
                        ...
                        <blockquote class="bq1">
                            <div class="title">Base Index</div>
                        ...
                        <table width="1078px" border="0" align="center" cellpadding="0" cellspacing="0" class="color1">
										...
										<div style="width:70%; height:auto;" align="center">
											<table width="100%" class="table1" id="table1">
												<tr class="label" style="background-color:#EAEAEA; height:35px;">
													<td align="left" valign="middle" nowrap="nowrap">Description</td>
													<td align="center" valign="middle">Base Index <i class='fa fa-inr' style='font-weight:normal; padding-top:5px;'></td>
													<td align="center" valign="middle">Under Head<br/>(10CC<sup style="font-size:11px; color:#E70601">*</sup>/10CA<sup style="font-size:11px; color:#E70601">*</sup>)</td>
													<td align="center" valign="middle" colspan="2">Escalation Break up</td>
													<td align="center" valign="middle"><input type="button" class="buttonstyle" name="btn_add" id="btn_add" value="ADD" onClick="addrow()"></td>
												</tr>
												<tr class="labeldisplay" style="background-color:#EAEAEA">
													...
													<td align="center"><input type="text" class="extraItemTextbox" name="txt_material_baseindex" id="txt_material_baseindex"></td>
													<td align="center" valign="middle">
													<select class="extraItemTextbox" name="cmb_material_bi_type" id="cmb_material_bi_type">
														<option value="">------Select------</option>
														<option value="10CA">10 CA</option>
														<option value="10CC">10 CC</option>
													</select>
													</td>
													<td align="center"><input type="text" class="extraItemTextbox" name="txt_material_escal_perc" id="txt_material_escal_perc"></td>
													<td align="center" valign="middle">
														<!--<input type="text" class="extraItemTextbox" name="txt_material_escal_percname" id="txt_material_escal_percname">-->
														&emsp;X<sub>M</sub>&emsp;
													</td>
												...
												<tr class="labeldisplay" style="background-color:#EAEAEA">
													...
													<td align="center"><input type="text" class="extraItemTextbox" name="txt_cement_baseindex" id="txt_cement_baseindex"></td>
													<td align="center" valign="middle">
													<select class="extraItemTextbox" name="cmb_cement_bi_type" id="cmb_cement_bi_type">
														<option value="">------Select------</option>
														<option value="10CA">10 CA</option>
														<option value="10CC">10 CC</option>
													</select>
													</td>
													<td align="center"><input type="text" class="extraItemTextbox" name="txt_cement_escal_perc" id="txt_cement_escal_perc"></td>
													<td align="center" valign="middle">
														<!--<input type="text" class="extraItemTextbox" name="txt_cement_escal_percname" id="txt_cement_escal_percname">-->
														&emsp;X<sub>C</sub>&emsp;
													</td>
													<td align="center" valign="middle">&nbsp;</td>
												</tr>
												<tr class="labeldisplay" style="background-color:#EAEAEA">
													...
													<td align="center"><input type="text" class="extraItemTextbox" name="txt_steel_baseindex" id="txt_steel_baseindex"></td>
													<td align="center" valign="middle">
													<select class="extraItemTextbox" name="cmb_steel_bi_type" id="cmb_steel_bi_type">
														<option value="">------Select------</option>
														<option value="10CA">10 CA</option>
														<option value="10CC">10 CC</option>
													</select>
													</td>
													<td align="center"><input type="text" class="extraItemTextbox" name="txt_steel_escal_perc" id="txt_steel_escal_perc"></td>
													<td align="center" valign="middle">
														<!--<input type="text" class="extraItemTextbox" name="txt_steel_escal_percname" id="txt_steel_escal_percname">-->
														&emsp;X<sub>S</sub>&emsp;
													</td>
													<td align="center" valign="middle">&nbsp;</td>
												</tr>
												<tr class="labeldisplay" style="background-color:#EAEAEA">
													...
													<td align="center"><input type="text" class="extraItemTextbox" name="txt_labour_baseindex" id="txt_labour_baseindex"></td>
													<td align="center" valign="middle">
													<select class="extraItemTextbox" name="cmb_labour_bi_type" id="cmb_labour_bi_type">
														<option value="">------Select------</option>
														<option value="10CA">10 CA</option>
														<option value="10CC">10 CC</option>
													</select>
													</td>
													<td align="center"><input type="text" class="extraItemTextbox" name="txt_labour_escal_perc" id="txt_labour_escal_perc"></td>
													<td align="center" valign="middle">
														<!--<input type="text" class="extraItemTextbox" name="txt_labour_escal_percname" id="txt_labour_escal_percname">-->
														&emsp;Y<sub></sub>&emsp;
													</td>
													<td align="center" valign="middle" id="btn_td4">&nbsp;</td>
												</tr>
												<!--<tr>
                            ...
                            <div style="padding-left:16%; font-size:10px" class="labeldisplay">
								<sup style="font-size:10px; color:#E70601">* </sup>10CA - Monthly wise and 10CC - Quarterly Wise.
							</div>
