            ...
            <div class="content">
                ...
                <div class="container_12">
                  <div class="grid_12" align="center">
					<div align="right"><a href="BaseIndex_10CC.php">Add</a>&nbsp;&nbsp;&nbsp;</div>
                      <blockquote class="bq1" style="overflow:auto">
						<input type="hidden" name="hid_sheetid" id="hid_sheetid" value="<?php if($_GET['sheet_id'] != ''){ echo $_GET['sheet_id']; } ?>">
							...
							<?php
										$select_baseindex_query = "select * from base_index where sheetid = '$sheetid' and type = 'TCC'";
							...
							?>
								<tr class="label">
									...
									<td align="center" valign="middle">
										<?= $BIList->base_breakup_code; ?>
									</td>
									<td align="center" valign="middle">
										<?= $BIList->base_breakup_perc; ?> 
									</td>
									<td align="center" valign="middle">
