...
if (isset($_POST["submit"])) 
{
	...
	$base_breakup_code_arr 		= 	$_POST['txt_base_breakup_code'];
	$base_breakup_perc_arr 		= 	$_POST['txt_base_breakup_perc'];
	$count = count($base_index_item_arr);
	//echo $base_index_item;
	//print_r($base_price_rate_arr);exit;
	$delete_tca_query = "update base_index set active = '0', modifieddate  = NOW() where sheetid = '$sheetid' and type = 'TCC'";
	...
	for ($c = 0; $c<$count; $c++) 
	{
		...
		$base_breakup_code = $base_breakup_code_arr[$c];
		$base_breakup_perc = $base_breakup_perc_arr[$c];
		$tca_query 	= 	"INSERT INTO base_index set
									...
									base_breakup_code = '$base_breakup_code',
									base_breakup_perc = '$base_breakup_perc',
									type = 'TCC',
									active = '1',
									sheetid = '$sheetid',
									modifieddate  = NOW(),
...
<style>
 ...
 <script>
	var add_row_s 		= 3;
	var prev_edit_row 	= 0;
	var ItemArr = ["Material","Labour"];
	var CodeArr1 = ["MIo","LIo"];
	var CodeArr2 = ["Xm","Y"];
	var CodeArr3 = ["OTC","LAB"];
  	 function goBack()
	 {
	   	url = "dashboard.php";
...
//alert(data);
                ...
                else
                {
                   	...
                   	for(i = 0; i < name.length; i+=8)
                   	{
						...
						var txt_box4 = document.createElement("input");
							...
							txt_box4.id = "txt_base_breakup_code"+index;
						...
						var txt_box5 = document.createElement("input");
							...
							txt_box5.id = "txt_base_breakup_perc"+index;
		...
		function AssignCode(obj,ind){
			...
			document.getElementById("txt_base_breakup_code"+ind).value = "";
			if(count>1){
			...
			for(var i=0; i<ItemArr.length; i++){
				...
				if(itemDesc == selectedItem){
					...
					document.getElementById("txt_base_breakup_code"+ind).value = CodeArr2[i];
		...
		function getIndex(ind,IndexCode,MatCode){
            ...
            strURL = "find_material_index.php?workorderno=" + document.form.cmb_shortname.value+"&IndexCode="+IndexCode+"&MatCode="+MatCode+"&MatCata=10CC";
            xmlHttp.open('POST', strURL, true);
            xmlHttp.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
            xmlHttp.onreadystatechange = function ()
            {
    ...
    <body class="page1" id="top" oncontextmenu="return false"onload="noBack();" onpageshow="if (event.persisted) noBack();" onUnload="">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data" name="form">
           <?php include "Menu.php"; ?>
            <!--==============================Content=================================-->
            <div class="content">
                <div class="title">Base Index - 10CC</div>
                <div class="container_12">
                    <div class="grid_12">
                        <blockquote class="bq1" style="overflow:auto">
							<div align="right"><a href="BaseIndexView_10CC.php">View</a>&nbsp;&nbsp;&nbsp;</div>
												...
												<table width="100%" class="table1" id="table1">
													<tr class="label" style="background-color:#EAEAEA; height:35px;">
														...
														<td align="center" valign="middle" colspan="2">
															Base Index <!--<i class='fa fa-inr' style='font-weight:normal; padding-top:5px;'>-->
														</td>
														<td align="center" valign="middle" colspan="2">
															Escalation Breakup (in %)
														</td>
													...
													<tr class="label" style="background-color:#EAEAEA; height:35px;">
														...
														<td align="center" valign="middle" nowrap="nowrap">
															Index<!--Rate <i class='fa fa-inr' style='font-weight:normal; padding-top:5px;'>-->
														</td>
