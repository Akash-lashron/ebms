				...
				<div class="container_12">
					<div class="grid_12" align="center">
						...
						<blockquote class="bq1" style="overflow:auto">
							<div class="row"><div class="div12 lboxlabel" style="text-align:center">&nbsp;</div></div>
							<div class="row">
								<div class="div12 lboxlabel" style="text-align:center"><font color="#2769AC" style="font-size:20px">Nuclear Recycle Board (NRB)</br>Fast Reactor Fuel Facility (FRFCF)</br>Proposed RE 2022-23</font></div>
							</div>
							<div class="row"><div class="div12 lboxlabel" style="text-align:center">&nbsp;</div></div>
							<div class="row">
								...
								<div class="div8" align="center">
									<table align="center" class="table itemtable formtable" width="100%">
										<thead>
											<tr>
												<td colspan="4" class="cboxlabel fhead" style="text-align:right">Expenditure up to</td>
												<td colspan="1" class="cboxlabel">JUL-22</td>
											</tr>
											<tr>
												<th nowrap="nowrap">S No.</th>
												<th nowrap="nowrap" width="2%">Object Heads</th>
												<th width="60%">BE Approved</br>2022-23</th>
												<th nowrap="nowrap">Proposed RE</br>2022-23</th>
												<th nowrap="nowrap">Expenditure</br>till Date</th>
											</tr>
										</thead>
										<tbody>
										<?php $SNo = 1; if($RowCount == 1){ while($List = mysqli_fetch_object($SelectSql)){ ?>
											...
											<tr <?php echo $RowStyle; ?> class="<?php echo $Cls; ?>">
												...
												<td class="cboxlabel">
													...
													?>
													<input type="text" name="txt_item_rate[]" id="txt_item_rate" class="tboxclass itemRate" value="<?php echo $DefPerc; ?>" onKeyPress="return isNumberWithTwoDecimal(event,this);" maxlength="11" style="text-align:center" autocomplete="off">
								...
								<div class="div12" align="center" vertical-align="middle">
