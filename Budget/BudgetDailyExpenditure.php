...
include "common.php";
$PageName = $PTPart1.$PTIcon.'Daily Expenditure';
$msg = "";
									...
									<div class="div6">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card">Monthly Expenditure <span id="CourseChartDuration"></span></div>
												<div class="card-body padding-1 ChartCard" id="CourseChart">
													...
													<div class="divrowbox">
														<div class="div4" align="left"><lable class="divlable">From Date</label></div>
														<div class="div8">
															<input type="text" name="txt_from_date" id="txt_from_date" class="tboxclass" required />
														</div>
													</div>
													<div class="divrowbox">
