...
include "common.php";
$PageName = $PTPart1.$PTIcon.'Discipline Wise Expenditure';
$msg = "";
							...
							<div class="row">
									...
									<div class="div8">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="left">&nbsp;Discipline Wise Expenditure <span id="CourseChartDuration"></span></div>
								...
								<div class="box-container box-container-lg" align="center">
									...
									<div class="div8">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="left">&nbsp;Discipline Wise Expenditure Statement <span id="StmtDuration"></span></div>
												<div class="card-body padding-1 ChartCard" id="CourseChart">
													<div class="divrowbox pt-2">
