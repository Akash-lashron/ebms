...
include "common.php";
$PageName = $PTPart1.$PTIcon.'Monthly Expenditure Plan for Upcoming Financial Year';
$msg = "";
$CurrYear = date('Y');
									...
									<div class="div12">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="left">&nbsp;Monthly Expenditure Plan for Upcoming Financial Year <span id="CourseChartDuration"></span></div>
