...
include "common.php";
$PageName = $PTPart1.$PTIcon.'Half Yearly Expenditure';
$msg = "";
									...
									<div class="div6">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card">Half Yearly Expenditure <span id="CourseChartDuration"></span></div>
												<div class="card-body padding-1 ChartCard" id="CourseChart">
													...
													<div class="divrowbox">
														<div class="div4" align="left"><lable class="divlable">Period</label></div>
														<div class="div8">
															<select class="group selectlgbox" name="cmb_quarter" id="cmb_quarter" required>
																<option value=""> ------------------------ Select ------------------------ </option>
																<option value="I">Q1 & Q2 (April - September)</option>
																<option value="II">Q3 & Q4 (October - March)</option>
															</select>
														</div>
													</div>
													<!--<div class="divrowbox">
