...
include "common.php";
$PageName = $PTPart1.$PTIcon.'Quarterly Expenditure';
$msg = "";
									...
									<div class="div6">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card">Quarterly Expenditure <span id="CourseChartDuration"></span></div>
												<div class="card-body padding-1 ChartCard" id="CourseChart">
													...
													<div class="divrowbox">
														<div class="div4" align="left"><lable class="divlable">Quarter</label></div>
														<div class="div8">
															<select class="group selectlgbox" name="cmb_quarter" id="cmb_quarter" required>
																<option value=""> ------------------------ Select ------------------------ </option>
																<option value="ALL">All Quarters</option>
																<option value="I">Quarter - I</option>
																<option value="II">Quarter - II</option>
																<option value="III">Quarter - III</option>
																<option value="IV">Quarter - IV</option>
															</select>
														</div>
													</div>
													<!--<div class="divrowbox">
