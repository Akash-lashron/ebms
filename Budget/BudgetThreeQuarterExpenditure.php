...
include "common.php";
$PageName = $PTPart1.$PTIcon.'Three Quarters Expenditure';
$msg = "";
									...
									<div class="div6">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card">Three Quarters Expenditure <span id="CourseChartDuration"></span></div>
													...
													<div class="divrowbox">
														...
														<div class="div8">
															<select class="group selectlgbox" name="cmb_quarter" id="cmb_quarter" required>
																<option value=""> ------------------------ Select ------------------------ </option>
																<option value="I">Q1 - Q3 (April - December)</option>
															</select>
														</div>
													</div>
													<!--<div class="divrowbox">
