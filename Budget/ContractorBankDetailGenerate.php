...
include "common.php";
$PageName = $PTPart1.$PTIcon.'Contractor Details Upload';
//checkUser();
$msg = ""; $del = 0;
$RowCount = 0;
...
if ($_POST["submit"]) {
    ...
    if($checkupload == 1) {
		...
		if($Execute > 0){
			$msg = "Bidder's Bank Details Saved Successfully";
			$success = 1;
		}else{
			$msg = "Error : Bidder's Bank Details Not Saved. Please Try Again.";
			$success = 0;
		}
	}
} //submit 
                        ...
                        <blockquote class="bq1" style="overflow:auto">
							...
							<div class="container">
								<div class="row ">
									...
									<div class="div2">&nbsp;</div>
									<div class="div8">
										<div class="row divhead head-b" align="center">Contractor Bank Detail Upload</div>
