...
if($_SESSION['isadmin'] == 1){
	...
	WHERE b.inst_type = 'BG' AND b.inst_status != 'R'  AND b.inst_exp_date < '$CurrDate' AND (c.eic = '".$_SESSION['sid']."' OR c.created_by = '".$_SESSION['userid']."')";
}
																...
																<table width="100%" align="center" class="dataTable table2excel mgtb-8">
																	<thead>
																		...
																		<tr>
																			...
																			<th rowspan="2" valign="middle">BG Amount<br> ( &#8377; ) </th>
