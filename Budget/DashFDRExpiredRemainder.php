...
if($_SESSION['isadmin'] == 1){
	$MasterQuery1 = "SELECT a.tr_id, b.bfdid, b.inst_exp_date,b.inst_type, b.inst_purpose FROM loi_entry a 
	...
	WHERE b.inst_type = 'FDR' AND b.inst_status != 'R'  AND b.inst_exp_date < '$CurrDate' AND (c.eic = '".$_SESSION['sid']."' OR c.created_by = '".$_SESSION['userid']."')";
}
...
if($ImpDetIds != ''){
	if($_SESSION['isadmin'] == 1){
		...
		INNER JOIN staff f ON (e.eic = f.staffid)
		WHERE b.bfdid IN ($ImpDetIds) AND b.inst_type = 'FDR' AND b.inst_exp_date < '$CurrDate'
		AND (c.eic = '".$_SESSION['sid']."' OR c.created_by = '".$_SESSION['userid']."') 
		ORDER BY c.tr_id  ASC";
	}
																...
																<table width="100%" align="center" class="dataTable table2excel mgtb-8">
																	<thead>
																		...
																		<tr>
																			...
																			<th rowspan="2" valign="middle">Scheduled Date of<br>Completion</th>
																			<th rowspan="2" valign="middle"> Extended Date of<br>Completion</th>
																			<th rowspan="2" valign="middle">Engineer Incharge</th>
																			<th rowspan="2" valign="middle">Contractor Name</th>
																			<th rowspan="2" valign="middle">FDR Amount<br> ( &#8377; ) </th>
