...
include "common.php";
$PageName = $PTPart1.$PTIcon.'Department Estimate Uploads View';
checkUser();
$success = 0;
...
if($TenRegResultSql == true){
	if(mysqli_num_rows($TenRegResultSql)>0){
		while($TRList = mysqli_fetch_object($TenRegResultSql)){
			...
			array_push($GlobIdArr,$TRList->globid);
									...
									<div class="div12">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="center"> Department Estimate Uploads - View </div>
																...
																<table width="100%" align="center" class="dataTable table2excel mgtb-8">
																	...
																	<tbody>
																				...
																				if($DepEstResultSql == true){
																					if(mysqli_num_rows($DepEstResultSql)>0){
																						while($DepList = mysqli_fetch_object($DepEstResultSql)){
																							...
																							$WorkName 		= $DepList->work_name;
																							$RefNo 			= $DepList->ref_no;
																		...
																		<tr class='labeldisplay'>
																			...
																			<td valign='middle' class='tdrow' align = 'justify'><?php echo $RefNo; ?></td>
																			<td valign='middle' class='tdrow' align = 'justify'><?php echo $WorkName; ?></td>
																			<td class='tdrow' align='right' valign='middle'><?php echo IndianMoneyFormat($EstimateAmt); ?></td>
																			<td valign='middle' class='tdrow' align = 'justify'><?php echo $EstCreateDate; ?></td>
																			...
																			<td align='center' valign='middle' class='tdrow' >
																				<?php if(in_array($DepList->globid,$GlobIdArr)){ ?>
																					NIT Created
																				<?php }else{ ?>
																				<a data-url="DeptEstimateUploadGenerate?id=<?php echo $DepList->mastid; ?>" class=" BtnHref btn btn-info" name="View" id="View">
																					Re-Upload
																				</a>
																				<?php } ?>
																			</td>
