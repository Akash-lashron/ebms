																	...
																	<div class="row">
																		...
																		<table class="dataTable etable " align="center" width="100%" id="emdtable1">
																			...
																			<tr>
																				...
																				<td align="center">
																					<select name="cmd_itmno_colm" id ="cmd_itmno_colm" class="tboxsmclass"> 
																						<option value=""> -- Select -- </option> 
																						<?php 
																							$x = 0;
																							for($i='A'; $i<'ZZ'; $i++){
																				...
																				<td align="center">
																					<select name="cmd_desc_colm" id ="cmd_desc_colm" class="tboxsmclass"> 
																						<option value=""> -- Select -- </option> 
																						<?php 
																							$x = 0;
																							for($i='A'; $i<'ZZ'; $i++){
																				...
																				<td align="center">
																					<select name="cmd_qty_colm" id ="cmd_qty_colm" class="tboxsmclass"> 
																						<option value=""> -- Select -- </option> 
																						<?php 
																							$x = 0;
																							for($i='A'; $i<'ZZ'; $i++){
																				...
																				<td align="center">
																					<select name="cmd_unit_colm" id ="cmd_unit_colm" class="tboxsmclass">  
																						<option value=""> -- Select -- </option>
																						<?php 
																							$x = 0;
																							for($i='A'; $i<'ZZ'; $i++){
																				...
																				<td align="center">
																					<select name="cmd_rate_colm" id ="cmd_rate_colm" class="tboxsmclass">  
																						<option value=""> -- Select -- </option>
																						<?php 
																							$x = 0;
																							for($i='A'; $i<'ZZ'; $i++){
																				...
																				<td align="center">
																					<select name="cmd_amt_colm" id ="cmd_amt_colm" class="tboxsmclass">  
																						<option value=""> -- Select -- </option>
																						<?php 
																							$x = 0;
																							for($i='A'; $i<'ZZ'; $i++){
