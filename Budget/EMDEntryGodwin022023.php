...
if(isset($_POST['submit']) == " Save "){
	...
	if(($TrId != null)&&($EMdmasid != null)){
		...
		foreach($Emdinstnumstr as $Key => $Value){
			...
			$insert_query1	= "insert into emd_detail set emid='$EMdmasid', contid='$EmdCont', inst_type='$Emdinstype',inst_no='$Emdinstnum', bank_name='$Emdbname',
			branch_addr='$Emdbadd', issue_dt='$Emddate', valid_dt='$Emdexdate', emd_amt='$AmountList', active='1'";
		...
		foreach($Emdinstnumstr as $Key => $Value){
			...
			$insert_query1	= "insert into emd_detail set emid='$LastInsertid', contid='$EmdCont', inst_type='$Emdinstype',inst_no='$Emdinstnum', bank_name='$Emdbname',
			branch_addr='$Emdbadd', issue_dt='$Emddate', valid_dt='$Emdexdate', emd_amt='$AmountList', active='1'";
			$insert_sql1 = mysqli_query($dbConn,$insert_query1);
		}
		foreach($DDinstnumstr as $Key => $Value){
															...
															<div class="table-responsive dt-responsive rtabdiv" id="table-stmt">
																...
																<div class="row">
																   ...
																   <div class="row">
																	 ...
																	 <div class="div6">
																		<input type='text' readonly="" name='txt_full_emd_amt' id='txt_full_emd_amt' class="tboxsmclass" value="<?php if($_GET['id'] != ""){ echo $EMdamtt; } ?>">
																	...
																	<div class="card-header inkblue-card" align="left">&nbsp;EMD Details</div>
																		...
																		<tr>
																		    <td align="center">
																			 ...
																			 <td align="center"><input type="text" style="text-align:right;" maxlength="12" class="tboxsmclass" onKeyPress="return isNumberWithTwoDecimal(event,this);" name="txt_part_amt_0" id="txt_part_amt_0"></td>
																		...
																		if($ResultQuery2 == true){
																		   ...
																		   <tr id="<?php echo $Index; ?>">
																			  ...
																			  <td align="center"><input type="text" style="text-align:right;" maxlength="12" class="tboxsmclass EmAmt<?php echo $contid; ?>"  data-id="<?php echo $contid; ?>" data-index="<?php echo $Index; ?>"  onKeyPress="return isNumberWithTwoDecimal(event,this);" name="txt_part_amt[]" id="txt_part_amt_<?php echo $Index; ?>" value="<?php  echo $Emdamnt?>"></td>
