							...
							<div class="row">
								...
								<?php if($report==true){ ?>
									<table class="table itemtable rtable table2excel" border="1" width="100%" align="center">
										<tr><td colspan="13" class="tablehead"> BARC-NRB-FRFCF-KALPAKKAM <?php echo $heading; ?></td></tr>
										<tr><td colspan="13" class="tablehead"> FDR REGISTER <?php echo $heading; ?></td></tr>
										<tr>
									...
									if($rs_date_sql == true){
										...
										while($List = mysqli_fetch_object($rs_date_sql)){
											...
											while($List1 = mysqli_fetch_assoc($sql_selectSql)){
												...
												a.sheetid = '" . $SheetId . "' AND a.globid = '" . $GlobId . "' AND a.contid = '" . $ContId . "' AND b.bg_type = 'FD'";
													
												$sql_selectSql2 = mysqli_query($dbConn,$sql_select2);
												while($List3 = mysqli_fetch_object($sql_selectSql2)){
													$FDBankName	 = $List3->bank_name;
													$FDAmount	 = $List3->bg_amt;
													...
													while($List2 = mysqli_fetch_object($sql_selectSql1)){
														...
														echo "<td class='labelright' nowrap='nowrap'>" . $FDSerNo . " - " . $FDDt . "</td>";
														echo "<td class='labelright' nowrap='nowrap'>" . $FDAmount . "</td>";
														echo "<td class='labelright'>" . $FDBankName . "</td>";
														echo "<td class='labelright' nowrap='nowrap'>" . $FDExpDt . "</td>";
									...
									<?php }else{ ?>
										<table  class="table"  cellpadding="5" cellspacing="0" width="70%" align="center">
											<tr><td class="tablehead"> FDR REGISTER </td></tr>
										</table>
