...
if($Page == "TS"){
	...
	if($Checkpt == 1){
		...
		$SelectQuery7	= "SELECT a.staffid,a.staffname,a.intercom,b.designationname,c.section_name FROM staff a INNER JOIN designation b ON (a.designationid = b.designationid)
		...
		if(mysqli_num_rows($SelectQuery7Sql)>0){
			...
			$OutputArr['ENGGICNO']  = $List8['intercom'];
