							...
							<div class="box-container box-container-lg">
								<div class="div8">
									...
									<div class="div6">
										<div class="card">
											<div class="face-static" style="height:130px;">
												<div class="card-header seagreen-card ft12">Committed and Actual expenditure variation - FY 2022-23 <span id="CourseChartDuration">in Cr.</span></div>
												<div class="card-body padding-1 ChartCard" id="CourseChart">
													<div class="padd2 dcardbox">
														<div class="div8 dcardbox">
															<div class="dcardlabel">Approved BE/RE - <span class="sm-badge ft11">20</span></div>
															<div class="dcardlabel">Committed Expenditure (A) - <span class="sm-badge ft11">16</span></div>
															<div class="dcardlabel">Actual Expenditure (B) - <span class="sm-badge ft11">10</span></div>
															<div class="dcardlabel">Variation between (A) and (B) - <span class="sm-badge ft11">6</span></div>
														</div>
														<div class="div4">
								...
								<div class="div4">
									<div class="div12">
										<div class="card">
											<div class="face-static" style="height:130px">
												<div class="card-header seagreen-card ft12">Today's Expenditure (<?php echo date("d/m/Y"); ?>) <span id="CourseChartDuration">in Lakhs</span></div>
												<div class="card-body padding-1 ChartCard" id="CourseChart">
													<!--<div class="padd2" style="font-size:11px; text-align:left; padding-left:15px;">
...
function GaugeChart(){
	...
	// Data
	var data = [{
	  category: "Project Sanctioned",
	  value: 80,
	  full: 100,
	  columnSettings: {
		fill: "#007fd4"//chart.get("colors").getIndex(0)
	  }
	}, {
	  category: "Total Action Taken",
	  value: 35,
	  full: 100,
	  columnSettings: {
		fill: "#dd9b1a"//chart.get("colors").getIndex(1)
	  }
	}, {
	  category: "Total Committed amount",
	  value: 92,
	  full: 100,
	  columnSettings: {
		fill: "#08bf78"//chart.get("colors").getIndex(2)
	  }
	}, {
	  category: "Actual Expenditure up to date",
	  value: 100,
	  full: 100,
	  columnSettings: {
		fill: "#DF6DF8"//chart.get("colors").getIndex(3)
	  }
	}];
