							...
							<div class="row">
								...
								<?php if($report==true){ ?>
									<table class="table itemtable rtable table2excel" border="1" width="100%" align="center">
										<tr><td colspan="8" class="tablehead"> BARC-NRB-FRFCF-KALPAKKAM <?php echo $heading; ?></td></tr>
										<tr><td colspan="8" class="tablehead"> INCOME TAX RECOVERY DETAILS IN RESPECT OF CONTRACTORS <?php echo $heading; ?></td></tr>
										<tr>
									...
									<?php }else{ ?>
										<table  class="table"  cellpadding="5" cellspacing="0" width="70%" align="center">
											<tr><td class="tablehead"> INCOME TAX RECOVERY DETAILS </td></tr>
										</table>
