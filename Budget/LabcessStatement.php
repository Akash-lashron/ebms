							...
							<div class="row">
								...
								<?php if($report==true){ ?>
									<table class="table itemtable rtable table2excel" border="1" width="100%" align="center">
										<tr><td colspan="7" class="tablehead"> BARC-NRB-FRFCF-KALPAKKAM <?php echo $heading; ?></td></tr>
										<tr><td colspan="7" class="tablehead"> LABOUR CESS RECOVERY STATEMENT <?php echo $heading; ?></td></tr>
										<tr>
											<td class="colhead">S.No</td>
											<td class="colhead">CCODE</td>
											<td class="colhead">NAME OF CONTRACTOR</td>
											<td class="colhead">WORK</td>
											<td class="colhead">DTPMT</td>
											<td class="colhead">BILL VALUE</td>
											<td class="colhead">CLC AMOUNT</td>
										</tr>
									<?php
									$TotSumBillVal = 0;
									if($rs_date_sql == true){
										...
										while($List = mysqli_fetch_object($rs_date_sql)){
											...
											$VAmt 		= $List->lw_cess_amt;
											$VAmtIMF	= moneyFormat($List->lw_cess_amt);
											...
											while($List1 = mysqli_fetch_assoc($sql_selectSql)){
												...
												while($List2 = mysqli_fetch_object($sql_selectSql1)){
													...
													echo "<td class='labelright' nowrap>". $BillValIndForm ."</td>";
													echo "<td class='labelright' nowrap='nowrap'>" . $VAmtIMF . "</td>";
													echo "</tr>";
												}
											}
											$TotSumBillVal = $TotSumBillVal+$VAmt;
											$sno++;
										}
									...
									<?php }else{ ?>
										<table  class="table"  cellpadding="5" cellspacing="0" width="70%" align="center">
											<tr><td class="tablehead"> LABOUR CESS RECOVERY STATEMENT </td></tr>
										</table>
