													...
													<div class="row">
														<div class="row clearrow"></div>
												        	<div class="div3 lboxlabel">Technical Sanction Number</div>
																...
																<div class="row clearrow"></div>
																<div class="div3 lboxlabel">Tender Value (Rs.)</div>
																<div class="div3" align="left">
																	<input type="text" name="txt_tech_est" id="txt_tech_est" class="tboxsmclass EmdCalc" value="<?php if($_GET['id'] != ""){ echo $Tenest; } ?>">
																	<input type="hidden" name="txt_techsanc_est" id="txt_techsanc_est" class="tboxsmclass" value="<?php if($_GET['id'] != ""){ echo $TsAmount; } ?>">
																</div>
																<div class="div3 lboxlabel">&emsp;Cost of Tender Fee</div>
																<div class="div3" align="left">
																...
																<div class="div3 lboxlabel">
																	EMD&nbsp;
																	<input type="text"  name="txt_emd_perc" id="txt_emd_perc" style="width:30px; text-align:right" onKeyPress="return isPercentageValue(event,this);" class="tboxsmclass EmdCalc" value="<?php if(isset($DefEMDPerc)){ echo $DefEMDPerc; } else if($_GET['id'] != ""){ echo $Emdper; }  ?>" size="1">
																	(% of Tender Value)
																</div>
																<div class="div3">
...
$(document).ready(function(){
	...
	$('body').on("change",".EmdCalc", function(e){ 
		var EmdPerc = $("#txt_emd_perc").val();
		var TsAMT=	$("#txt_tech_est").val();
		var EmdAmt = EmdPerc*TsAMT/100;
			EmdAmt = Math.ceil(parseFloat(EmdAmt));
		$("#txt_emd_amt").val(EmdAmt.toFixed());
	});
});
