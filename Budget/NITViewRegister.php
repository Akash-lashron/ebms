...
include "common.php";
$PageName = $PTPart1.$PTIcon.'NIT Register';
checkUser();
$success = 0;
...
if($_SESSION['isadmin'] == 1){
	...
	$result = "SELECT a.*, b.staffname, c.ts_no FROM tender_register a INNER JOIN staff b ON ( a.eic = b.staffid ) 
	INNER JOIN technical_sanction c ON ( a.ts_id = c.ts_id ) WHERE (a.eic = '$staffid' OR a.created_by = '$UserId') ORDER BY tr_id ASC";
}
									...
									<div class="div12">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="center">NIT - Register</div>
														...
														<div class="table-responsive dt-responsive ResultTable">
															<div class="table-responsive dt-responsive rtabdiv" id="table-stmt">
																...
																<tbody>
																		<?php
																			$SNO = 1; 
																			if(($result_sql == true)&&(mysqli_num_rows($result_sql) > 0)){
																	...
																	<tr class='labeldisplay'>
																		...
																		<?php //} ?><a data-url="NIT?id=<?php //echo $List->tr_id; ?>" class=" BtnHref btn btn-info" name="View" id="View"><?php //echo $BtnName; ?></a>
																	</td>-->
																	</tr>
								                                   <?php  $SNO++; } } ?>
																   </tbody>
	...
	$("#exportToExcel").click(function(e){ 
		...
		if(table.length){ 
			$(table).table2excel({
				...
				filename: "NIT Register-" + new Date().toISOString().replace(/[\-\:\.]/g, "") + ".xls",
				fileext: ".xls",
				exclude_img: true,
				exclude_links: true,
				exclude_inputs: true
