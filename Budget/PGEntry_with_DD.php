													...
													<div class="card-body padding-1 ChartCard" id="CourseChart">
														<div class="divrowbox pt-2">
															<div class="table-responsive dt-responsive ResultTable">
															   ...
															   <div class="row clearrow"></div>
															   <div class="row">
																  <div class="div3 lboxlabel">LOI Number</div>
																			   ...
																			   <div class="row clearrow"></div>		
																				<table class="dataTable etable " align="center" width="100%" id="pgtable1">
																					...
																					<tr>
																						...
																						<td align="center" style="width:100px;"><input type="text" readonly="" placeholder="DD/MM/YYYY"  class="tboxsmclass date EmdDt " name="txt_date_pg_0" id="txt_date_pg_0"></td>
																						<td align="center" style="width:100px;"><input type="text" readonly="" placeholder="DD/MM/YYYY" class="tboxsmclass expdate ExpDt ValDate" data-index = '0' name="txt_expir_date_pg_0" id="txt_expir_date_pg_0"></td>
																						<td align="center" style="width:100px;"><input type="text" readonly="" placeholder="DD/MM/YYYY" class="tboxsmclass expdate Extndt ExvaDate"  data-index = '0' name="txt_exten_date_pg_0" id="txt_exten_date_pg_0"></td>
																					...
																					<td align="center" style="width:80px;"><input type="text" align="left"  placeholder="DD/MM/YYYY" data-index="<?php echo $Index; ?>" class="tboxsmclass date EmdDt "  name="txt_date_pg[]" id="txt_date_pg_<?php echo $Index; ?>" value="<?php echo dt_display( $Result2->inst_date);?>"></td>
																					...
																					<td align="center" style="width:80px;"><input type="text"  placeholder="DD/MM/YYYY" class="tboxsmclass expdate  Extndt  ExvaDate" data-index="<?php echo $Index; ?>" name="txt_exten_date_pg[]" id="txt_exten_date_pg_<?php echo $Index; ?>"  value="<?php echo dt_display( $Result2->inst_ext_date);?>"></td>
...
$( ".date" ).datepicker({  
	...
	if((DateofIssue != "") && (DateofExpiry != "") ){  
		...
		if(emdexpdate<emddate){
			var a="BG/FDR Expiry date should be greater than BG/DD/FDR Date";
  ...
  $("body").on("change", ".ValDDDate", function(event){ 
		...
		$("body").on("click", "#emp_add", function(event){ 
			...
			var DateofExpiry = $("#txt_expir_date_pg_0").val(); //alert(DateofExpiry);
			...
			var RowStr = '<tr id="'+Index+'"><td><input type="text" name="cmd_instype[]" readonly  id="cmd_instype_'+Index+'"  data-index="'+Index+'" class="tboxsmclass"  value="'+InstType+'"></td><td><input type="text" readonly name="txt_bankname_pg[]" id="txt_bankname_pg_'+Index+'"  data-index="'+Index+'" class="tboxsmclass"  value="'+BankName+'"></td><td><input type="text" readonly name="txt_branch_pg[]" id="txt_branch_pg_'+Index+'"  data-index="'+Index+'" class="tboxsmclass"  value="'+BranchName+'"></td><td><input type="text" readonly name="instrunum[]"  id="instrunum_'+Index+'"  data-index="'+Index+'" class="tboxsmclass"  value="'+InstNum+'"></td><td><input type="text" readonly name="txt_date_pg[]" id="txt_date_pg_'+Index+'"  data-index="'+Index+'" class="tboxsmclass EmdDt"  value="'+DateofIssue+'"></td><td><input type="text"  readonly name="txt_expir_date_pg[]" id="txt_expir_date_pg_'+Index+'"  data-index="'+Index+'" class="tboxsmclass ExpDt "  value="'+DateofExpiry+'"></td><td><input type="text"  readonly name="txt_exten_date_pg_[]" id="txt_exten_date_pg_'+Index+'"  data-index="'+Index+'" class="tboxsmclass Extndt" value="'+DateofExtension+'"></td><td><input type="number" name="txt_part_amt[]" id="txt_part_amt_'+Index+'"  data-index="'+Index+'" readonly class="tboxsmclass EmAmt" style="text-align:right;"  data-index="'+Index+'" value="'+AmtDetail+'"></td><td align="center"><input type="button" class="delete btn btn-info"  data-index="'+Index+'" name="emp_delete" id="emp_delete" value="DELETE"></td></tr>'; 
			if(InstType == 0){
	...
	$("body").on("click", "#emp_DD_add", function(event){ 
			...
			var DateofExpiry = $("#txt_expir_date_pg_DD_0").val();  //alert(DateofExpiry);
