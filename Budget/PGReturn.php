															...
															<div class="row" id="table-stmt">
																	...
																	<div class="row">
																		<div class="card-header inkblue-card hidden Details" align="left">&nbsp;FDR/Bank Guarantee Details</div>
																			...
																			<div class="smediv hidden">&nbsp;</div>
																			<div class="row smclearrow hidden"></div>
																			<div class="row">
				...
				//alert(JSON.stringify(RowSpanContArr));
					...
					if(data != null){ 
						 ...
						 $.each(Result2, function(index, element) {
								...
								BankStr +="<td align='left'><input type='text' class='tboxsmclass' readonlyname='txt_expir_date_pg_0'  width='200%' id='txt_expir_date_pg_0'  value='"+element.inst_exp_date+"'></td>";
								BankStr +="<td align='left'><input type='text' class='tboxsmclass' readonlyname='txt_expir_date_pg_0'  width='200%' id='txt_expir_date_pg_0'  value='"+element.inst_ext_date+"'></td>";
								...
								BankStr +="<td align='left' rowspan='"+RowSpan+"' ><input type='date'class='tboxsmclass date' required name='txt_return_date[]' id='txt_return_date[]' ></td>";
								...
								BankStr +="<td align='left'><input type='text' class='tboxsmclass' readonly name='txt_exten_date_pg_0' id='txt_exten_date_pg_0'  value='"+element.inst_ext_date+"' ></td>";
