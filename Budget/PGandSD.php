						...
						<blockquote class="bq1" style="overflow:auto">
							...
							<div>&nbsp;</div>
								...
								<div class="div12">
									...
									<div class="div4">
										<div class="dropdown">
											<button class="btn btn-primary dropdown-toggle BtnBox sorBtn" type="button" data-toggle="dropdown" data-url="PGEntry">PG Entry</button>
										</div>
									</div>
									<div class="div4">
										<div class="dropdown">
											<button class="btn btn-primary dropdown-toggle BtnBox sorBtn" type="button" data-toggle="dropdown" data-url="SDEntry">SD Entry</button>
										</div>
									</div>
									<div class="div2">
										&nbsp;
