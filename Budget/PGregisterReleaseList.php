...
include "common.php";
$PageName = $PTPart1.$PTIcon.'PG Register Release List';
...
if($_SESSION['isadmin'] == 1){
	...
	INNER JOIN bg_fdr_details c ON (a.sheet_id = c.master_id) WHERE c.inst_purpose='PG' AND c.inst_status='R'";
}else{
	$MasterQuery = "SELECT a.*, b.name_contractor, c.* FROM sheet a 
	INNER JOIN  contractor b ON (a.contid = b.contid)  
	INNER JOIN bg_fdr_details c ON (a.sheet_id = c.master_id) WHERE c.inst_purpose='PG' AND c.inst_status='R'
	AND (a.eic = '".$_SESSION['sid']."' OR FIND_IN_SET(".$_SESSION['sid'].",a.assigned_staff))";
}
									...
									<div class="div12">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="center">PG Release - List</div>
