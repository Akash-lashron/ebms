	...
	if(isset($_GET['id'])){   
		...
		if($GlobIDSql == true){
			if(mysqli_num_rows($GlobIDSql)>0){
				...
				if(($WorkCost == null)||($WorkCost == "")){
					$WorkCost = 0;
				}
				if(($sd_perc == null)||($sd_perc == "")){
					$sd_perc = 0;
				}
				$SDVal      = $WorkCost*$sd_perc;	//round(($List->sd_amt),0);
				//echo $SDVal;
			}
		}
									...
									<div class="div10">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="center">SD (BG/FDR) Entry</div>
																	...
																	<!--    2nd Div Starts Here   -->
																		...
																		<!-- <td align="center">
																	       <select name="cmd_purposes_0" id ="cmd_purposes_0" style="width:155px" class="tboxsmclass">
																				...
																				<td align="center" style="width:100px;" ><input type="text" placeholder="DD/MM/YYYY" data-index = '0' class="tboxsmclass expdate Extndt ExvaDate"  name="txt_exten_date_pg_0" id="txt_exten_date_pg_0"></td>
																			...
																			<?php
																					$Index = 1;
																					$SelectQuery2 = "SELECT * FROM bg_fdr_details where master_id='$LOIPGID' AND inst_type !='DD' AND inst_purpose= 'SD' AND userid='$UserId' order by master_id asc";
																					...
																					if($ResultQuery2 == true){
																						if(mysqli_num_rows($ResultQuery2)>0){
																							...
																							while($Result2 = mysqli_fetch_object($ResultQuery2)){
																								...
																								if($Result2->inst_date == "0000-00-00"){
																									$Emnddate = "";
																								}else{
																									$Emnddate    = dt_display($Result2->inst_date);
																								}
																								if($Result2->Emdexpirdat == "0000-00-00"){
																									$Emdexpirdat = "";
																								}else{
																									$Emdexpirdat    = dt_display($Result2->inst_exp_date);
																								}
																								if($Result2->inst_ext_date == "0000-00-00"){
																									$Emdextensiondat = "";
																								}else{
																					...
																					<td align="center" style="width:80px;"><input type="text" align="left"  placeholder="DD/MM/YYYY" data-index="<?php echo $Index; ?>" class="tboxsmclass date EmdDt ValDate"  name="txt_date_pg[]" id="txt_date_pg_<?php echo $Index; ?>" value="<?php echo $Emnddate;?>"></td>
																					<td align="center" style="width:80px;"><input type="text" align="left"  placeholder="DD/MM/YYYY" data-index="<?php echo $Index; ?>" class="tboxsmclass expdate ExpDt ValDate" name="txt_expir_date_pg[]" id="txt_expir_date_pg_<?php echo $Index; ?>" value="<?php echo $Emdexpirdat;?>"></td>
																					<td align="center" style="width:80px;"><input type="text"  placeholder="DD/MM/YYYY" class="tboxsmclass expdate Extndt ExvaDate "data-index="<?php echo $Index; ?>" name="txt_exten_date_pg[]" id="txt_exten_date_pg_<?php echo $Index; ?>" value="<?php echo $Emdextensiondat;?>"></td>
																			...
																			<table class="dataTable etable table-responsive " align="center" width="100%" id="emdtable2">
																				...
																				<tr>
																					...
																					<td align="center"><input type="text" placeholder="DD/MM/YYYY" readonly="" data-DDindex = '0' class="tboxsmclass chdate EmdDDt chdatval" name="txt_challandate_pg_DD_0" id="txt_challandate_pg_DD_0"></td>
																					<td align="center"><input type="text" placeholder="DD/MM/YYYY" readonly="" data-DDindex = '0' class="tboxsmclass chdate ExpDDt readatval " name="txt_Challanrealdate_pg_DD_0" id="txt_Challanrealdate_pg_DD_0"></td>
																					...
																					<?php
																						$DDIndex = 1;
																								$SelectQuery3 = "SELECT * FROM bg_fdr_details where master_id='$LOIPGID' AND inst_type ='DD' AND inst_purpose='SD' AND userid='$UserId' order by master_id asc";
																						...
																						<tr id="<?php echo $DDIndex; ?>">
																							...
																							<td align="center"><input type="text" class="tboxsmclass"  name="txt_bankname_pg_DD[]" id="txt_bankname_pg_DD_<?php echo $DDIndex; ?>" data-DDindex="<?php echo $DDIndex; ?>" value="<?php echo $DDbname?>"></td>
																								...
																								<td align="center"><input type="text" placeholder="DD/MM/YYYY" class="tboxsmclass date EmdDt ValDDDate"  name="txt_date_pg_DD[]" id="txt_date_pg_DD_<?php echo $DDIndex; ?>" data-DDindex="<?php echo $DDIndex; ?>" value="<?php echo $DDdate;?>"></td>
																								<td align="center"><input type="text"  placeholder="DD/MM/YYYY" class="tboxsmclass expdate ExpDt ValDDDate" name="txt_expir_date_pg_DD[]" id="txt_expir_date_pg_DD_<?php echo $DDIndex; ?>" data-DDindex="<?php echo $DDIndex; ?>" value="<?php echo $DDexdate;?>"></td>
																								...
																								<td align="center"><input type="text" placeholder="DD/MM/YYYY" class="tboxsmclass  chdate EmdDDt  chdatval"  name="txt_challandate_pg_DD[]" id="txt_challandate_pg_DD_<?php echo $DDIndex; ?>" data-DDindex="<?php echo $DDIndex; ?>" value="<?php echo $DDChalldate;?>"></td>
																								<td align="center"><input type="text"  placeholder="DD/MM/YYYY" class="tboxsmclass chdate ExpDDt  readatval" name="txt_Challanrealdate_pg_DD[]" id="txt_Challanrealdate_pg_DD_<?php echo $DDIndex; ?>" data-DDindex="<?php echo $DDIndex; ?>" value="<?php echo $DDChallRealate ;?>"></td>
...
<script>
			...
			$.ajax({ 
				...
				success: function (data) {  
					if(data != null){ 
						...
						workcost = data.work_order_cost; //alert(workcost);
					}
				}
			});
  ...
  $("body").on("change", ".ExvaDate", function(event){  //alert(1)
	var DateIndex = $(this).attr("data-index");
	var DateofExpiry = $("#txt_expir_date_pg_"+DateIndex).val(); //alert(DateofExpiry);
	var DateofExtension = $("#txt_exten_date_pg_"+DateIndex).val(); //alert(DateofExtension);
	if((DateofExtension != "") && (DateofExpiry != "") ){   
		var d1 = DateofExtension.split("/");
		var d2 = DateofExpiry.split("/");
		var emdexpdate = new Date(d1[2], d1[1]-1, d1[0]); //alert(emdexpdate);
		var emddate = new Date(d2[2], d2[1]-1, d2[0]);
		if(emdexpdate<emddate){
			var a="BG/FDR Extension date should be greater than BG/FDR Expiry Date";
			BootstrapDialog.alert(a);
			$(this).val('');
			event.preventDefault();
			event.returnValue = false;
  ...
  $("body").on("change", ".ValDDDate", function(event){ 
		...
		$("body").on("click", "#emp_add", function(event){ 
			...
			var RowStr = '<tr id="'+Index+'"><td><input type="text" readonly name="cmd_instype[]"  id="cmd_instype_'+Index+'" data-index="'+Index+'" class="tboxsmclass"  value="'+InstType+'"></td><td><input type="text" readonly  name="txt_bankname_pg[]" id="txt_bankname_pg_'+Index+'" class="tboxsmclass" data-index="'+Index+'"  value="'+BankName+'"></td><td><input type="text" readonly name="txt_branch_pg[]" id="txt_branch_pg_'+Index+'" class="tboxsmclass" data-index="'+Index+'" value="'+BranchName+'"></td><td><input type="text" readonly name="instrunum[]"  id="instrunum_'+Index+'" data-index="'+Index+'" class="tboxsmclass"  value="'+InstNum+'"></td><td><input type="text" readonly  name="txt_date_pg[]" id="txt_date_pg_'+Index+'" class="tboxsmclass date EmdDt ValDate" data-index="'+Index+'" value="'+DateofIssue+'"></td><td><input type="text" readonly  name="txt_expir_date_pg[]" id="txt_expir_date_pg_'+Index+'"  data-index="'+Index+'" class="tboxsmclass expdate ExpDt ValDate"  value="'+DateofExpiry+'"></td><td><input type="text"  readonly name="txt_exten_date_pg_[]" id="txt_exten_date_pg_'+Index+'"  data-index="'+Index+'" class="tboxsmclass expdate Extndt ValDate" value="'+DateofExtension+'"></td><td><input type="number"  readonly name="txt_part_amt[]" id="txt_part_amt'+Index+'"  data-index="'+Index+'"  class="tboxsmclass EmAmt" style="text-align:right;"  value="'+AmtDetail+'"></td><td align="center"><input type="button" class="delete btn btn-info" name="emp_delete" id="emp_delete"  data-index="'+Index+'" value="DELETE" style="margin-top:0px;"></td></tr>'; 
