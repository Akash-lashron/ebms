...
include "common.php";
$PageName = $PTPart1.$PTIcon.'SD Entry View';
...
$MasterQuery = "SELECT a.*, b.name_contractor, c.*,d.sd_perc, d.sd_amt FROM sheet a 
INNER JOIN  contractor b ON (a.contid = b.contid)  
INNER JOIN bg_fdr_details c ON (a.sheet_id = c.master_id)
INNER JOIN works d ON (a.sheet_id = d.sheetid) WHERE c.inst_purpose='SD' AND c.inst_status !='R' AND c.userid='$UserId' ORDER by a.sheet_id ASC, a.contid ASC, c.bfdid asc";
									...
									<div class="div12">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="center">SD - View </div>
																...
																<table width="100%" align="center" class="dataTable table2excel mgtb-8">
																	<thead>
																		...
																		<tr>
																			...
																			<th rowspan="2" valign="middle"> SD (%)</th>
																			<th rowspan="2" valign="middle"> SD Value<br> (&#8377;)</th>
																			<th rowspan="2" valign="middle">Contractor Name</th>
																			<th colspan="7" valign="middle">BG/FDR Details</th>
																	...
																	<tbody>
																		...
																		<tr class='labeldisplay'>
																			...
																			<td rowspan= <?php echo $TrRowspan ?> valign='middle' class='tdrow' align = 'justify'><?php echo $PGValue->computer_code_no; ?></td>
																			<td rowspan= <?php echo $TrRowspan ?> valign='middle' class='tdrow' align = 'justify'><?php echo $PGValue->work_name; ?></td>
																			<td rowspan= <?php echo $TrRowspan ?> valign='middle' class='tdrow' align = 'justify'><?php echo $PGValue->sd_perc; ?></td>
																			<td rowspan= <?php echo $TrRowspan ?> valign='middle' class='tdrow' align = 'justify'><?php echo round(($PGValue->sd_amt),0); ?></td>
																			...
																			<td class='tdrow' align='center' valign='middle'><?php //echo dt_display($PGValue->ga_challan_date); ?></td>
																			...
																			<td align='center' rowspan="<?php echo $TrRowspan; ?>" valign='middle' class='tdrow' ><a data-url="SDEntry?id=<?php echo $PGValue->master_id; ?>" class=" BtnHref btn btn-info" name="View" id="View">Edit</a></td>
																			<?php
																			}
																			?>
																		</tr>
	...
	$("#exportToExcel").click(function(e){ 
		...
		if(table.length){ 
			$(table).table2excel({
				...
				filename: "SDRegister-" + new Date().toISOString().replace(/[\-\:\.]/g, "") + ".xls",
				fileext: ".xls",
				exclude_img: true,
				exclude_links: true,
				exclude_inputs: true
