<div class="innerdiv2">
	...
	<?php $W = $total_a1_amount; ?>
		...
		<?php $A = round(($total_a1_amount * $DefValPercArr[1] / 100),2); ?>
		...
		<div class="div3" align="center">
			<input type="text" name="txt_a" id="txt_a" value="<?php echo IndianMoneyFormat($A); ?>" readonly="" class="tboxs2mclass rtext" />
		</div>
		<div class="row clearrow"><hr align="left" width="100%"></div>
		<?php $WC = round(($W + $A),2); ?>
		...
		<div class="div1 lboxlabel rtext">&nbsp;</div>
		<div class="div3" align="center">
			<input type="text" name="txt_wc" id="txt_wc" value="<?php echo IndianMoneyFormat($WC); ?>" readonly="" class="tboxs2mclass rtext" />
		</div>
		<div class="row clearrow"><hr align="left" width="100%"></div>
		...
		<div class="div2 lboxlabel rtext">&nbsp;</div>
		<div class="div3" align="center">
			<input type="text" name="txt_b" id="txt_b" value="<?php echo IndianMoneyFormat($B); ?>" readonly="" class="tboxs2mclass rtext" />
		...
		<div class="div3" align="center">
			<input type="text" name="txt_x" id="txt_x" value="<?php echo IndianMoneyFormat($X); ?>" readonly="" class="tboxs2mclass rtext" />
		</div>
		<div class="row clearrow"><hr align="left" width="100%"></div>
		...
		<div class="div3" align="center">
			<input type="text" name="txt_c" id="txt_c" value="<?php echo IndianMoneyFormat($C); ?>" readonly="" class="tboxs2mclass rtext" />
		</div>
		<div class="row clearrow"><hr align="left" width="100%"></div>
		<?php $Y = round(($X + $C),2); ?>
		<div class="div5 lboxlabel">&nbsp;</div>
		...
		<div class="div3" align="center">
			<input type="text" name="txt_y" id="txt_y" value="<?php echo IndianMoneyFormat($Y); ?>" readonly="" class="tboxs2mclass rtext" />
		</div>
		<div class="row clearrow"><hr align="left" width="100%"></div>
		...
		<div class="div3" align="center">
			<input type="text" name="txt_d" id="txt_d" value="<?php echo IndianMoneyFormat($D); ?>" readonly="" class="tboxs2mclass rtext" />
		</div>
		<div class="row clearrow"><hr align="left" width="100%"></div>
		...
		<div class="div3" align="center">
			<input type="text" name="txt_e" id="txt_e" value="<?php echo IndianMoneyFormat($E); ?>" readonly="" class="tboxs2mclass rtext" />
		</div>
		<div class="row clearrow"><hr align="left" width="100%"></div>
											
		<?php $F = round(($Y+$D+$E),2); ?>
		<div class="div7 lboxlabel">Total Y+D+E Cost of <!---- Here 1 ---></div>
		<div class="div2 lboxlabel rtext">F</div>
		<div class="div3" align="center">
			<input type="text" name="txt_f" id="txt_f" value="<?php echo IndianMoneyFormat($F); ?>" readonly="" class="tboxs2mclass rtext" />
		</div>
		<div class="row clearrow"><hr align="left" width="100%"></div>
		<?php //if(@mysqli_result($rs_master,0,'quantity') != ''){ $ForOneUnit = round(($F/@mysqli_result($rs_master,0,'quantity')),2); }else{ $ForOneUnit = round(($F/1),2); } ?>
		<div class="div9 lboxlabel">Cost of 1 <span id="one_unit"></span> <i class="fa fa fa-paperclip cmd-box cmd-box-unit" id="CmdBox0" data-index="0"></i></div>
		<div class="div3" align="center">
			<input type="text" name="txt_cost_one" id="txt_cost_one" value="<?php echo IndianMoneyFormat($ForOneUnit); ?>" readonly="" class="tboxs2mclass rtext" />
		</div>
		<input type="hidden" name="hid_to_unit" id="hid_to_unit" />
		<div class="row clearrow"><hr align="left" width="100%"></div>
											
		<div class="div5 lboxlabel">&nbsp;</div>
		<div class="div4 lboxlabel ltext color-1">TW Rate</div>
		<div class="div3" align="center">
			<input type="text" name="txt_township_amt" id="txt_township_amt" value="<?php echo IndianMoneyFormat($ForOneUnit); ?>" readonly="" class="tboxs2mclass rtext" />
		</div>
		<div class="row clearrow"><hr align="left" width="100%"></div>
		<?php //if(@mysqli_result($rs_master,0,'quantity') != ''){ $G = round(($W*$DefValPercArr[5] / (100 * @mysqli_result($rs_master,0,'quantity'))),2); }else{ $G = round(($W*$DefValPercArr[5] / 100),2); } ?>
		...
		<div class="div1 lboxlabel rtext">&nbsp;</div>
		<div class="div3" align="center">
			<input type="text" name="txt_g" id="txt_g" value="<?php echo IndianMoneyFormat($G); ?>" readonly="" class="tboxs2mclass rtext" />
		</div>
		<div class="row clearrow"><hr align="left" width="100%"></div>
											
		<?php $IGCAR = round(($ForOneUnit+$G),2); ?>
		<div class="div5 lboxlabel">&nbsp;</div>
		<div class="div4 lboxlabel ltext color-1">IGCAR Rate <!---- Here 2 ---> </div>
		<div class="div3" align="center">
			<input type="text" name="txt_igcar1_amt" id="txt_igcar1_amt" value="" readonly="" class="tboxs2mclass rtext" />
		</div>
