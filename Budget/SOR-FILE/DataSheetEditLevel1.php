											...
											<div class="row" id="gr-append">
												...
												<div class="div9" align="center">
													<select name="cmb_group[]" id="cmb_group2" class="sboxsmclass group" data-group="2"> 
														...
														<?php echo $objBind->BindGroup2NoSubLevel($GlobGr1Id,$GlobGr2Id); ?>
													</select>
												</div>
											</div>
											<?php $PrevGroup = 2; $MaxGroup = 3; for($g=2; $g<$IdArrCnt; $g++){ $CurrChiId = $ChildArr[$g]; $CurrParId = $ParentArr[$CurrChiId]; ?>
											...
											<div class="<?php echo $MaxGroup; ?> G row">
												...
												<div class="<?php echo $MaxGroup; ?> G div9" align="center">
													<select name="cmb_group[]" id="cmb_group<?php echo $MaxGroup; ?>" data-group="<?php echo $MaxGroup; ?>" class="sboxsmclass group">
														...
														<?php echo $objBind->BindGroup2($CurrParId,$CurrChiId); ?>
													</select>
												</div>
											</div>
									...
									<div class="innerdiv2">
										...
										<div class="row innerdiv" align="center">
											...
											<div class="row lboxlabel new <?php echo $NewHideClass; ?>">
												&emsp;
												<input type="radio" name="calc_type" id="with_calc" class="calc_type" value="WC" <?php if($DMCalcType == "WC"){ ?> checked="checked" <?php } ?>>&nbsp; With Calculation
												&emsp;&emsp;&emsp;
												<input type="radio" name="calc_type" id="without_calc" class="calc_type" value="WOC" <?php if($DMCalcType == "WOC"){ ?> checked="checked" <?php } ?>>&nbsp; Without Calculation
											</div>
...
var Disable = $("#add_ded_disable").val(); 
if(Disable == 1){
