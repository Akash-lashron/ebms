...
<?php include "Header.html"; ?>
    ...
    <body class="page1" id="top" oncontextmenu="return false"onload="noBack();" onpageshow="if (event.persisted) noBack();" onUnload="">
        <!--==============================header=================================-->
        <form action="HistoryTaxesOverHeadsEditList.php" method="post" enctype="multipart/form-data" name="form" id="form1">
						...
						<blockquote class="bq1" style="overflow:auto">
							...
							<div class="row">
								...
								<div class="div6" align="center">
									<div class="innerdiv2">
										<div class="row divhead head-sb" align="center">Default Master - History<!-- - Horticulture--></div>
