...
$DataSheetArr = array();
$SelectDataSheetQuery	= "select distinct item_id from datasheet_a1_details_hc where item_id != 0";
...
$SelectMasterGroupQuery	= "select * from item_master_hc where par_id = 0 and active = 1 order by item_desc asc";
...
if((isset($_GET['Action']) == "D")&&(isset($_GET['id']))){
	$DeleteId = $_GET['id'];
	$DeleteQuery = "update group_datasheet_hc set active = 0 where id = '$DeleteId'";
}
										...
										<div id='TAB<?php echo $MasterList->item_id; ?>' data-title='<?php echo $MasterList->item_desc; ?>' class="tab-content">
											<table class="group-table table itemtable formtable">
												...
												<tbody>
													<?php 
													$SNo = 1; $DetailCnt = 0;
													$SelectDetailGroupQuery = "select * from item_master_hc where item_type = '$MasterList->item_type' and par_id != 0 and par_id = '$MasterList->item_id' and active = 1 order by item_code asc";
													...
													?>
																<tr>
																	...
																	<td align="center">
																		...
																		<span class="dynamicSpan hide" id="DType<?php echo $DetailList->item_id; ?>" contenteditable="true"><?php echo $DetailList->item_code; ?></span>
																	</td>
																	<td align="justify">
