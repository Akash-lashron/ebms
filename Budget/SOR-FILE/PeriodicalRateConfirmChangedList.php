...
<?php include "Header.html"; ?>
    ...
    <body class="page1" id="top" oncontextmenu="return false"onload="noBack();" onpageshow="if (event.persisted) noBack();" onUnload="">
        <!--==============================header=================================-->
        <form action="PeriodicalRateConfirm.php" method="post" enctype="multipart/form-data" name="form" id="form1">
...
$(document).ready(function(){
	...
	$('body').on("click","#btn_next", function(event){ 
		...
		if(WithEffectFromDate == ""){
			BootstrapDialog.alert("Error : Please select rate with effect from field.");
			event.preventDefault();
