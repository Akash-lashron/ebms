...
if (isset($_POST['btn_view_x']))
{
	...
	$sql_level2="select item_id from item_master where item_id='" . $_POST['cmb_single_level2'] . "'";
...
if($modify==false)	
{
	...
	<table width="900" border="0" align="center" class="color1" cellpadding="0" cellspacing="0">
		...
		<tr style="display:none">
			<td width="70" class="labelbold">&nbsp;&nbsp;Level 1 </td>
			<td width="830">
				<?php
		...
		<tr>
			<td width="70" class="labelbold">&nbsp;&nbsp;Main Item</td>
			<td width="430">
						<?php
						...
						?>
						<select class="text" style="width:390px;height:21px;" name="cmb_single_level2" ID="cmb_single_level2" onBlur="func_make()">
							<option value="Select">Select</option>
...
else
{
	...
	<table width="1000" border="1" align="center" cellpadding="0" cellspacing="0" class="color2">
		<tr class="labelboldcenter" height="25"><td colspan="26" background="Title bar/Titlebar_Centre_Piece.jpg">Item Rate Update  <?php echo $level3_desc; ?></td></tr>
		...
		$sql_level3="select * from item_master where item_id like '" . $_POST['cmb_single_level2'] . "%'
		...
		if(@mysqli_result($rs_level3,0,'item_id')!="")
		{
			...
			{		 
				...
				echo "<td class='labelcenter' nowrap>&nbsp; ".$row." </td>";
				echo "<td class='labelleft'><input type='text' size='100' name='txt_desc" . $row . "' id='txt_desc" . $row . "' value='" . $rows['item_desc'] . "' class='text' readonly /></td>";
				echo "<td nowrap>&nbsp;<input type='text' size='20' name='cmb_unit" . $row . "' id='cmb_unit" . $row . "' value='" . $rows['unit'] . "' class='text' readonly/></td>";
				...
				echo "<td class='labelcenter'><input type='text' name='txt_price" . $row . "' id='txt_price" . $row . "' value='" . $rows['price'] . "' size='5' class='labelfieldright' onblur='show_factor_single($row)' readonly/></td>";
		...
		<input type="hidden" name="item_id_level3" id="item_id_level3" value="<?php echo $_POST['cmb_single_level2']; ?>"  />
	</table>
