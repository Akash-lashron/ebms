...
include "common.php";
$PageName = $PTPart1.$PTIcon.'Technical Sanction Register';
checkUser();
$success = 0;
$Finacid  = array();
									...
									<div class="div12">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="center">Technical Sanction - Register</div>
																...
																<tbody>
																	<?php
																		...
																		while($List = mysqli_fetch_object($resultSql)){
																			...
																			//print_r($HoaNameDisp);
																			$HoaNameDispay = implode(",<br>",$HoaNameDisp);
																	?>
																	<tr class='labeldisplay'>
																		...
																		<td class='tdrow' align='justify' nowrap="nowrap" valign='justify'><?php echo $HoaNameDispay; ?></td>
																		...
																		<td class='tdrow' align='left' valign='middle'><?php echo $StaffNameArr[$List->eic]; ?></td>
																		<!--	<td valign='middle' class='tdrow' align='center'>
																			...
																			<?php// } ?>
																			<a data-url="TechnicalSanction?id=<?php// echo $List->ts_id; ?>" class="BtnHref btn btn-info" title="<?php// echo $TTMess ?>" name="View" id="View"><?php// echo $BtnName;?></a>
																		</td>	-->
																	</tr>
																	<?php  $SNO++; } ?>
																   </tbody>
	...
	$("#exportToExcel").click(function(e){ 
		...
		if(table.length){ 
			$(table).table2excel({
				...
				filename: "TSRegister-" + new Date().toISOString().replace(/[\-\:\.]/g, "") + ".xls",
				fileext: ".xls",
				exclude_img: true,
				exclude_links: true,
				exclude_inputs: true
