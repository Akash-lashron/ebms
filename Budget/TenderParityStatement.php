															...
															<div class="table-responsive dt-responsive rtabdiv" id="table-stmt">
																<div class="div12 dataTable" align="left">
																	<div class="div12 namebox">
																		<table class="nborder">
																			<tr>
																				<td nowrap="nowrap"><b>CCNo&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;: </b></td>
																				<td><b><?php if(isset($computer_code_no)){ echo $computer_code_no; } ?></b></td>
																			</tr>
																			<tr>
																				<td nowrap="nowrap"><b>Name Of Work : </b></td>
																				<td><b><?php if(isset($work_name)){ echo $work_name; } ?><b></td>
																			</tr>
																		</table>
																	</div>
																	...
																	<?php
																		...
																		*/
																				while($Result2 = mysqli_fetch_object($SelectScheduleQuerySql)){ 
																					...
																					$ItemQty		  = $Result2->total_quantity; //echo "AA=".$ItemQty;
			...
			$("#exportToExcel").click(function(e){ 
				...
				if(table.length){ 
					$(table).table2excel({
						...
						filename: "Tender Parity Statement -" + new Date().toISOString().replace(/[\-\:\.]/g, "") + ".xls",
						fileext: ".xls",
						exclude_img: true,
						exclude_links: true,
						exclude_inputs: true
