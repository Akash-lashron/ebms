																...
																<div class="row">
																	...
																	<div class="div9">
																		<select id="cmb_tr_no" name="cmb_tr_no" class="tboxclass">
																			...
																			<?php echo $objBind->BindCstTrNo(0,"WOENTRY"); ?>
																		</select>
																	</div>
																	<div class="row clearrow"></div>
																	<div class="div3 lboxlabel">Name of Work</div>
																	<div class="div9">
																		<textarea name='txt_workname' readonly="" maxlength="2500" class="tboxsmclass" id='txt_workname' required rows="2"><?php if (isset($_GET['sheet_id'])){ echo $work_name; } ?></textarea>
																	</div>
																		<div class="row clearrow"></div>
																		<div class="div3 lboxlabel">Short Name</div>
																		<div class="div9">
																			<input type="text" class="tboxsmclass" maxlength="2000" name='txt_shortname' required id='txt_shortname' value="<?php if (isset($_GET['sheet_id'])){ echo $short_name; } ?>">
																		</div>
																		<div class="row clearrow"></div>
																		<div class="div3 lboxlabel">Contractor Name</div>
																		<div class="div4">
																			<input type="text" class="tboxsmclass" maxlength="150" name='txt_cont_name' required id='txt_cont_name' value="<?php if (isset($_GET['sheet_id'])){ echo $name_contractor; } ?>">
																			<input type="hidden" class="tboxsmclass" maxlength="150" name='txt_cont_id' required id='txt_cont_id' value="">
																		</div>
																		<div class="div2 cboxlabel">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;HOA Code</div>
																		<div class="div3">
																			<select name='cmb_hoa[]' id='cmb_hoa' class="tboxsmclass" multiple="multiple" > </select>
																		</div>
																		<div class="row clearrow"></div>
																		<div class="card-header isappcheck inkblue-card" align="left">&nbsp;Work Order Details</div>
																			<table class="dataTable isappcheck" align="center" width="100%" id="table1">
																				...
																				<tr>
																					<td align="center" style="width:70%"><input type="text" maxlength="100" readonly="" class="tboxclass" name="txt_workorderno" id="txt_workorderno"></td>
																					<td align="center" style="width:50%"><input type="text" class="tboxclass datepicker" style="text-align:center;" name="workorderdate" id="workorderdate" readonly=""></td>
																					<td align="center" style="width:50%"><input type="text" maxlength="12" class="tboxclass" style="text-align:right;" readonly="" name="txt_workorderamt" id="txt_workorderamt" onkeypress="return event.charCode >= 48 && event.charCode <= 57"></td>
																					<td align="center" style="width:100%"><input type="text" maxlength="50" class="tboxclass" style="text-align:center;" name="txt_computercodeno" id="txt_computercodeno" readonly=""></td>
																					<!--<td align="center">
																					...
																					<td align="center"><input type="text" class="tboxclass" maxlength="11" readonly="" style="text-align:center;" name="workduration" id="workduration" onKeyPress="return isIntegerValueWithLimit(event,this,2);"></td>
																					<td align="center"><input type="text" class="tboxclass datepicker" readonly="" style="text-align:center;" name="workcommencedate" id="workcommencedate"></td>
																					<td align="center"><input type="text" class="tboxclass datepicker" readonly="" style="text-align:center;" name="txt_dateofcompletion" id="txt_dateofcompletion"></td>
																				</tr>
																			</table>
																		</div>
																		<div class="row clearrow"></div>

																		<input type="hidden" class="tboxclass" name="txt_hid_woamt" id="txt_hid_woamt" readonly="">
																		...
																		<div class="div4">
																			<input type="text" readonly="" class="tboxsmclass" maxlength="50" name='txt_agreementno' required id='txt_agreementno' value="<?php if (isset($_GET['sheet_id'])){ echo $agree_no; } ?>">
																		</div>
																		...
																		<div class="row clearrow"></div>
																			...
																			<div class="div4">
																					<input type="text" readonly="" maxlength="100" class="tboxsmclass" name='txt_ICNO' required id='txt_ICNO'  value="">
																		...
																		<div class="Details" id="ContDet">
																			<!--<div class="card-header inkblue-card" align="left">&nbsp;Contractor Bank Details</div>
																				<table class="dataTable" align="center" width="100%" id="table0">
																					...
																					<tr>
																						<td align="center"><input type="checkbox" class="tboxclass" name="ch_bank_det" id="ch_bank_det"></td>
																						<td align="center"><input type="text" class="tboxclass datepicker" name="workorderdate" id="workorderdate" readonly=""></td>
																						<td align="center"><input type="text" class="tboxclass" readonly="" name="txt_workorderamt" id="txt_workorderamt" onkeypress="return event.charCode >= 48 && event.charCode <= 57"></td>
																						<td align="center"><input type="text" class="tboxclass" name="txt_computercodeno" id="txt_computercodeno" readonly=""></td>
																						<td align="center"><input type="text" class="tboxclass datepicker" readonly="" name="txt_dateofcompletion" id="txt_dateofcompletion"></td>
																						<td align="center"><input type="text" class="tboxclass datepicker" readonly="" name="txt_dateofcompletion" id="txt_dateofcompletion"></td>
																					</tr>
																				</table>
																			</div>-->
																		...
																		<div class="div3 lboxlabel">whether GST applicaple for this work</div>
																		<div class="div1 no-padding-lr gstselapp" style="width:10%;">
																			<div class="inputGroup">
																				<input id="gst_app_yes" name="gstapplicable" type="radio" value="Y"/>
																		...
																		<div class="div1 gstselapp" style="padding-left:10px; width:10%;">
																			<div class="inputGroup">
																				<input id="gst_app_no" name="gstapplicable" type="radio" value="N"/>
																				<label for="gst_app_no" style="padding:1px 0px; width:100%; font-size:11px;" class="cboxlabel"> &nbsp; NO</label>
																			</div>
																		</div>

																		<div class="div2 cboxlabel" style="text-align:right;">LCESS Applicable</div>
																		<div class="div2 no-padding-lr"  style="padding-left:10px; width:10%;">
																			<div class="inputGroup">
																		...
																		<div class="div1" style="padding-left:10px; width:10%;">
																			<div class="inputGroup">
																		...
																		<div class="div2 lboxlabel gstapplicab">GST Rate on Work Order %</div>
																		<div class="div2 gstapplicab">
																			<input type="text" class="tboxsmclass" maxlength="10" onkeypress="return event.charCode >= 48 && event.charCode <= 57" name='txt_gst_value' id='txt_gst_value' value="">
																		</div>
																		
																		<div class="div2 cboxlabel gstapplicab">GST Inclusive/Exclusive </div>
																		<div class="div2 no-padding-lr gstapplicab">
																			<div class="inputGroup">
																		...
																		<div class="div2 gstapplicab" style="width:15%;">
																			<div class="inputGroup">
																		...
																		<div class="row clearrow gstapplicab"></div>
																		...
																		<div class="div1">
																			<input type="text" readonly="" maxlength="10" class="tboxsmclass" name='txt_sd_per' required id='txt_sd_per' onKeyPress="return isPercentageValue(event,this);" value="">
		...
		$.ajax({ 
			...
			success: function (data) {  
				if(data != null){
					...
					$("#txt_workorderamt").val(WoAmtFormated);
					...
					if(ContBankDets != null){
						...
						$.each(ContBankDets, function(index, element) {
							...
							BankStr +="<td align='left'><input type='text' readonly='' class='tboxsmclass' name='txt_bank_ifsc_0' id='txt_bank_ifsc' value='"+element.ifsc_code+"'></td></tr>";
						});
						BankStr += "</table>";
