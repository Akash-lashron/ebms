...
include "common.php";
$PageName = $PTPart1.$PTIcon.'Work Status List';
																		...
																		<dl>
																			...
																			<dd class="accordion-content accordionItem <?php if($x == 1){ ?> is-expanded animateIn <?php } else{ ?> is-collapsed <?php } ?>" id="accordion<?php echo $sheetid; ?>" aria-hidden="true" style="overflow:auto;">
																				<div align="left" style="padding:5px 5px; background:#fff;">
																					...
																					<a data-url="WorkStatus?id=<?php echo $sheetid; ?>"><span class="rlable-sky">&nbsp;<i class="fa fa-hand-o-right" style="font-size:15px; padding-top:2px;"></i> Click Here &nbsp;</span></a>
																					<a data-url="WorkOrderExtensionEntry?id=<?php echo $sheetid; ?>"><span class="rlable-sky">&nbsp;<font style="color:#DF0979; font-weight:bold; background:#edeaea; border-radius:7px; padding:2px;">Work Extension &nbsp;</span></a>
																				</div>
																			</dd>
																		</dl>
																	</div>
...
$(document).ready(function(){ 
	...
	$('body').on('click', '.Chart', function() {
		...
		if((id != undefined)&&(id != '')){ 
			$(location).attr('href', 'Chart.php?sheetid='+id+'&content='+content);
		}else{
