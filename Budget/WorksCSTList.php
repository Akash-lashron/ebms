...
include "common.php";
$PageName = $PTPart1.$PTIcon.'CST Waiting For Accounts Confirmation';
$msg = "";
...
if($_SESSION['isadmin'] == 1){
	$sheetquery = "SELECT * FROM tender_register WHERE cst_status ='A' ORDER BY tr_id ASC";
}else{
	$sheetquery = "SELECT * FROM tender_register WHERE cst_status ='A' AND (eic = '".$_SESSION['sid']."' OR created_by = '".$_SESSION['userid']."') ORDER BY tr_id ASC";
}
									...
									<div class="div12">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="center">CST Waiting For Accounts Confirm</div>
																...
																<table class="table table-striped table-bordered" id="example">
																	<thead>
																		<tr>
																			...
																			<th rowspan="2">Tender Estimate<br>( &#x20b9; )</th>
																					...
																					foreach($ContPosiArr as $ContKey => $ContValue){
																						if($x == 0){ ?>
																							<tr>
																								...
																								<!-- <td rowspan="<?php //echo $RowSpan; ?>" align="center"><input type="button" data-url="CSTView?id=<?php //echo $List->tr_id; ?>" class="BtnHref btn btn-info" Value="<?php //if($List->cst_status == 'A'){ echo "View CST"; }?> "></td> -->
																								</tr>
																							<?php $x++; $SNO++; 
																						}else{ ?>
																							<tr>
