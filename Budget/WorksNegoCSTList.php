...
include "common.php";
$PageName = $PTPart1.$PTIcon.'Negotiation CST Waiting For Confirmation';
$msg = "";
...
if($_SESSION['isadmin'] == 1){
	...
	$sheetquery = "SELECT * FROM tender_register WHERE nego_status ='A' AND (eic = '".$_SESSION['sid']."' OR created_by = '".$_SESSION['userid']."') ORDER BY tr_id ASC";
}
									...
									<div class="div12">
										<div class="card cabox">
											<div class="face-static">
												<div class="card-header inkblue-card" align="center">Negotiation CST Waiting For Accounts Confirm</div>
																...
																<table class="table table-striped table-bordered" id="example">
																	<thead>
																		<tr>
																			...
																			<th rowspan="2">Negotiated Estimate<br>( &#8377; )</th>
