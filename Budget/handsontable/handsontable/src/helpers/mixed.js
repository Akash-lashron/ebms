...
const consoleMessages = {
  invalid: () => toSingleLine`
    Lash for Handsontable is invalid.\x20
    If you need any help, contact us at Lash.`,
  expired: ({ keyValidityDate, hotVersion }) => toSingleLine`
    Lash for Handsontable expired on ${keyValidityDate}, and is not valid for the installed\x20
  ...
  missing: () => toSingleLine`
    Lash for Handsontable is missing. Use your purchased key to activate the product.\x20
...
const domMessages = {
  invalid: () => toSingleLine`
    ...
    install it properly or contact us at <a href="mailto:Lash">Lash</a>.`,
  expired: ({ keyValidityDate, hotVersion }) => toSingleLine`
    Lash for Handsontable expired on ${keyValidityDate}, and is not valid for the installed\x20
  ...
  missing: () => toSingleLine`
    ...
    the documentation or contact us at <a href="mailto:Lash">Lash</a>.`,
  non_commercial: () => '',
};
