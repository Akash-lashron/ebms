...
<tr>
	<td colspan="12">
		...
		<?php 
		$Comb_slno++; 
		$Tot_Comb_EscAmt = $Tot_Comb_EscAmt + $ArrayA4[$x3]; 
		$Tot_Comb_DPM_EscAmt = $Tot_Comb_DPM_EscAmt + $ArrayA4[$x3];
		$Tot_Comb_UPTO_EscAmt = $Tot_Comb_UPTO_EscAmt + $ArrayA4[$x3];
		} ?>
			<tr class="labelbold">
				<td colspan="2" align='right'>Total&nbsp;</td>
			...
			<tr class='labelbold'>
				<td align='right' class='' colspan="2">GRAND TOTAL&emsp;</td>
