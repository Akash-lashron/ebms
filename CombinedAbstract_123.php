					...
					if($select_comb_amt_sql == true){
						if(mysql_num_rows($select_comb_amt_sql)>0){
							while($CAmtList = mysql_fetch_object($select_comb_amt_sql)){
								...
								//$OverAllDpmAmount = $OverAllDpmAmount + $Comb_dpm_amt;
								//$OverAllSlmAmount = $OverAllSlmAmount + $Comb_slm_amt;
								//$OverAllSlmDpmAmount = $OverAllSlmDpmAmount + $Comb_upto_date_amt;
								//$CombinedNetAmt = $Comb_sec_adv_amt + $Comb_slm_amt;
								//$TotalCombinedNetAmt = $TotalCombinedNetAmt + $CombinedNetAmt;
						...
						?>
							...
							<!--<tr class='labelprint'>
								<td align='center' class=''><?php echo $Comb_slno; $Comb_slno++; ?></td>
								<td align='right' class=''><?php echo $section_abcd; ?> - Work Done : &emsp;</td>
								<td align='center' class=''><?php echo $Comb_mbookno; ?> / P - <?php echo $Comb_mbookpage; ?> </td>
								<td align='right' class=''><?php echo number_format($Comb_slm_amt, 2, '.', ''); ?> </td>
							</tr>
							<tr class='labelprint'>
								<td align='center' class=''><?php echo $Comb_slno; $Comb_slno++; ?></td>
								<td align='right' class=''><?php echo $section_abcd; ?> - Secured Advance : &emsp;</td>
								<td align='center' class=''><?php echo $Comb_mbookno; ?> / P - <?php echo $Comb_mbookpage; ?> </td>
								<td align='right' class=''><?php echo number_format($Comb_sec_adv_amt, 2, '.', ''); ?> </td>
							</tr>
							
							<tr class='labelprint'>
								<td align='center' class=''><?php echo $Comb_slno; $Comb_slno++; ?></td>
								<td align='right' class=''><?php echo $section_abcd; ?> - Escalation : &emsp;</td>
								<td align='center' class=''>--</td>
								<td align='right' class=''>0.00</td>
							</tr>-->
						<?php
							}
						}
...
<tr>
	<td colspan="12">
		...
		<table width='950px' cellpadding='3' cellspacing='3' align='center' class='label table1' bgcolor="#FFFFFF" id="table1">
			...
			<tr class="labelbold">
				<td>&nbsp;</td>
				<td align='left' class='' colspan="3">Net Amount</td>
			</tr>
		<?php $Comb_slno = 1; $Tot_Comb_NetAmt = 0; for($x1=0; $x1<count($ArrayA1); $x1++){ ?>	
			<tr class='labelprint'>
		...
		<?php $Comb_slno++; $Tot_Comb_NetAmt = $Tot_Comb_NetAmt + $ArrayA2[$x1]; } ?>
			<tr class="labelbold">
				<td colspan="3" align='right'>Total Net Amount&nbsp;</td>
				<td align='right' class=''><?php echo number_format($Tot_Comb_NetAmt, 2, '.', ''); ?></td>
			</tr>
			
			<tr class="labelbold">
				<td>&nbsp;</td>
				<td align='left' class='' colspan="3">Secured Advance</td>
			</tr>
		<?php $Comb_slno = 1; $Tot_Comb_SecAdv = 0; for($x2=0; $x2<count($ArrayA1); $x2++){ ?>	
			<tr class='labelprint'>
				<td align='center' class=''><?php echo $Comb_slno; ?></td>
				<td align='left' class=''><?php echo $ArrayA7[$x2]." - ".$ArrayA8[$x2]; ?></td>
				<td align='center' class=''><!--<?php//if($ArrayA3[$x2] != 0){ ?> MB-<?php// echo $ArrayA5[$x2]; ?> / P-<?php// echo $ArrayA6[$x2]+1; } else{ echo "--"; }  ?>--></td>
		...
		<?php $Comb_slno++; $Tot_Comb_SecAdv = $Tot_Comb_SecAdv + $ArrayA3[$x2]; } ?>
			<tr class="labelbold">
				<td colspan="3" align='right'>Total Secured Advance Amount&nbsp;</td>
				<td align='right' class=''><?php echo number_format($Tot_Comb_SecAdv, 2, '.', ''); ?></td>
			</tr>
			
			<tr class="labelbold">
				<td>&nbsp;</td>
				<td align='left' class='' colspan="3">Escalation</td>
			</tr>
		<?php $Comb_slno = 1; $Tot_Comb_EscAmt = 0; for($x3=0; $x3<count($ArrayA1); $x3++){ ?>	
			<tr class='labelprint'>
				<td align='center' class=''><?php echo $Comb_slno; ?></td>
				...
				<td align='right' class=''><?php echo number_format($ArrayA4[$x3], 2, '.', ''); $GrandTotal = $GrandTotal + $ArrayA4[$x3]; ?></td>
			</tr>
		<?php $Comb_slno++; $Tot_Comb_EscAmt = $Tot_Comb_EscAmt + $ArrayA4[$x3]; } ?>
			<tr class="labelbold">
				<td colspan="3" align='right'>Total Escalation Amount&nbsp;</td>
				<td align='right' class=''><?php echo number_format($Tot_Comb_EscAmt, 2, '.', ''); ?></td>
			</tr>
			
			<tr class='labelbold'>
				<td align='right' class='' colspan="3">GRAND TOTAL&emsp;</td>
