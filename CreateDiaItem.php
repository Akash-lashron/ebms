...
if (isset($_POST["submit"])) {
	...
	$Item_Dia_Query = "insert into dia_wise_item set sheetid = '$sheet_id', divid = '$divid', subdivid = '$subdiv_id', dia = '$ItemDia', userid = '$userid', staffid = '$staffid', active = 1, modifieddate = NOW()";	
	$Item_Dia_Sql = mysql_query($Item_Dia_Query);
	if($Item_Dia_Sql==true)
	{
		$msg = "Dia Wise Item Created Sucessfully..!!";
		$success = 1;
	}
	else
	{
...
<?php require_once "Header.html"; ?>
    ...
    <script type="text/javascript"  language="JavaScript">
        ...
        function func_items()
        {
            ...
            strURL = "find_steelitem_no.php?sheetid=" + document.form.workorderno.value +"&type=S";
                ...
                <div class="container_12">
                    <div class="grid_12">
                        <blockquote class="bq1" style="overflow-y:scroll;">
                            <div class="title">Create Item - Dia Wise </div>		
                                    ...
                                    <table width="1060" border="1" cellpadding="0" cellspacing="0" align="center" >
                                        ...
                                        <tr>
                                            ...
                                            <td class="label"  colspan="3">
                                                <select onBlur="display();" name="itemno" id="itemno" class="textboxdisplay" onChange="cls(this);func_subitem_no();" style="width:100px;height:22px;" tabindex="7">
                                                    <option value="0">Item No</option>
                                                </select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;	

                                           <!-- &nbsp;&nbsp;&nbsp;&nbsp;Sub Item No.-->
                                            
                                                <select onBlur="display();" name="subitemno" id="subitemno" class="textboxdisplay" style="width:100px;height:22px;" onChange="cls(this);find_subsubitem(this);">
                                                    <option value="0">Sub Item 1</option>
                                                </select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                           
                                                <select onBlur="display();" name="subsubitemno" id="subsubitemno" class="textboxdisplay" style="width:100px;height:22px;"  onChange="cls(this);find_subsubsubitem(this);">
                                                    <option value="0">Sub Item 2</option>
                                                </select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<select onBlur="display();" name="subsubsubitemno" id="subsubsubitemno" class="textboxdisplay" style="width:100px;height:22px;" >
                    					...
                    					<tr>
                                            <td>&nbsp;</td>
                                            <td class="label">Select Dia of Rod</td>
                                            <td class="labeldisplay" colspan="3">
												<input type="checkbox" name="check_dia[]" id="check_dia_8" value="8"><label class="label">8</label>&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="checkbox" name="check_dia[]" id="check_dia_10" value="10"><label class="label">10</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="checkbox" name="check_dia[]" id="check_dia_12" value="12"><label class="label">12</label>&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="checkbox" name="check_dia[]" id="check_dia_16" value="16"><label class="label">16</label>&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="checkbox" name="check_dia[]" id="check_dia_20" value="20"><label class="label">20</label>&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="checkbox" name="check_dia[]" id="check_dia_25" value="25"><label class="label">25</label>&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="checkbox" name="check_dia[]" id="check_dia_28" value="28"><label class="label">28</label>&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="checkbox" name="check_dia[]" id="check_dia_32" value="32"><label class="label">32</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												<input type="checkbox" name="check_dia[]" id="check_dia_36" value="36"><label class="label">36</label>&nbsp;&nbsp;&nbsp;&nbsp;
											</td>
                                        </tr>
