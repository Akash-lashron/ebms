...
<script type="text/javascript" language="javascript">
	...
	// var table = "tableDemo";
	 var table1 = new Array("tableDemo");
	 var temp = "role";
     ...
     <div class="container_12">
        <div class="grid_12">
            ...
            <blockquote class="bq1">
               	<div class="title">User Role Creation</div>
						...
						<table border="0" class="tableDemo bordered">
							...
							<tr id="<?=$eachRecord['roleid'];?>">
								...
								<td align="center">
									...
									<!--<a href="javascript:;" id="<?=$eachRecord['roleid'];?>" class="ajaxEdit"><img src="" class="eimage"></a>
									<a href="javascript:;" id="<?=$eachRecord['roleid'];?>" class="ajaxDelete"><img src="" class="dimage"></a>-->
								</td>
							</tr>
							<? }
							}
