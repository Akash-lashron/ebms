            ...
            xmlHttp.onreadystatechange = function ()
            {
                if (xmlHttp.readyState == 4)
                {
                    ...
                    else
                    {
                        ...
                        for(i = 0; i < name.length; i++)
                        {
                            document.form.txt_rate_unit.value 	= name[9];
                        }
    ...
    <body class="page1" id="top" oncontextmenu="return false"onload="noBack();" onpageshow="if (event.persisted) noBack();" onUnload="">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data" name="form">
           <?php include "Menu.php"; ?>
            <!--==============================Content=================================-->
            <div class="content">
                            <div class="title">Electricity Bill New</div>
                    ...
                    <div class="grid_12">
                        ...
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="color1">
								...
								<tr>
                                    ...
                                    <td>
										<select name="cmb_shortname" id="cmb_shortname" class="textboxdisplay" style="width:465px" onChange="workorderdetail();recoverydetail();ElectricityMeterDetail();">
								...
								<tr>
									<td colspan="3" align="center">
										...
										<div style="width:90%; height:auto; overflow:scroll" align="center">
