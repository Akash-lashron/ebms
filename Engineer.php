                      ...
                      <div class="container">
						<table width="100%"  bgcolor="#E8E8E8" border="1" cellpadding="0" cellspacing="0" align="center" >
                            ...
                            <tr height="25px">
                                ...
                                <td class="labeldisplay">
									<input type="text" name='mobile' id='mobile' class="textboxdisplay" value="<?php if($_GET['staffid']!='') echo $mobile; ?>" style="width:297px;" maxlength="10" tabindex="5" onKeyPress="return isNumber(event)"/>
								</td>
							...
							<!--<tr height="25px">
                                ...
                                <td class="labeldisplay">
									<input type="text"  name='dob' id='dob' class="textboxdisplay" value="<?php if($_GET['staffid']!='') { echo $DOB; } else { echo date('d/m/Y'); } ?>"size="13" tabindex="7" >
								</td>
                                <td>&nbsp;</td>
								<td class="label">Date of Joining</td> 
                                <td class="labeldisplay">
									<input type="text"  name='doj' id='doj' class="textboxdisplay" value="<?php if($_GET['staffid']!='') { echo $DOJ; } else { echo date('d/m/Y'); } ?>"size="13" tabindex="8" >
								</td>
                            </tr>
							<tr>
								<td>&nbsp;</td>
							...
							<tr>
                                ...
                                <td class="labeldisplay">
									<input type="text" name='intercom' id='intercom' class="textboxdisplay" value="<?php if($_GET['staffid']!='') echo $intercom; ?>" style="width:297px;" maxlength="8" tabindex="6" onKeyPress="return isNumber(event)"/>
								</td>
								</tr>
