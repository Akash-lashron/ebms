...
<script>
	function goBack()
	{
		url = "Esc_Consump_10ca_Steel_Site_Print.php";
...
{ 
	...
	$sc_mbookno 	= $newmbookno;
						...
						echo "<tr class='labelbold'><td colspan='4' align='center'>Quantity of steel brought to site and 10CA qty. calculation</td></tr>";
						echo "<tr class='labelbold'>";
