...
if($_GET['sheetid'] != "")
{
	...
	//$select_mbook_query = "select * from mymbook where sheetid = '$sheetid' and rbn = '$esc_rbn' and esc_id = '$esc_id' and mtype = 'CC' and genlevel = 'cem_consum'";
	// Commented for Single Escalation MBook....Above is for multiple MBook
	$select_mbook_query = "select * from mymbook where sheetid = '$sheetid' and rbn = '$esc_rbn' and esc_id = '$esc_id' and mtype = 'E' and genlevel = 'cem_consum'";
...
<script type="text/javascript">
	...
	function goBack()
	{
		url = "Esc_Site_Consump_10ca_Cement_Print.php";
            ...
            <!--==============================Content=================================-->
						...
						if($escal_measure_sql == true)
						{
							if(mysql_num_rows($escal_measure_sql)>0)
							{
								...
								while($MList = mysql_fetch_object($escal_measure_sql))
								{
								 ...
								 else
								 {
									...
									//if(($month != $prev_month)&&($prev_month != ""))
									{
										...
										$total_item_qty_month_mt = round(($total_item_qty_month/50),$prev_decimal_placed);
										echo '<tr class="labelbold">';
										echo '<td align="center" valign="middle">&nbsp;</td>';
										echo '<td align="center" valign="middle">&nbsp;</td>';
										echo '<td align="center" valign="middle">&nbsp;</td>';
										...
										echo '<td align="center" valign="middle">&nbsp;Bag&nbsp;</td>';
										echo '</tr>';
								...
								echo '<td align="center" valign="middle" colspan="4"><input type="text" name="txt_ref_'.$prev_subdivid.'" id="txt_ref_'.$prev_subdivid.'" class="hidtextbox"></td>';
								echo '<td align="right" valign="middle">&nbsp;'.number_format($total_item_qty_month_mt,$prev_decimal_placed,".",",").'&nbsp;</td>';
								echo '<td align="center" valign="middle">&nbsp;Bags&nbsp;</td>';
								echo '</tr>';
								$summary_arr[$prev_subdivid][$prev_month] = $total_item_qty_month_mt;
								$summary_ref_arr[$prev_subdivid][$prev_month] = " B/f MB-".$cc_mbookno."/Pg-".$page;
								$summary_txtbox_arr[$prev_subdivid][$prev_month] = $tbid;
						...
						//print_r($InvoiceMonMastArr);exit;
						echo "<br/>";
						...
						/*print_r($InvoiceQtyMastArr); echo "A<br/>";
						print_r($UsedQtyArr); echo "B<br/>";
						print_r($InvoiceMonMastArr); echo "C<br/>";
						print_r($MonthYrArr); echo "D<br/>";
						exit;*/
						
						$i = 1; $x = 0;
						echo "<table width='1087px' cellpadding='3' cellspacing='3' align='center' class='labelprint table1' bgcolor='#FFFFFF'>";
						echo "<tr class='labelbold'><td colspan='4' align='center'>Quantity of cement brought to site and 10CA qty. calculation</td></tr>";
						echo "<tr class='labelbold'>";
						echo "<td align='center'>Invoice Month</td>";
						echo "<td align='center'>RAB/Billing Month</td>";
						echo "<td align='right'>Qty. Brought to Site (in Bag) </td>";
