...
if($_GET['sheetid'] != "")
{
	...
	$select_rbn_query = "select distinct(mbookgenerate.rbn), escalation.esc_id, escalation.tca_fromdate, 
						...
						where mbookgenerate.sheetid = '$sheetid' and escalation.sheetid = '$sheetid' and escalation.flag = 0 and escalation.quarter = '$quarter'";
...
$SelectAbstractBookSql = mysql_query($SelectAbstractBookQuery);
if($SelectAbstractBookSql == true)
{
	if(mysql_num_rows($SelectAbstractBookSql)>0)
	{
		$AsbBookList = mysql_fetch_object($SelectAbstractBookSql);
