...
$select_escmbook_query = "select * from mymbook where sheetid = '$sheetid' and rbn = '$curr_rbn' and quarter = '$quarter' and esc_id = '$esc_id' and staffid = '$staffid' and mtype = 'E' and genlevel = 'rev_escalation'";
...
<script type="text/javascript" language="javascript">
	...
	function goBack()
	{
		url = "EscalationRevisedPrintGenerate.php";
...
$title = '<table width="875" border="0"  cellpadding="2" cellspacing="2" align="center" bgcolor="#FFFFFF" style="border:none;" class="labelprint">
			...
			<br/><br/>
			<b/>Revised Escalation for 10CA ('.$TCAfir_month.' to '.$TCAlas_month.')&nbsp;&nbsp;</b><br/>&nbsp;</td></tr>
			</table>';
echo $title;
//$Line = $Line+2;
...
$title = '<table width="875" border="0"  cellpadding="2" cellspacing="2" align="center" bgcolor="#FFFFFF" style="border:none;" class="labelprint">
			...
			Escalation MBook No.'.$esc_mbook.'
			<br/><br/>
			<b/>Revised Escalation for 10CC ('.$fir_month.' to '.$las_month.')&nbsp;&nbsp;</b><br/>&nbsp;</td></tr>
			</table>';
echo $title;
$table = "";
//$Line = $Line+2;
...
<table width='675' cellpadding='3' cellspacing='3' align='center' class='label table1 labelprint' bgcolor="#FFFFFF" id="table1">
	<tr><td colspan="3" align="center">Revised Escalation for Quarter - <?php echo $quarter; ?></td></tr>
	<tr>
