...
if($_POST["submit"] == " View ") 
{
	...
	header('Location: EscalationRevisedPrint.php?sheetid='.$sheetid.'&quarter='.$quarter);
}
            ...
            <div class="container_12">
                <div class="grid_12">
                    <blockquote class="bq1">
                        <div class="title">Escalation Print - Revised</div>
                 ...
                 <tr>
					...
					?>
					<select name="cmb_shortname" id="cmb_shortname" onChange="find_workname();AllQuarter();" class="textboxdisplay" style="width:400px;height:22px;" tabindex="7">
				...
				<tr>
                    ...
                    <td class="label">
						...
						<input type="hidden" name='txt_rbn' readonly="" id='txt_rbn' class="textboxdisplay" style="width: 210px;">
