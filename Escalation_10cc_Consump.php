...
if ($_POST["submit"] == ' View ') 
{
	...
	header('Location: Escalation_10cc_Consump_View.php');
} 
?>
     ...
     { 
		...
		function find_priceindex_period()
     	{ 
            ...
            strURL = "find_priceindex_period_10cc.php?sheetid=" + document.form.cmb_shortname.value+"&type=TCC";/// This is for Cement - So base_index_code is CIo;
            xmlHttp.open('POST', strURL, true);
            xmlHttp.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
            xmlHttp.onreadystatechange = function ()
            {
       	...
       	<div class="container_12">
			...
			<!--<div align="right"><a href="View_Electricity_generate_Bill.php">View</a>&nbsp;&nbsp;&nbsp;</div>-->
                 <blockquote class="bq1">
                     <div class="title">Escalation - 10CC Consumption</div>
						<input type="hidden" name="hid_sheetid" id="hid_sheetid" value="<?php if($_GET['sheet_id'] != ''){ echo $_GET['sheet_id']; } ?>">
                        	<table width="1078px" border="0" align="center" cellpadding="0" cellspacing="0" class="color1">
								...
								<tr>
                                    ...
                                    <td>
										<select name="cmb_shortname" id="cmb_shortname" class="textboxdisplay" style="width:465px" onChange="workorderdetail();find_priceindex_period();">
