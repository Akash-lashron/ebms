...
if ($_POST["submit"] == ' View ') 
{
	...
	$_SESSION['cc_mbook_id'] 		= $mbid;
	header('Location: Escalation_Cement_Consump_General_View.php?varid=1');
} 
?>
 ...
 <script>
     ...
     { 
        ...
        { 
            ...
            strURL = "find_generatembno.php?sheetid=" + document.form.cmb_shortname.value + "&mtype=CC";
            xmlHttp.open('POST', strURL, true);
            xmlHttp.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
            xmlHttp.onreadystatechange = function ()
            {
