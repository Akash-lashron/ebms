...
$escal_data_old_bn_query = 	"SELECT DATE(measurementbook.measurementbookdate) as mdate, measurementbook.subdivid, DATE(measurementbook.fromdate) as fromdate, 
							...
							WHERE schdule.measure_type != 's' AND schdule.measure_type != 'st' AND measurementbook.sheetid = '$sheetid' 
							AND measurementbook.rbn >= '$from_rbn' AND measurementbook.rbn <= '$to_rbn' AND schdule.sheet_id = '$sheetid' AND tc_unit != '0'
...
$escal_data_new_bn_query = 	"SELECT DATE(measurementbook_temp.measurementbookdate) as mdate, measurementbook_temp.subdivid, 
							...
							WHERE schdule.measure_type != 's' AND schdule.measure_type != 'st' AND measurementbook_temp.sheetid = '$sheetid' 
							AND measurementbook_temp.rbn = '$to_rbn' AND schdule.sheet_id = '$sheetid' AND tc_unit != '0' 
                ...
                <div class="container_12">
                    <div class="grid_12">
                        ...
                        <blockquote class="bq1">
                            <div class="title">Escalation - Cement Consumption View</div>
						...
						$total_cem_consum_kg = round($total_cem_consum,$decimal_placed);
						echo '<tr class="label">';
						echo '<td align="center" valign="middle">&nbsp;</td>';
						echo '<td align="center" valign="middle">&nbsp;</td>';
						echo '<td align="center" valign="middle">&nbsp;</td>';
						...
						echo '<td align="center" valign="middle" colspan="2">&nbsp;Total</td>';
						echo '<td align="right" valign="middle">&nbsp;'.number_format($total_cem_consum,$decimal_placed,".",",").'&nbsp;</td>';
