...
if(isset($_POST['submit']) == " Save ")
{
	...
	if($date_wise_data != "")
	{
		...
		and ecm.esc_id='$esc_id' and ecm.esc_item_type = 'STL' and ec.esc_item_type = 'STL' and ecm.quarter = '$quarter'";
		...
		for($j=0; $j<$count1; $j++)
		{
			...
			$insert_master_query = "insert into esc_consumption_10ca_master set esc_id = '$esc_id', sheetid = '$sheetid',
									esc_rbn = '$esc_rbn', quarter = '$quarter', item_code = 'SIo', esc_cons_mbook = '$sc_mbookno', 
