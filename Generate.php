...
{
	header('Location: MBook.php?varid=1');
}
else
{
	header('Location: SteelMBook.php?varid=1');
}
//$popupwindow =1;
...
<input type="hidden" name="hid_maxdate" id="hid_maxdate" >
    ...
    $(function () {
        function DisplayPageDetails() {
            ...
            $.post("MBookNoService.php", {currentmbook: currentmbooknovalue}, function (data) { //alert(data);
