                                	...
                                	<tr> 
                                        ...
                                        <td  class="label">
                                           ...
                                           // if($_SESSION['sid'] == 0) { $Logonstaffid =0;} else {  $Logonstaffid =$_SESSION['sid']; } 
											...
											<select name="currentmbookno" id="currentmbookno" class="textboxdisplay" style="width:130px;height:22px;" tabindex="6" onChange="func_GenerateAbstractMBno(); findabstarctmbbokno();">
                                ...
                                <tr><td>&nbsp;</td><td></td><td id="val_mbook" style="color:red"></td></tr>
                                    <tr> 
                                        ...
                                        <td  class="label">
											...
											<select name="currentmbookno_abs" id="currentmbookno_abs" class="textboxdisplay" style="width:130px;height:22px;" tabindex="7">
                                                <option value="0" selected="selected"> ----- Select ----- </option>
                                                        <?php // echo $objBind->BindMBook(-1,$staffid); ?>
                                            </select>
