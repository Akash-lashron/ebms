                ...
                <div class="container_12">
                    <div class="grid_12">
                        ...
                        <blockquote class="bq1" style="overflow:scroll">
                            <div class="title">Generate - Electricity Bill</div>
                        ...
                        <table width="1078px" border="0" align="center" cellpadding="0" cellspacing="0" class="color1">
								...
								<tr>
                                    ...
                                    <td>
										<input type="text" name='txt_final' id='txt_final' class="textboxdisplay" value="" onBlur="calculateEBamount();" style="width: 120px;">
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								...
								<tr>
									...
									<td>
										<input type="text" name='txt_meter_rent' onBlur="calculateEBamount();" id='txt_meter_rent' class="textboxdisplay" value="<?php if($_GET['sheet_id'] != ''){ echo $short_name; } ?>" style="width: 120px;">
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<input type="text" name='txt_electricity_cost' readonly="" id='txt_electricity_cost' class="textboxdisplay" value="<?php if($_GET['sheet_id'] != ''){ echo $short_name; } ?>" style="width: 465px;">
									</td>
								</tr>
