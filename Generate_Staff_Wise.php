...
if($_POST["btn_generate"] == "Generate") 
{
	...
	$_SESSION["abs_page"] = $abs_page;	$_SESSION["zone_id"] = $zone_id;
	...
	{
		$dia_wise_item_query = "select * from dia_wise_item where sheetid = '$sheet_id' and active = 1";
		$dia_wise_item_sql = mysql_query($dia_wise_item_query);
		if($dia_wise_item_sql == true)
		{
			if(mysql_num_rows($dia_wise_item_sql)>0)
			{
				$count = 1;
			}
			else
...
<?php require_once "Header.html"; ?>
	...
	function zonename()
     	{ 
            ...
            strURL = "find_zone_name.php?workorderno=" + document.form.wordorderno.value;
            xmlHttp.open('POST', strURL, true);
            xmlHttp.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
            xmlHttp.onreadystatechange = function ()
            {
                                ...
                                <table width="1000"  bgcolor="#E8E8E8" border="0" cellpadding="0" cellspacing="0" align="center" >
                                    ...
                                    <tr> 
                                        ...
                                        <td  class="labeldisplay"><?php
                                            ...
                                            ?>
                                            <select name="wordorderno" id="wordorderno"  class="textboxdisplay" tabindex="1" onChange="func_mbhead_date(); func_GenerateMBno(0,0); zonename();" style="width:405px;height:22px;">
                                    ...
                                    <tr> 
                                        ...
                                        <td  class="label">
										<select name='cmb_zone_name' id='cmb_zone_name' class="textboxdisplay" style="width:405px;">
                                    ...
                                    <tr> 
                                        <td>&nbsp;</td>
                                        <td  class="label">&nbsp;</td>
                                        <td  class="labeldisplay" id="val_zone_name" style="color:red">&nbsp;</td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr> 
                                	...
                                	<tr> 
                                        ...
                                        <td  class="label">
                                           ...
                                           // if($_SESSION['sid'] == 0) { $Logonstaffid =0;} else {  $Logonstaffid =$_SESSION['sid']; } 
											...
											<select name="currentmbookno" id="currentmbookno" class="textboxdisplay" style="width:130px;height:22px;" tabindex="7" onChange="func_GenerateAbstractMBno(); findabstarctmbbokno();">
                                                <option value="0" selected="selected"> ----- Select ----- </option>
                                                        <?php // echo $objBind->BindMBook(-1,$staffid); ?>
                                            </select>
                                            <q class="">&nbsp;&nbsp;&nbsp;MBook Page &nbsp;&emsp;&nbsp;&nbsp;</q>&nbsp;
                                ...
                                <tr><td>&nbsp;</td><td></td><td id="val_mbook" style="color:red"></td></tr>
                                   <!-- <tr> 
                                    ...
                                    <tr> 
                                        ...
                                        <td  class="labeldisplay">
										<input type="number" name="rbnno" id="rbnno" tabindex="8" class="textboxdisplay" style="width:123px"/>
...
<!--===================== THIS IS FOR FINAL BILL ==============================----->									
                                    ...
                                    <tr class="hidden" id="hide_row1"> 
                                        <td>&nbsp;</td> 
                                        <td  class="label">Actual Date of Completion </td>
...
<!--===================================================----->									
                            ...
                            <input type="hidden" name="txt_all_rbn" id="txt_all_rbn" />
    ...
    $(function () {
        function DisplayPageDetails() {
			...
			var generatetype 			= 	"sw";
            $.post("MBookNoService.php", {currentmbook: currentmbooknovalue, currentbmookname: currentmbooknotext, sheetid: wordordernovalue, generatetype: generatetype, staffid: staffid, currentrbn: currentrbn}, function (data) {
		...
		function FindAllRBNDetails() {
		 	$('#txt_all_rbn').val('');
            var workordernumber = $("#wordorderno option:selected").attr('value');
            $.get("findrbn.php", {workordernumber: workordernumber}, function (data) { 
				 var AllRbn = data;
				 $('#txt_all_rbn').val(AllRbn);
            });
        }
		
		$.fn.CheckGeneratedRBN = function(event) { 
			var AllRbn = $('#txt_all_rbn').val(); 
			var rbnlist = AllRbn.split("*");
			var count = 0;
			var maxRAB=Math.max.apply(null,rbnlist);
			//alert(maxRAB);
			var current_rbn = $('#rbnno').val();
			for(i=0;i<rbnlist.length;i++){
				if(rbnlist[i] == current_rbn){
					count++;
				}
			}
			if((count > 0)||(Number(current_rbn)<Number(maxRAB))){ 
				var a="RAB "+current_rbn+" already Closed. Enter valid RAB.";
				$('#rbn_error').text(a);
				event.preventDefault();
				event.returnValue = false;
			}
