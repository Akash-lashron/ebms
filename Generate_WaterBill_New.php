     ...
     { 
		...
		function meter_details()
     	{ 
            ...
            strURL = "find_water_meter_details.php?workorderno=" + document.form.cmb_shortname.value+"&meterno="+document.form.cmb_meter_no.value;
            xmlHttp.open('POST', strURL, true);
            xmlHttp.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
            xmlHttp.onreadystatechange = function ()
            {
    ...
    <body class="page1" id="top" oncontextmenu="return false"onload="noBack();" onpageshow="if (event.persisted) noBack();" onUnload="">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data" name="form">
           <?php include "Menu.php"; ?>
            <!--==============================Content=================================-->
            <div class="content">
                <div class="title">Generate - Water Bill New</div>
                    ...
                    <div class="grid_12">
                        ...
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="color1">
                                ...
                                <tr>
									...
									<div class="labeldisplay" style="width:310px;float:left;color:red;" id="val_rbn">&nbsp;</div>
									<div class="labeldisplay" style="float:right;color:red; width:378px;" id="val_ebill_no"></div>
									</td>
								</tr>
										...
										<div style="width:90%; height:auto;" align="center">
											<table width="100%" class="table1" id="table1">
												<tr class="label" style="background-color:#EAEAEA">
													...
													<td align="center">Rate <i class='fa fa-inr' style='font-weight:normal; padding-top:5px;'></td>
