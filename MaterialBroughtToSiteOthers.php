...
if(isset($_POST["save"])){
	...
	$InsertQuery 	= "insert into mat_invoice set sheetid= '$SheetId', matid = '', mat_code = '$Material', mat_type = '$MatType', invoice_dt = '$InvoiceDate', received_dt = '$MaterialRecDt', qty = '$InvoiceQty', qty_unit = '$InvoiceQtyUnit', invoice_no = '$InvoiceNo', active = 1, created_by = '".$_SESSION['userid']."', created_on = NOW()";
...
<script>
   $(function () {
	...
	function GetSheetName() {
        ...
        // Optional: Add a flag for backend logic
        formData.append("GetSheet", true);
        fetch('GetSheetName.php', {
            method: 'POST',
            body: formData
        })
        .then(res => res.text())
        .then(data => {
            ...
            document.getElementById("txt_excel_sheet").innerHTML = 
			'<option value="">---------- Select ----------</option>' + data;
        })
        .catch(err => {
            document.getElementById("txt_excel_sheet").innerHTML = "";
        });
                        ...
                        <form  name="form" method="post" action="" enctype="multipart/form-data">
							<div class="container">
								...
								<div class="row ">
									<div class="div2">&nbsp;</div>
									<div class="div8">
										<div class="row"><div class="div12" style="margin-top:0px;"><div class="row divhead" align="center">General Material Brought to Site Details Entry</div></div></div>
										<div class="row innerdiv">
											<div class="row" align="right">
												 <input type="button" title="Click here to go Upload Invoice - Excel" class="backbutton isentry" style="cursor: pointer;" name="btn_excel" id="btn_excel" value=" Upload Invoice - Excel">
												 <input type="button"  title="Click here to Download Excel Template" class="backbutton isexcel" style="cursor: pointer;" value="  Download Excel Template " >
												 <input type="button" title="click here to go Invoice Entry"  class="backbutton isexcel" style="cursor: pointer;" name="btn_entry" id="btn_entry" value=" Invoice Entry ">
											</div>
											<div class="row clearrow"></div>
											...
											<div class="row isexcel">
												<div class="row clearrow"></div>
												<div class="row">
													<div class="div1">&nbsp;</div>
													<div class="div4 ">
														<label for="fname"> Excel Upload File </label>
													</div>
													<div class="div4">
														<input type="file" name="excel_file" id="excel_file" onchange="GetSheetName()"class=" ExcelCheck">
													</div>
													<div class="div3">&nbsp;</div>
												</div>
												<div class="row clearrow"></div>
												<div class="row">
													...
													<div class="div4">
														<select name="txt_excel_sheet" id="txt_excel_sheet" class="DispSelectBox">
															<option value="">---------- Select ----------</option>
														</select>
													</div>
													<div class="div3">&nbsp;</div>
												...
												<div class="row">
													<div class="div1">&nbsp;</div>
													<div class="div4 ">
														<label for="fname"> Start Row </label>
													</div>
													<div class="div4">
														<input type="text" name="txt_excel_strow" id="txt_excel_strow" class="DispSelectBox disable" value="3" readonly="">
													</div>
													<div class="div3">&nbsp;</div>
												</div>
												<div class="row clearrow"></div>
												<div class="row">
													<div class="div1">&nbsp;</div>
													<div class="div4 ">
														<label for="fname"> End Row </label>
													</div>
													<div class="div4">
														<input type="text" name="txt_excel_endrow" id="txt_excel_endrow" class="DispSelectBox" value="">
													</div>
													<div class="div3">&nbsp;</div>
												</div>
								...
								<div class="row">
									<div class="div12" align="center">
										 <input type="submit" data-type="submit" value=" Save " name="save" id="save" class="isentry"/>
										 <input type="submit" data-type="submit" value=" Upload Excel " name="btn_upload" id="btn_upload" class="isexcel"/>
									</div>									
								</div>                           
                            </div>
                        </form>
...
<?php include "footer/footer.html"; ?>
	...
	$("body").on("click","#btn_excel", function(event){
		$('.isexcel').show();
		$('.isentry').hide();		
		$("form[name='form']").attr("action", "MaterialBroughtToSiteOthersInvoice.php");
	});
	$("body").on("click","#btn_entry", function(event){
		$('.isexcel').hide();
		$('.isentry').show();
		$("form[name='form']").attr("action", "<?php echo $_SERVER['PHP_SELF']; ?>");
	});
	$("#cmb_work_no").chosen();
