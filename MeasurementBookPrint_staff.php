...
if($_POST["submit"] == " View ") 
{
	...
	if($mbooktype == "G")
	{
		header('Location: MBook_Print_staff_wise.php?workno='.$workno);
	}
	if($mbooktype == "S")
	{
		header('Location: SteelMBook_Print_staff_wise.php?workno='.$workno); 
	}
}
...
<script type="text/javascript">
    ...
    <body class="page1" id="top" oncontextmenu="return false"onload="noBack();" onpageshow="if (event.persisted) noBack();" onUnload="">
        ...
        <!--==============================Content=================================-->
        <div class="content">
                        <div class="title">Measurement Book Print</div>
            <div class="container_12">
                <div class="grid_12">
                 ...
                 <tr>
					...
					<select name="cmb_work_no" id="cmb_work_no" onChange="find_workname(); zonename();" class="textboxdisplay" style="width:400px;height:22px;" tabindex="7">
