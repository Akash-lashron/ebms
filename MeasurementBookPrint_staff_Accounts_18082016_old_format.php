            ...
            <div class="container_12">
                <div class="grid_12">
                    <blockquote class="bq1">
                        <div class="title">Measurement Book View</div>
				...
				<tr>
                    ...
                    <td  class="labeldisplay">
					<input type="text" name="txt_rbn_no" id="txt_rbn_no" class="textboxdisplay" style="width:397px;" readonly="">
					</td>
					<td>&nbsp;</td>
					<td>&nbsp;</td>
				</tr>
                <tr><td>&nbsp;</td><td></td><td id="val_rbn_no" style="color:red"></td></tr>
                <tr> 
                    <td>&nbsp;</td> 
                    <td  class="label">Measurement Book Type </td>
                    <td  class="labeldisplay">
                      <select name="cmb_mbook_type" id="cmb_mbook_type" class="textboxdisplay" onChange="getStaffList();" style="width:400px;height:22px;" size="" tabindex="7">
                        <option value="">---------------------------------Select---------------------------------</option>
                ...
                <tr> 
                    <td>&nbsp;</td> 
                    <td  class="label">Prepared Staff Name </td>
                    <td  class="labeldisplay">
                      <select name="cmb_staff_name" id="cmb_staff_name" class="textboxdisplay" onChange="zonename();" style="width:400px;height:22px;" size="" tabindex="7">
                        <option value="">---------------------------------Select---------------------------------</option>
                      </select>
					</td>
                    <td>&nbsp;</td>
				...
				<tr> 
                    ...
                    <td  class="labeldisplay">
                      	<select name='cmb_zone_name' id='cmb_zone_name' class="textboxdisplay" style="width:400px;">
