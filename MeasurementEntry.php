...
if($_POST["update"] == " Update ")
{
	...
	$subdiv_name 		= 	$_POST['hid_subdivname'];
	...
	if(mysql_num_rows($mbookdetail_query)<= 1)
	{
		...
		$insert_mbheader_sql		=	"insert into mbookheader (date, sheetid, allotmentid, divid, subdivid, subdiv_name, active, staffid, userid) values ('$mes_date', '$sheet_id', 1, '$div_id', '$subdiv_id', '$subdiv_name', 1, '$staffid', '$userid')";
	...
	if($measurement_type == 's')
	{
		...
		for ($c = 0; $c < count($rec); $c++) 
		{
			...
			if($x != 2) 
			{
				$mbookdetailsquery	=	"INSERT INTO `mbookdetail`(`mbheaderid`, `subdivid`, `subdiv_name`, `descwork`, `measurement_no`, `measurement_l`, `measurement_dia`, `measurement_contentarea`, `entry_date`, `remarks`) VALUES 
												('" . $mbookheaderid_new . "' ,
												 '" . $subdiv_id . "',
												 '" . $subdiv_name . "',
	...
	elseif($measurement_type == 'st')
	{
		...
		for ($c = 0; $c < count($rec); $c++) 
		{
			...
			if($x!=2) 
			{
				...
				$mbookdetailsquery	=	"INSERT INTO `mbookdetail`(`mbheaderid`, `subdivid`, `subdiv_name`, `descwork`, `measurement_no`, `measurement_l`, `measurement_b`, `measurement_d`, `structdepth_unit`, `measurement_contentarea`, `entry_date`, `remarks`) VALUES 
											('" . $mbookheaderid_new . "' ,
											 '" . $subdiv_id . "',
											 '" . $subdiv_name . "',
	...
	else
	{
		...
		for ($c = 0; $c < count($rec); $c++) 
		{
			...
			if($x!=2)
			{
				$mbookdetailsquery	=	"INSERT INTO `mbookdetail`(`mbheaderid`, `subdivid`, `subdiv_name`, `descwork`, `measurement_no`, `measurement_l`, `measurement_b`, `measurement_d`, `measurement_contentarea`, `entry_date`, `remarks`) VALUES 
											('" . $mbookheaderid_new . "' ,
											 '" . $subdiv_id . "',
											 '" . $subdiv_name . "',
											 '" . $_POST['txt_dec_wk' . $x] . "' ,
...
if($_POST["submit"] == " Submit ") 
{
	...
	$subdiv_name 		=  	getsubdivname($subdiv_id);
	...
	$mbookheaderquery 	= 	"INSERT INTO `mbookheader`(`date`, `sheetid`, `allotmentid`,`divid`,`subdivid`, `subdiv_name`, `active`, `staffid`, `userid`) VALUES ('$date','$sheet_id',1,'$div_id','$subdiv_id','$subdiv_name',1,'$staffid','$userid')";
	...
	if($_POST['txt_measure_type']=="s")
	{
		...
		for ($c = 0; $c < count($rec); $c++) 
		{
			...
			$mbookdetailsquery	=	"INSERT INTO `mbookdetail`(`mbheaderid`, `subdivid`, `subdiv_name`, `descwork`, `measurement_no`, `measurement_l`, `measurement_dia`, `measurement_contentarea`, `entry_date`, `remarks`) VALUES ('" . $lastmbookheaderid . "' ,
											 '" . $subdiv_id . "',
											 '" . $subdiv_name . "',
											 '" . $_POST['txt_dec_wk_mt' . $x] . "' ,
											 '" . $_POST['txt_no_mt' . $x] . "' ,
    ...
    elseif($_POST['txt_measure_type']=="st")
	{
		...
		for ($c = 0; $c < count($rec); $c++) 
		{
			...
			$mbookdetailsquery	=	"INSERT INTO `mbookdetail`(`mbheaderid`, `subdivid`, `subdiv_name`, `descwork`, `measurement_no`, `measurement_l`, `measurement_b`, `measurement_d`, `structdepth_unit`, `measurement_contentarea`, `entry_date`, `remarks`) VALUES ('" . $lastmbookheaderid . "' ,
											 '" . $subdiv_id . "',
											 '" . $subdiv_name . "',
											 '" . $_POST['txt_dec_wk_st' . $x] . "' ,
											 '" . $_POST['txt_no_st' . $x] . "' ,
	...
	else
	{
		...
		for ($c = 0; $c < count($rec); $c++) 
		{
			...
			if($x!=2)
			{
			$mbookdetailsquery	=	"INSERT INTO `mbookdetail`(`mbheaderid`, `subdivid`, `subdiv_name`, `descwork`, `measurement_no`, `measurement_l`, `measurement_b`, `measurement_d`, `measurement_contentarea`, `entry_date`, `remarks`) VALUES ('" . $lastmbookheaderid . "' ,
											 '" . $subdiv_id . "',
											 '" . $subdiv_name . "',
											 '" . $_POST['txt_dec_wk' . $x] . "' ,
											 '" . $_POST['txt_no' . $x] . "' ,
    ...
    <script type="text/javascript"  language="JavaScript">
		...
		function get_current_entered_qty()
		{
			...
			if(used_qty > workorder_qty)
			{
				...
				swal("Entered measurement quantity is exceeded than Work Order quantity..", "", "");
				//return false;
				//exit();
			}
		...
		function valid()
		{
            ...
            else if(document.form.txt_measure_type.value=="st")
			{
				...
				if((document.form.txt_d_st.value!="") && (document.form.cmb_depthunit_st.value==""))
				{
					...
					swal("Select Unit of the Depth", "", "");
					exit;
				}
				if((document.form.txt_d_st.value=="") && (document.form.cmb_depthunit_st.value!=""))
				{
					//alert("Selected Depth Unit is Invalid");
					swal("Selected Depth Unit is Invalid", "", "");
					exit;
				}
			}
			else 
...
function addrow_st()
	...
	function checkGeneralSQM(obj)
	{
		var id = obj.id;
		var temp_unit1 = document.form.remarks.value;
		var temp_unit2 = temp_unit1.toLowerCase();
		var itemunit = temp_unit2.replace(/[^a-zA-Z ]/g, "");
		//alert(itemunit)
		if(itemunit == "sqm")
		{
			if(id == "txt_l")
			{
				var length = document.form.txt_l.value;
				if((length != "") && (length != 0))
				{
					var breadth = document.form.txt_b.value;
					var depth = document.form.txt_d.value;
					if((breadth != "") && (breadth != 0) && (depth != "") && (depth != 0))
					{
						alert("You must enter only any two field of length, breadth and depth");
						exit();
					}
				}
			}
			else if(id == "txt_b")
			{
				...
				if((breadth != "") && (breadth != 0))
				{
					var length = document.form.txt_l.value;
					var depth = document.form.txt_d.value;
					if((length != "") && (length != 0) && (depth != "") && (depth != 0))
					{
						alert("You must enter only any two field of length, breadth and depth");
						exit();
					}
			...
			else if(id == "txt_d")
			{
				...
				if((depth != "") && (depth != 0))
				{
					var length = document.form.txt_l.value;
					var breadth = document.form.txt_b.value;
					if((length != "") && (length != 0) && (breadth != "") && (breadth != 0))
					{
						alert("You must enter only any two field of length, breadth and depth");
						exit();
					}
...
<?php include "Menu.php"; ?>
                    ...
                    <div class="grid_12">
                        <blockquote class="bq1" style=" overflow-y: auto;">
                            <div class="title">Measurement Sheet Entry (M Book) </div>		
								...
								<input type="hidden" name="txt_work_no" id="txt_work_no" value="">
								<input type="hidden" name="hid_subdivname" id="hid_subdivname" value="<?php if($_GET['mbheaderid'] != "") { echo $subdiv_name; } ?>">
                                <div class="container">
			...
			<!------ NEW  FORMAT STARTS  HERE  ------------->			
										<tr>
											<td colspan="3" align="">
												<table style="display: inline-block;" width="510px">
													<tr>
														<td class="label" nowrap="nowrap" width="120px">&nbsp;&nbsp;&nbsp;Short Name</td>
														<td>
															<select id="workorderno" name="workorderno" onChange="func_item_no();cls()" class="textboxdisplaysmall" style="width:370px;height:22px;">
													...
													<tr>
														<td class="label" nowrap="nowrap" width="120px">&nbsp;&nbsp;&nbsp;Work Order No.</td>
														<td>
															<?php if($_GET['mbheaderid'] != "") { ?>
															<input type="text" name="txt_workorder_no" id="txt_workorder_no" class="textboxdisplaysmall" style="width:370px;" value="<?php echo $work_order_no; ?>">
															<?php }else { ?>
															<input type="text" name="txt_workorder_no" id="txt_workorder_no" class="textboxdisplaysmall" style="width:370px;">
															<?php } ?>
														</td>
														<td>&nbsp;</td>
													</tr>
													...
													<tr>
														...
														<td>
															<?php 
																if($_GET['mbheaderid'] != "") 
																{ ?>
																	<select name="itemno" id="itemno" class="textboxdisplaysmall" style="width:65px;height:22px;">
																...
																{?>
																	<select onBlur="display();get_itemquantity(this);" name="itemno" id="itemno" class="textboxdisplaysmall" onChange="cls(this);func_subitem_no();getitem_desc(this);" style="width:65px;height:22px;">
															   ...
															   <!-- &nbsp;&nbsp;&nbsp;&nbsp;Sub Item No.-->
																...
																if($_GET['mbheaderid'] != "") 
																{ ?>
																	<select name="subitemno" id="subitemno" class="textboxdisplaysmall" style="width:80px;height:22px;">
															   ...
															   <?php 
															   	...
															   	{?>
																	<select onBlur="display();get_itemquantity(this);" name="subitemno" id="subitemno" class="textboxdisplaysmall" style="width:80px;height:22px;" onChange="cls(this);find_desc(this); find_subsubitem(this);">
															   	...
															   	if($_GET['mbheaderid'] != "") 
															   	{ ?>
																	<select name="subsubitemno" id="subsubitemno" class="textboxdisplaysmall" style="width:85px;height:22px;">
																...
																{?>
																	<select onBlur="display();get_itemquantity(this);" name="subsubitemno" id="subsubitemno" class="textboxdisplaysmall" style="width:85px;height:22px;"  onChange="cls(this);find_subsubsubitem(this);find_desc(this);">
																...
																if($_GET['mbheaderid'] != "") 
																{ ?>
																	<select name="subsubsubitemno" id="subsubsubitemno" class="textboxdisplaysmall" style="width:85px;height:22px;">
																...
																{?>
																	<select onBlur="display();get_itemquantity(this);" name="subsubsubitemno" id="subsubsubitemno" class="textboxdisplaysmall" style="width:85px;height:22px;"  onChange="find_desc(this);">
													...
													<tr>
														...
														<td class="labeldisplay">
															<textarea name="descriptionnotes" id="descriptionnotes" class="textboxdisplaysmall txtarea_style" rows="2" style="width:370px;" disabled="disabled"><?php if($_GET['mbheaderid'] != "") { echo $shortnotes; } ?></textarea>
														</td>
														<td>&nbsp;</td>
													</tr>
													<tr style="height:7px;">
												...
												<table style="display: inline-block;" width="503px">
													<!--<tr>
...
<div style="height:404px; width:96%; padding-left: 0.999em">
	...
	<input type="text" name="sno" id="sno" class="textboxdisplaysmall" size="4" readonly="" value="1" style="width: 26px" /></td>
        ...
        <td style="width: 141px;border:thin lightgray solid">
							...
							<input type="text" name="txt_l" id="txt_l" class="textboxdisplaysmall" size="10" onBlur="contentorarea();checkGeneralSQM(this);" style="width: 84px" tabindex="3" value="<?php echo $measurement_l; ?>" onKeyPress="return isNumber(event)" /></td>
                                                      <td style="width: 84px;border:thin lightgray solid">
							<input type="text" name="txt_b" id="txt_b" class="textboxdisplaysmall" size="10" onBlur="contentorarea();checkGeneralSQM(this);" style="width: 84px" tabindex="4" value="<?php echo $measurement_b; ?>" onKeyPress="return isNumber(event)" /></td>
                                                      <td style="width: 84px;border:thin lightgray solid">
							<input type="text" name="txt_d" id="txt_d" class="textboxdisplaysmall" size="10" onBlur="contentorarea();checkGeneralSQM(this);" style="width: 84px" tabindex="5" value="<?php echo $measurement_d; ?>" onKeyPress="return isNumber(event)" /></td>
							...
							<input type="text" name="txt_ca" id="txt_ca" class="textboxdisplaysmall" size="10" readonly="" value="<?php echo $measurement_contentarea; ?>" style="width: 130px"/></td>
                                                      ...
                                                      <td style="width: 84px;border:thin lightgray solid">
							<input type="text" name="txt_l" id="txt_l" class="textboxdisplaysmall" size="10" onBlur="contentorarea();checkGeneralSQM(this);" style="width: 84px" tabindex="3" onKeyPress="return isNumber(event)" /></td>
                                                      <td style="width: 84px;border:thin lightgray solid">
							<input type="text" name="txt_b" id="txt_b" class="textboxdisplaysmall" size="10" onBlur="contentorarea();checkGeneralSQM(this);" style="width: 84px" tabindex="4" onKeyPress="return isNumber(event)" /></td>
                                                      <td style="width: 84px;border:thin lightgray solid">
							<input type="text" name="txt_d" id="txt_d" class="textboxdisplaysmall" size="10" onBlur="contentorarea();checkGeneralSQM(this);" style="width: 84px" tabindex="5" onKeyPress="return isNumber(event)" /></td>
                                                      <td style="width: 130px;border:thin lightgray solid">
...
function save(x) 
{
	...
	if(x != 1)
	{
		...
		{
			swal("Please Select Measurement Type...!", "", "");
			event.returnValue = false;//for ie
						event.preventDefault();//for chrome
		}
	}
