                        ...
                        <blockquote class="bq1" style="overflow:auto">
							...
							<div class="container">
									...
									<div class="div7" align="center">
										<div class="innerdiv2">
											<div class="row divhead head-b" align="center">Measurement Upload Entry Form</div>
											<div class="row innerdiv group-div" align="center">
												<!--<div class="div1">&nbsp;</div>
												<div class="div11" align="right" style=" margin-bottom:3px">
												...
												<div class="div9">
													<select name="txt_workshortname" id="txt_workshortname" class="divtbox" onChange="workorderdetail();zonename();" tabindex="1">
												...
												<div class="div3 lboxlabel" align="left">Measurement Type</div>
												<div class="div3" style="border:none">
													<div class="inputGroup">
														<input id="rad_others" name="rad_measurementtype" type="radio" value="G"/>
														<label for="rad_others" style="padding:3px 0px; width:98%;" > &nbsp;GENERAL </label>
													</div>
												</div>
												<div class="div1" style="border:none">&nbsp;</div>
												<div class="div3" style="border:none">
													<div class="inputGroup">
												...
												<!--<div class="div2" style="border:none">&nbsp;</div>-->
												<!--<div class="main-content div9 main-content-body" style="border:none; padding:0px !important;">
													<div class="div6" style="border:none">
														<div class="inputGroup">
															<input id="rad_others" name="rad_measurementtype" type="radio" value="G"/>
															<label for="rad_others" style="padding:3px 0px; width:98%;" > &nbsp;GENERAL </label>
														</div>
												...
												<div class="div12 grid-empty"></div>
												<div class="div3 hide lboxlabel" align="left" id="zrow1">Zone Name </div>
												<div class="div7 hide" id="zrow2">
													<select name='cmb_zone_name' id='cmb_zone_name'>
														<option value=""> ----------- Select Zone Name  ----------- </option>
													</select>
												</div>
												<div class="div2 hide" align="left" id="zrow4">&nbsp;</div>
												<div class="div12 hide grid-empty" id="zrow3"></div>
												<div class="div3 lboxlabel" align="left">Sheet Name</div>
												<div class="div9">
													<input type="text" name='txt_xl_sheetname' id='txt_xl_sheetname' class="divtbox">
												</div>
												<div class="div2 lboxlabel" align="left">&nbsp;</div>
												<div class="div12 grid-empty"></div>
												<div class="div3 lboxlabel" align="left">Start Row</div>
												<div class="div4">
													<input type="text" name='txt_xl_startrow' id='txt_xl_startrow' value="7" readonly="" class="divtbox">
												</div>
												<div class="div2 cboxlabel" align="center">&nbsp;End Row&nbsp;</div>
												<div class="div3">
													<input type="text" name='txt_xl_endrow' id='txt_xl_endrow' class="divtbox">
												</div>
												<div class="div12 grid-empty"></div>
												<div class="div3 lboxlabel" align="left">Upload File</div>
												<div class="div9" align="left">
													<input type="file" class="text" name="file" id="file" style="height:25px;" />
												</div>
												<!--<div class="div10" align="right" style="color:#ACACAC">Upload files allow only the file formats of : .xls, .xlsx</div>-->
										...
										<div class="div3" align="center">
											<div class="innerdiv2">
												<div class="row divhead head-b" align="center">Guidelines/Instructions</div>
												<div class="row innerdiv group-div" align="center">
													<div class="div12">
														<div class="div12 inst-box" style="border:none">
															<div class="div12" align="center" style="margin-bottom:8px;">
																<a href="MeasurementUpload_View.php"><span class="inst-link">View Unconfirmed Measurements</span></a>
															</div>
														</div>
													</div>
													<div class="div12">
														<div class="div12 inst-box" id="GV" onClick="OpenInNewTabWinBrowser('MeasurementUpload_File_Sample_General.php');">
															<div class="div3">
																<i class="fa fa-folder-open ficon"></i>
															</div>
															<div class="div9 lht1">
																Click here to view Geneal Mesasurements upload file format, instructions and guidelines.
															</div>
														</div>
													</div>
													<div class="div12">
														<div class="div12 inst-box" id="SV" onClick="OpenInNewTabWinBrowser('MeasurementUpload_File_Sample_Steel.php');">
															<div class="div3">
																<i class="fa fa-folder-open ficon"></i>
															</div>
															<div class="div9 lht1">
																Click here to view Steel Mesasurements upload file format, instructions and guidelines.
															</div>
														</div>
													</div>
													<div class="div12">
														<div class="div12 inst-box" id="GD">
															<a href="download.php?filename=GMTemplate.xlsx" title="Click here to download General Measurements file">
															<div class="div3">
																<i class="fa fa-download ficon"></i>
															</div>
															<div class="div9 lht1" style="padding-top:4px">
																Click here to download Geneal Mesasurements template file.
															</div>
															</a>
														</div>
													</div>
													<div class="div12">
														<div class="div12 inst-box" id="SD">
															<a href="download.php?filename=SMTemplate.xlsx" title="Click here to download Steel Measurements file">
															<div class="div3">
																<i class="fa fa-download ficon"></i>
															</div>
															<div class="div9 lht1" style="padding-top:4px">
																Click here to download Steel Mesasurements template file.
															</div>
															</a>
														</div>
													</div>
													<div class="div12">
														<div class="div12 inst-box">
															<div class="div12 lht1">
																&nbsp;<b>Note :</b> <br/>
																&nbsp;Upload files allow only the file formats of <br/>
																&nbsp;.xls, .xlsx
															</div>
														</div>
													</div>
											...
											<!--<div class="div12" style="border:1px solid #DBDBDB">
												<img src="images/xls.png" style="opacity:0.5">uyuyuytutyu
											</div>-->
										</div>
										<div class="div1" align="center">&nbsp;</div>
									</div>
	...
	/*$('#btn-overlay').click(function(e){ alert();
	  $('#overlay').show();
		...
		function UploadMeasurements() 
		{
        	...
        	$.ajax({ 
				type      	: 'POST', 
				url       	: 'ExcelThirdPartyLibrary.php',
				data	  	:  formData,
