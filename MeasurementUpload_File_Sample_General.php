...
<script type="text/javascript">
    ...
    $(document).ready(function () {  
		 ...
		 [ "Agreement No.", "", "" ], 
		 [ "RAB No", "", "", "CC No.", "", "", "" ],
		 [ "Date", "Item No.", "Description", "No.", "L", "B", "D", "" ],
		 [ "02.01.2016", "1.1.a", "F-001 Footings (Some Mesaurements 1)", "2", "1.234", "0.123", "2.000", "" ],
		 [ "", "", "F-001 Footings (Some Mesaurements 1)", "2", "1.234", "0.123", "2.000", "" ],
		 [ "", "", "F-001 Footings (Some Mesaurements 2)", "3", "2.345", "0.345", "3.000", "" ],
		 [ "", "", "F-001 Footings (Some Mesaurements 3)", "4", "3.456", "0.567", "4.000", "" ],
		 [ "03.01.2016", "1.1.a", "EXCAVATION", "", "", "", "", "" ],
		 [ "", "", "Earth work excavation (Work Description 1)", "2", "1.234", "0.123", "2.000", "" ],
		 [ "", "", "Earth work excavation (Work Description 2)", "3", "2.345", "0.345", "3.000", "" ],
		 [ "03.01.2016", "5.7.a", "CONCRETE AND ALLIED WORKS", "", "", "", "", "" ],
		 [ "", "", "Work Description 1", "2", "1.234", "", "2.000", "" ],
		 [ "", "", "Work Description 2", "3", "2.345", "", "3.000", "" ],
		 ];
		...
		<div class="container_12">
			<div class="grid_12">
				<blockquote class="bq1" style="background-color:#FFFFFF">
					&nbsp;
					<div class="title">Measurement Upload Sample File Format - General </div>
					...
					<div style="height:260px">
						<div class="dosection">
							...
							<div class="dodontcontent">3. 
								...
								&emsp;&emsp;&nbsp;<font style="color:#740368">(d)</font> 4th column should be a No.(Number) field.<br/>
								&emsp;&emsp;&nbsp;<font style="color:#740368">(e)</font> 5th column should be a B.(Breadth) field.<br/>
								&emsp;&emsp;&nbsp;<font style="color:#740368">(f)</font> 6th column should be a D.(Depth) field.
							</div>
						...
						<div class="dontsection">
							...
							<div class="dodontcontent">8. Dont use any special character in Date, Item No., No., L., B. and D. Column if these field dont have any value please be left as empty.</div>
					...
					<div>
						<p><font style="font-family:Verdana, Arial, Helvetica, sans-serif; color:#BF0500; font-weight:bold; font-size:11px">* The Above Instruction are only applicable for "General Measurements".</font></p>
					</div>
