...
if($_GET['sheetid'] != "")
{
	...
	$select_itemlist_sql 	= 	"select subdivision.subdiv_id, subdivision.subdiv_name, subdivision.div_id, schdule.total_quantity,schdule.per, schdule.deviate_qty_percent, schdule.sub_type from subdivision 
	...
	while($ItemList = mysql_fetch_object($select_itemlist_query))
	{
		...
		for($x=0; $x<count($expDiaStr); $x++)
		{
			...
			//{
				...
				$select_measurementqty_sql = "SELECT measurement_contentarea AS usedqty FROM mbookdetail where measurement_dia = '$dia' and subdivid = '$subdivid' and measurement_contentarea != ''";// GROUP BY mbookdetail.subdivid";
...
INNER JOIN schdule ON (schdule.subdiv_id = mbookdetail_temp.subdivid)
...
<style>
    ...
    <body class="page1" id="top" oncontextmenu="return false"onload="noBack();" onpageshow="if (event.persisted) noBack();" onUnload="">
                ...
                <div class="container_12">
                    <div class="grid_12">
                        <blockquote class="bq1" style="overflow:scroll">
							...
							{
							?>
							<table width="1070px" border="0" align="center" cellpadding="3" cellspacing="3" class="table1">
								<tr>
					...
					if(mysql_num_rows($getmeasurement_query)>0)
					{
						...
						while($MList = mysql_fetch_object($getmeasurement_query))
						{
							...
							{ 
								...
								$ItemErr = $ItemErr.$eno.". ".$QtyError."<br/>"; 
								$Errorstr =  $MItemno."@@@".$DateError."@@@".$ItemError."@@@".$QtyError;
		...
		<input type="hidden" name="txt_descrip_<?php echo $Mbdetailid; ?>" id="txt_descrip_<?php echo $Mbdetailid; ?>" value="<?php echo $MDescription; ?>">							
									...
									<td align="right" 	id="td_dia_<?php echo $Mbdetailid; ?>">
