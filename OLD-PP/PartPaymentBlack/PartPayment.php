...
<head>
    ...
    <!-- Google Fonts
		============================================ -->
    <link href="fonts-googleapis/fonts.css" rel="stylesheet">
    <!-- Bootstrap CSS
		============================================ -->
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        <li>
                            <a class="has-arrow" href="index.html"><button type="button" class="btn btn-custon-four btn-default colorA1" style="color:#fff;">1</button></a>
                            <ul class="submenu-angle" aria-expanded="true" style="background:#205B97; border:1px solid #363838; border-left:none;  box-shadow: 0px 0px 134px 0px #043068 inset;">
                                ...
                                <!--<li><a title="Dashboard v.2" href="index-1.html" style="color:#FFFFFF"><span class="mini-sub-pro">Dashboard v.2</span></a></li>
                                <li><a title="Dashboard v.3" href="index-2.html" style="color:#FFFFFF"><span class="mini-sub-pro">Dashboard v.3</span></a></li>
                                <li><a title="Analytics" href="analytics.html" style="color:#FFFFFF"><span class="mini-sub-pro">Analytics</span></a></li>
                                <li><a title="Widgets" href="widgets.html" style="color:#FFFFFF"><span class="mini-sub-pro">Widgets</span></a></li>-->
                            </ul>
                        </li>
						<?php $x1= 2; for($j=2; $j<21; $j++){ $ColorCls = "colorA".$x1; if($x1 == 10){ $x1 = 0; } $x1++; ?>
                        <li><a title="RAB - <?= $j; ?>" href="events.html" aria-expanded="false"><button type="button" class="btn btn-custon-four btn-default <?php echo $ColorCls; ?>" style="color:#fff;"><?= $j; ?></button></a></li>
						<?php } ?>
                    </ul>
                </nav>
            </div>
                                    ...
                                    <div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
                                        <div class="header-top-menu tabl-d-n">
                                            <ul class="nav navbar-nav mai-top-nav">
                                                <li class="nav-item">
													<a href="#" class="nav-link">Item No. 12.1.1</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="panel-body">
                                ...
                                <ul class="mailbox-list mar-btm-1" style="border:1px solid #2195E3;">
                                    <li class="active" style="">
                                        <a href="#" style="background:#2195E3; color:#FFFFFF; border:none"><span class="pull-right">12 cum</span><i class="fa fa-envelope text-danger" style="color:#fff;"></i>Item Qty</a>
                                    </li>
                                    <li>
                                        <a href="#" style="color:#0241BE"><span class="pull-right">120 cum</span><i class="fa fa-check"></i> Agreement Qty</a>
                                    </li>
                                    <li>
                                        <a href="#" style="color:#0241BE"><span class="pull-right">60 cum</span><i class="fa fa-check"></i> Deviation Qty</a>
                                    </li>
                                    <li>
                                        <a href="#" style="color:#0241BE"><span class="pull-right">12 cum</span><i class="fa fa-check"></i> Beyond Dev. Qty</a>
                                    </li>
                                </ul>
                                <ul class="mailbox-list mar-btm-1" style="border:1px solid #EC416D;">
									<li class="active">
                                        <a href="#" style="background:#EC416D; color:#FFFFFF; border:none"><i class="fa fa-envelope text-danger" style="color:#fff"></i>Since Last Part payment</a>
                                    </li>
                                    <li>
                                ...
                                <ul class="mailbox-list mar-btm-1" style="border:1px solid #02B7C9;">
									<li class="active">
                                        <a href="#" style="background:#02B7C9; color:#FFFFFF; border:none"><i class="fa fa-envelope text-danger" style="color:#fff"></i>Deduct Previous Part Payment</a>
                                    </li>
                                    <li>
