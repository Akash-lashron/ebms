                    ...
                    <ul class="metismenu" id="menu1">
                        <li>
                            <a class="has-arrow" href="index.html">
								   <button type="button" class="btn btn-custon-four btn-default colorA1" style="color:#006DF0;">1</button>
								</a>
                            <ul class="submenu-angle" aria-expanded="true" style="background:#0450A4">
                        ...
                        <li><a title="Landing Page" href="events.html" aria-expanded="false"><button type="button" class="btn btn-custon-four btn-default <?php echo $ColorCls; ?>" style="color:#006DF0;"><?= $j; ?></button></a></li>
						<?php } ?>
                    </ul>
                </nav>
            </div>
