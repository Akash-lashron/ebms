							...
							?>
								<div class="card RabDetails <?php echo $Cls; ?>" id="RAB<?php echo $rbn; ?>" style="padding-top:1px; margin-top:1px;">
                                    ...
                                    <div class="stat-widget-two">
										<div class="row">
											<div class="col-4">
												<div class="card color1" style="margin-top:0px;">
													<table class="table SlmTab" id="SLMaddrTab<?php echo $rbn; ?>">
														<thead>
															<tr><th colspan="4" style="text-align:center; background:#E4E4E4; font-weight:normal;">Since Last Part Payment</th></tr>
															<tr>
												...
												<div class="card color1">
													<table class="table DpmTab" id="DPMaddrTab<?php echo $rbn; ?>">
														<thead>
															<tr><th colspan="4" style="text-align:center; background:#E4E4E4; font-weight:normal;">Deduct Previous Part Payment</th></tr>
															<tr>
																<th class="text-center">Qty</th>
																<th class="text-center">Rate</th>
																<th class="text-center">( % )</th>
