                                ...
                                <div class="row">
                                    <div class="col-md-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="btn-group ib-btn-gp active-hook mail-btn-sd mg-b-15">
											...
											<button type="sumit" name="BalanceBtn[<?= $RABValue; ?>]" class="btn btn-default btn-sm BalanceBtn BalanceBtn<?= $BDtClass; ?>" id="BalanceBtn<?= $RABValue; ?>" data-id="<?= $RABValue; ?>" value="<?= $RABValue; ?>"><?= $RABValue; ?></button>
											<?php } } ?>
                                        </div>
                                    </div>
                                </div>
													...
													?>
														<tr class="unread">
															...
															<?php if($TotalpaidPerc < 100){ ?>
																<input type="text" name="txt_curr_perc<?php echo $RABValue; ?>[]"  data-type='S' data-rbn="<?php echo $RABValue; ?>" id="txt_curr_perc<?php echo $DetList->mbdetail_id; ?>" data-id="<?php echo $DetList->mbdetail_id; ?>" data-qty="<?php echo $DetList->measurement_contentarea; ?>" data-prev_par_id = "<?php echo $GrParId;//$prev_parent_id; ?>" class="form-control small-tbox tbox-r FixCurrPerc<?php echo $RABValue; ?> fixAll PreParId<?php echo $GrParId;//$prev_parent_id; ?>" value="<?php if($DetList->curr_paid_perc != 0){ echo $DetList->curr_paid_perc; } ?>">
															<?php } ?>
															</td>
															<td align="center">
																TEST
									...
									<table class="table mtab SlmTab TabF" id="SLMaddrTab<?php echo $rbn; ?>" style="margin-bottom:6px">
										...
										<tbody>
											...
											<tr id='SlmAddR0' class="SLMROW<?php echo $rbn; ?>">
												...
												<td><input type="text" name='ParSlmAddQty<?php echo $rbn; ?>[]' class="form-control small-tbox tbox-r ResCls SlmQty" readonly='' data-rbn="<?php echo $rbn; ?>" value="<?php echo round($QtyValue,$Decimal); ?>"/></td>
									...
									<table class="table mtab SlmTab TabF" id="DPMaddrTab<?php echo $rbn; ?>" style="margin-bottom:6px">
										...
										?>
											<tr class='LDPMROW<?php echo $DpmPaidList->rbn; ?>'>
												...
												<td><input name='ChiDpmAddQty<?php echo $DpmPaidList->rbn; ?>PID<?php echo $DpmPaidList->measurementbookid; ?>[]' type='text' class='form-control input-md small-tbox tbox-r ResCls DpmQty DpmQty<?php echo $DpmPaidList->rbn; ?>' readonly='' data-rbn='<?php echo $DpmPaidList->rbn; ?>' value='<?php echo $PPList->qty; ?>' /></td>
