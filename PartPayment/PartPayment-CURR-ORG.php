											...
											if(mysql_num_rows($SelectGrParDetailSql)>0){
												while($GrParDtList = mysql_fetch_object($SelectGrParDetailSql)){
													...
													?>
														...
														<tr id='DpmAddR<?php echo $DpmPaidSlno; ?>' class="DpmAddR<?php echo $DpmPaidSlno; ?> DPMROW<?php echo $GrParRbn; ?> DpmPId<?php echo $DistGrParId; ?>">
															...
															<td><input type="text" name='ParDpmAddQty<?php echo $GrParRbn; ?>[]' class="form-control small-tbox tbox-r ronly ResCls DpmQty DpmQty<?php echo $GrParRbn; ?>" readonly="" data-rbn="<?php echo $GrParRbn; ?>" value="<?php echo $GrParQty; ?>"/></td>
															...
															<td><input type="text" name='ParDpmAddPerc<?php echo $GrParRbn; ?>[]' class="form-control small-tbox tbox-r ResCls DpmPerc <?php echo $RonlyClass; ?>" readonly='' data-rbn="<?php echo $GrParRbn; ?>" value=""/></td>
															<td>
																<input type="text" name='ParDpmAddAmount<?php echo $GrParRbn; ?>[]' class="form-control small-tbox tbox-r ronly DpmAmt" readonly="" value="<?php echo "0.00";//$DpmPaidList->measurementbookid; ?>"/>
													...
													<?php if($CurrPPayCount == 1){ while($CurrPPayList = mysql_fetch_object($SelectCurrPPaySql)){ $CurrPPayAmt = round(($CurrPPayList->qty * $CurrPPayList->percent * $ItemRate / 100),2); ?>
														<tr class='DpmAddR<?php echo $GrParRbn; ?>'>
															...
															<td><input name='ChiDpmAddQty<?php echo $GrParRbn; ?>PID<?php echo $DistGrParId; ?>[]' type='text' class='form-control input-md small-tbox tbox-r ResCls DpmQty DpmQty<?php echo $GrParRbn; ?>' data-rbn='<?php echo $GrParRbn; ?>' value='<?php echo $CurrPPayList->qty; ?>' /></td>
															...
															<td><input name='ChiDpmAddPerc<?php echo $GrParRbn; ?>PID<?php echo $DistGrParId; ?>[]' type='text' class='form-control input-md small-tbox tbox-r ResCls DpmPerc' readonly='' data-rbn='<?php echo $GrParRbn; ?>' value='<?php echo $CurrPPayList->percent; ?>'></td>
															...
															<td>
																...
																<input type='text' name='ChiParDpmMbIdList<?php echo $GrParRbn; ?>PID<?php echo $DistGrParId; ?>[]' value='<?php echo $CurrParIdArr[$DistGrParId][$CurrPPayList->percent]; ?>'>
															</td>
														</tr>
													<?php
														} }
