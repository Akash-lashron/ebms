...
<script>
    ...
    <body class="page1" id="top" oncontextmenu="return false"onload="noBack();" onpageshow="if (event.persisted) noBack();" onUnload="">
        ...
        <!--==============================Content=================================-->
        <div class="content">
                        <div class="title">Part-Payment Abstract Generate</div>
							...
							<br/>
								 <table width="100%"  bgcolor="#E8E8E8" border="0" cellpadding="0" cellspacing="0" align="center" >
									 ...
									 <tr>
										...
										<select name="cmb_work_no" id="cmb_work_no" onChange="find_workname();func_GenerateAbstractMBno();getrbn();" class="textboxdisplay" style="width:400px;height:22px;" tabindex="7">
