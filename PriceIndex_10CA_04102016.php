...
if (isset($_POST["submit"])) 
{
	...
	$pi_month1			= 	$pi_month_arr[0];
	$pi_month2 			= 	$pi_month_arr[1];
	$pi_month3 			= 	$pi_month_arr[2];
                ...
                else
                {
                   	...
                   	for(i = 0; i < name.length; i+=8)
                   	{
						...
						var txt_box7 = document.createElement("input");
							txt_box7.name = "txt_price_index_rate"+bid+"[]";
						...
						var txt_box8 = document.createElement("input");
							txt_box8.name = "txt_price_index_rate"+bid+"[]";
                ...
                <div class="container_12">
                    <div class="grid_12">
                        ...
                        <table width="1078px" border="0" align="center" cellpadding="0" cellspacing="0" class="color1">
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td class="label">No.of Month</td>
                                    <td><input type="text" name='txt_no_of_month' id='txt_no_of_month' class="textboxdisplay" value="" style="width: 100px;" onBlur="SetMonthField();"></td>
                                </tr>
