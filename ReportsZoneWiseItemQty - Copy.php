...
<form name="form" id="form" method="post">
            ...
            echo $title;
            $table2 = "<table width='100%' border='0'  cellpadding='3' cellspacing='3' align='center' bgcolor='#ffffff'>";
			$table2 = $table2 . "<tr>";;
...
<table width="100%" border="0" cellpadding="3" cellspacing="3" align="center" bgcolor="#FFFFFF" class="label">
<?php echo $table1; ?>
<?php
	for($zc3=0; $zc3<$item_count; $zc3++)
	{
		...
		//echo $select_item_detail_query."<br/>";
		...
		if($select_item_detail_sql == true)
		{
			if(mysql_num_rows($select_item_detail_sql)>0)
			{
				...
				//print_r($QtyArr);echo $subdivid."<br/>";
