...
$LtcLtLasPsA1 		= $m1."-".$m2."-".$m3."-".$m4."-".$m5."-".$m6a;
$LtcLtLasPsA2 		= $m1."-".$m2."-".$m3."-".$m4."-".$m5."-".$m6b;
$LtcLtLasPsA3 		= $m1."-".$m2."-".$m3."-".$m4."-".$m5."-".$m6c;
...
if(($LtcLtSas == $LtcLtLasPsA)||($LtcLtSas == $LtcLtLasPsA1)||($LtcLtSas == $LtcLtLasPsA2)||($LtcLtSas == $LtcLtLasPsA3))
{
	$temp++;
}
//$temp = 3;
