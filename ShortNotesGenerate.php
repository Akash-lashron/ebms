...
header('Location: ShortNoteCreate.php'); 
}
...
<SCRIPT type="text/javascript">
    ...
    <body class="page1" id="top" oncontextmenu="return false"onload="noBack();" onpageshow="if (event.persisted) noBack();" onUnload="">
        ...
        <!--==============================Content=================================-->
        <div class="content">
                        <div class="title">Short Notes Generate</div>
                             ...
                             <table width="100%"  bgcolor="#E8E8E8" border="0" cellpadding="0" cellspacing="0" align="center" >
									...
									<td  class="labeldisplay">
									   <select name="cmb_work_no" id="cmb_work_no" onChange="find_workname()" class="textboxdisplay" style="width:470px;height:22px;" tabindex="7">
										 ...
										 if($_SESSION['staff_section'] == 3){
										 	echo $objBind->BindWorkOrderNo(0);
                               ...
                               <tr>
								...
								<div style="text-align:center; height:45px; line-height:45px;" class="printbutton">
										...
										<input type="button" class="backbutton" name="back" id="back" value="Back" <?php if($_SESSION['staff_section'] == '2'){ ?> onClick="goBackAcc();"<?php }else{ ?> onClick="goBack();"<?php } ?> />
										</div>
										<div class="buttonsection">
										<input type="submit" data-type="submit" value=" View " name="submit" id="submit"/>
										</div>
