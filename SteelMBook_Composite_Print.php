...
$selectmbook_detail = " select DISTINCT fromdate, todate, rbn, abstmbookno FROM mbookgenerate WHERE sheetid = '$sheetid' AND flag = '2'";
...
<?php
            ...
            $table1 = $table1 . "<td width='2%' rowspan='2' class='labelcenter headingfont' style=''></td>";  //Remarks Field changed into Per.
            $table1 = $table1 . "</tr>";
...
INNER JOIN subdivision ON (mbookdetail.subdivid = subdivision.subdiv_id) WHERE  mbookheader.date  >= '$fromdate' AND mbookheader.date  <= '$todate' AND schdule.measure_type = 's' AND mbookdetail.mbdetail_flag != 'd' AND mbookheader.sheetid = '$sheetid' ORDER BY mbookheader.date, mbookdetail.subdivid ASC";
               ...
               if($sqlmeasurequery == true)
               {
				...
				$decimal = get_decimal_placed($List->subdivid,$sheetid);
                    ...
                    <td width='' colspan="6" class='labelcenter' style='text-align:right'><?php echo "B/f from Page ".$prevpage."/ Steel MB No.".$prevmbookno."";  ?></td>
                ...
                <tr height='' class="labelbold">
					...
					<input type="text" name="txt_pageid" class="labelbold" readonly="" id="txt_pageid<?php echo $txtboxid; ?>" style="width:243px; text-align:right; border:none;" />
				</td>
                    <td width='' class='labelcenter'></td>
                    <td width='' class='labelcenter' style="text-align:right"><?php if($tot8 != "") { echo number_format($tot8,$prev_decimal,".",","); } ?></td>
                    <td width='' class='labelcenter' style="text-align:right"><?php if($tot10 != "") { echo number_format($tot10,$prev_decimal,".",","); } ?></td>
		...
		if($measurementdia == 36){ ?><td width='6%' class='labelcenter' style="text-align:right"><?php $dia = 36; echo number_format($totaldia,$decimal,".",","); ?></td><?php $totaldiathirtysix+=$totaldia; }             
				...
				<tr height='25px' class="labelbold"><td colspan="16" align="center" class="labelcenter"><?php echo "Summary"; ?></td></tr>
                </tr>
                <?php
				$currentline+=4;
				/*if($currentline>32)
              ...
              // echo $summary."<br/>";
			   ...
			   $pre_subdivname = ""; $temp_var = "";$pre_subdivid = "";$summary_total = 0;
				...
				<tr height='' bgcolor="">
                   ...
                   <td width='' colspan="6" class='labelcenter'><?php echo $totalweight_KGS." kg"; ?></td>
				...
				<tr height='' class="labelbold">
                   ...
                   <td width='' colspan="3" class='labelcenter'>Total in mt</td>
                   <td width='' colspan="6" class='labelcenter'><?php echo $totalweight_MT." mt"; ?></td>
                   <td width='' colspan="5" class='labelcenter' style='text-align:right'><?php echo getabstractpage($sheetid,$pre_subdivid); ?></td>
...
?>
<tr height='' bgcolor="" class="labelbold">
  <td width='' colspan="6" class='labelcenter'><?php if($mpage==1){ echo "B/f from Page 100"; } else { echo "B/f from Page ".($mpage-1); } ?></td>
  <td width='7%' class='labelcenter' style="text-align:right"><?php if($subtotal_8 != 0) { echo number_format($subtotal_8,$result_summary[$x17],".",","); } ?></td>
  <td width='7%' class='labelcenter' style="text-align:right"><?php if($subtotal_10 != 0) { echo number_format($subtotal_10,$result_summary[$x17],".",","); } ?></td>
  <td width='7%' class='labelcenter' style="text-align:right"><?php if($subtotal_12 != 0) { echo number_format($subtotal_12,$result_summary[$x17],".",","); } ?></td>
  <td width='7%' class='labelcenter' style="text-align:right"><?php if($subtotal_16 != 0) { echo number_format($subtotal_16,$result_summary[$x17],".",","); } ?></td>
...
//echo $result_summary[$x16]."<br/>";
				...
				<tr height='' bgcolor="">
                   ...
                   <td width='' class='labelcenter'></td>
                   <td width='' colspan="3" class='labelcenter'>Total in kg</td>
                   <td width='' colspan="6" class='labelcenter'><?php echo number_format($totalweight_KGS,$pre_decimal,".",",")." kg"; ?></td>
                   <td width='' colspan="5" class='labelcenter'>&nbsp;</td>
				   
                </tr>
				<tr height='' class="labelbold"><!--A8FDAC-->
                   <td width='' class='labelcenter'></td>
                   <td width='' class='labelcenter'></td>
                   <td width='' colspan="3" class='labelcenter'>Total in mt</td>
                   <td width='' colspan="6" class='labelcenter'><?php echo number_format($totalweight_MT,$pre_decimal,".",",")." mt"; ?></td>
                   <td width='' colspan="5" class='labelcenter' style='text-align:right'><?php echo getabstractpage($sheetid,$pre_subdivid); ?></td>
