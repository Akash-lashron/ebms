...
function check_workorder_measurements($sheetid,$supp_sheetid)
{
	...
	/*$check_workorder_measurements_sql = "select  sheet.sheet_id, sheet_supplementary.sheetid, mbookheader.mbheaderid, mbookheader.sheetid, mbookdetail.mbdetail_id  from mbookheader 
...
if(isset($_POST['delete']))
{
	...
	header('Location: SupplementaryAgreementSheetEntryView.php?msg='.$temp);
}
?>
                ...
                <div class="container_12">
                    <div class="grid_12">
                        ...
                        <blockquote class="bq1" style="overflow:auto">
							   ...
							   $sno = 1;
								   ...
								   ?>
									...
									<div class="table-row">
										...
										<div class="col labelhead" align="center"><?php echo $sno; ?> </div>
										<div class="col labelhead" style="color:#1430EF">
										<?php
										if($check == 0)
										{
										?>
											<a href="SupplementaryAgreementSheetEntry.php?sheet_id=<?php echo $List->supp_sheet_id; ?>"><u><?php echo $List->work_order_no; ?></u> </a>
										<?php
										}
										else
										{
										...
										<div class="col labelhead"><?php echo dt_display($List->work_order_date); ?> </div>
                            ...
                            <!--<div class="col2"><?php //if ($msg != '') { echo "<center class='message'><br/>".$msg."</center>"; } ?></div>-->
