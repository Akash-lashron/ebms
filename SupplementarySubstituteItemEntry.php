...
if (isset($_POST["submit"])) {
	 ...
	 $measure_type   	= trim($_POST['txt_measure_type']);
	 $measure_sub_type  = trim($_POST['txt_measure_sub_type']);
	 //echo $measure_sub_type;exit;
...
//                                                    document.form.descriptionnotes.value=name[2];}
  	...
  	function item_description(obj)
	{
		...
		document.form.txt_measure_type.value = "";
		document.form.txt_measure_sub_type.value = "";
        var xmlHttp;
        var data;
        var i, j;
        if (window.XMLHttpRequest) // For Mozilla, Safari, ...
        ...
        xmlHttp.onreadystatechange = function ()
           ...
           if (xmlHttp.readyState == 4)
           {
               ...
               if (data != "")
               {
					...
					var mtype = name[3];
					var subtype = name[4];
					document.form.txt_measure_type.value = mtype;
					document.form.txt_measure_sub_type.value = subtype;
					//alert(subtype);
					if(cmb_id == "itemno")
					{
						if(name[0] != "")
                ...
                <div class="container_12">
                    <div class="grid_12">
                        <blockquote class="bq1" style="overflow-y:scroll;">
                            <div class="title">Substitute Item Entry <?php //print_r($MbHead); ?> </div>		
                          	
                                <input type="hidden" name="txt_item_no" id="txt_item_no" value="">
                                <input type="hidden" name="txt_work_no" id="txt_work_no" value="">
								<input type="hidden" name="txt_measure_type" id="txt_measure_type">
								<input type="hidden" name="txt_measure_sub_type" id="txt_measure_sub_type">
                                <div class="container">
                                    <table width="100%" border="1" cellpadding="0" cellspacing="0" align="center">
                                        ...
                                        <tr>
                                            ...
                                            <td class="label">
                                                <select id="workorderno" name="workorderno" onChange="func_item_no(); cls(this); GetSupplementaryWorkOrder();" class="textboxdisplay" style="width:505px;height:22px;" tabindex="7">
											...
											<td colspan="2" align="center">
												 <div style=" background-color:#EEEEEE; border:1px solid #D4D4D4" id="extra_item_div">
								  					<table width="100%" class="label">
														<tr style="background-color:#F0F0F0; height:25px; color:#FFFFFF; vertical-align:middle"><td align="center" colspan="4" class="gradientbg">Substitute Item </td></tr>
														<tr>
														...
														<tr>
															...
															<td align="center"><input type="text" class="extraItemTextbox" name="txt_extra_item_no" id="txt_extra_item_no"></td>
