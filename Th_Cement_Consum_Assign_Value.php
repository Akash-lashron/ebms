...
$schdulesql ="SELECT DISTINCT sno,sch_id, subdiv_id, sheet_id,  description, total_quantity, rate, per, decimal_placed, tc_unit, total_amt, subdiv_id, page_no FROM schdule where sheet_id= '$sheetid' AND  sno != '0' ";
$schdule=mysql_query($schdulesql);
 $RowCount =0;
 if(isset($_POST['back']))
 {
     header('Location: Th_Cement_Consum_Assign.php');
 }
 if(isset($_POST['update']))
 {
	...
	for($i=0; $i<$cnt; $i++)
	{
		...
		//echo $res[$i];
		$update_decimal_query = "update schdule set tc_unit = '$result[1]' WHERE sch_id = '$result[0]' AND sheet_id = '$sheetid'";
	...
	header('Location: Th_Cement_Consum_Assign_Value.php?sheetid='.$sheetid.'&temp='.$temp); 
 }
 //echo "M1".$msg;
?>
                        ...
                        <blockquote class="bq1" style="height:1px; overflow:auto;">
                         ...
                         <?php 
								...
								{ 
									 ...
									 ?>
									<div class="table-row">
										<div class="col labelhead" align="center" style="width:60px;">
											<?php echo $List->sno; ?> 
										</div>
										<div class="col labelhead" style="width:607px;" align="left" id="<?php if($List->per != ""){ echo $divid_incr; }else { echo "divid".$divid_incr; } ?>">
											<?php echo $List->description; ?> 
										</div>
										<div class="col labelhead" align="center" style="width:77px;">
										...
										<div class="col labelhead" align="center" style="width:85px;">
											<?php echo $List->rate; ?> 
										</div>
										<div class="col labelhead" align="center" style="width:106px;">
											<?php 
											if($List->total_amt != 0)
											{
												echo $List->total_amt;
										...
										<div class="col labelhead" align="center" style="width:76px">
											<?php if(($List->per != "")&&($List->per != '0'))
											{ ?>
											<input type="text" class="textboxdisplay textboxstyle" style="color:#003399; width:72px" name="txt_decimal_placed" id="txt_decimal_placed<?php echo $divid_incr; ?>" value="<?php echo $List->tc_unit; ?>"  onkeypress="return IsAlphaNumeric(event);" onBlur="get_decimal_val(<?php echo $x1; ?>,<?php echo $List->sch_id; ?>,this);"  >
											<input type="hidden" name="hide_result[]" id="hide_result<?php echo $x1; ?>" value="<?php echo $List->sch_id."@".$List->tc_unit; ?>" >
