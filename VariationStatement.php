...
if(($_SESSION['VarStmtSheetid'] != '')&&($_SESSION['VarStmtRbn'] != '')){
...
<script>
	function goBack(){
	   	url = "VariationStatementRemarks.php";
                    ...
                    <blockquote class="bq1" style="overflow:auto" id="printSection">
                            ...
                            <div class="container" align="center">
								...
								<thead>
									...
									<tr>
										...
										<td colspan="13"><?php echo $rbn; ?><?php echo $RabText; ?></td>
									</tr>
									<tr>
						...
						?>
									<tr>
										...
										<td align="left"><?php echo $List->vari_stmt_rem; ?></td>
									</tr>
						...
						?>			<?php if(trim($VarRemark) != ''){ ?>
									<tr class="label">
										<td colspan="2" align="left">Remarks </td>
										<td colspan="13" align="left"><?php echo $VarRemark; ?></td>
									</tr>
									<?php } ?>	
									<tr class="label">
									...
									<tr class="label">
										<td align="left" colspan="4">( % )of overall Excess/Less as per Agreement</td>
