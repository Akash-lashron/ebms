...
if (isset($_POST["submit"])) {
    ...
    header('Location: ViewMeasurementEntryListMBFormat.php?TempVal='.$temp);
                            ...
                            <div class="title">View Measurement Entry</div>		
                                ...
                                <div class="container">
                                    <table width="1078" border="1" cellpadding="0" cellspacing="0" align="center" >
                                        ...
                                        <tr><td>&nbsp;</td><td>&nbsp;</td><td colspan="3" id="val_mtype" style="color:red"></td></tr>
...
<?php include "footer/footer.html"; ?>
    ...
    $(function() {
     ...
     function DisplayPer(){
		...
		$.fn.validatemtype = function(event) {  
