...
if (isset($_POST["submit"])) {
     ...
     if((trim($_POST['subitemno']) != 0) && (trim($_POST['subitemno']) != ""))
     {
	 ...
	 else if((trim($_POST['subsubsubitemno']) != 0) && (trim($_POST['subsubsubitemno']) != ""))
     {
    ...
    header('Location: ViewMeasurementEntryList_Inactive.php?TempVal='.$temp);
                    ...
                    {   
                        ...
                        for (i = 1, j = b; i < a, j < c; i++, j++)
                        {
                           ...
                           // if(name[j].length > 2)
                            //{
                                var sitem = name[j].split(".");
                                var sub = sitem[0] +"."+ sitem[1] +"."+ sitem[2];
                                if(sitem.length > 3)
                                {
                                   // if(sssitem == sub)
                                   // {
                            ...
                            <div class="title">View Measurement Entry</div>		
                                ...
                                <div class="container">
                                    <table width="1078" border="1" cellpadding="0" cellspacing="0" align="center" >
                                        ...
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td  class="label" width="17%" nowrap="nowrap">Work Order No.</td>
                                            <td class="label">
                                               <?php 
