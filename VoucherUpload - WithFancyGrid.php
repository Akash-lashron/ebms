...
<link href="css/CustomFancyStyle.css" rel="stylesheet">
    <body class="page1" id="top" oncontextmenu="return false"onload="noBack();" onpageshow="if (event.persisted) noBack();" onUnload="">
        ...
        <!--==============================Content=================================-->
        <div class="content">
			<div class="title">Voucher Upload</div>
                        ...
                        <form name="form" method="post" action="PartPaymentPageView.php">
							...
							<div class="div12 card-div">
								<div class="div4 card-div-body">
									<div class="top-card">
										...
										<div class="top-card-container">
											<label for="name" class="card-label">Vocher Upload</label>
											<div><input type="text" name="name" id="name" class="card-label-tbox"></div>
										</div>
									</div>
								</div>
								<div class="div4 card-div-body">
									<div class="top-card">
										<div class="top-card-container">
											<label for="name" class="card-label">Voucher Entry</label>
											<div><input type="text" name="name" id="name" class="card-label-tbox"></div>
										</div>
									</div>
								</div>
								<div class="div4 card-div-body">
									<div class="top-card">
										<div class="top-card-container">
											<label for="name" class="card-label">Voucher View & Edit</label>
											<div>
												<input type="text" name="name" id="name" class="card-label-tbox"> 
												<input type="text" name="name" id="name" class="card-label-tbox">
											</div>
										</div>
									</div>
