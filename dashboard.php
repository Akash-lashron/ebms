...
<body class="page1" id="top">
 <!--==============================header=================================-->
  ...
  <!--==============================Content=================================-->
  <div class="content">
  <?php if($_SESSION['staff_section'] == 2){ ?>
...
?>
	...
	<div style="width:100%; height:97%" class="">
		<img src="images/accounts_bg.jpg" height="97%" width="100%">
	</div>
<?php
...
$ExpMajorStr = explode("@@@",$MajorWorkListStr);
$ExpMinorStr = explode("@@@",$MinorWorkListStr);
if(in_array($sheetid, $ExpMajorStr)){
	$MaxW = 1;
}
if(in_array($sheetid, $ExpMinorStr)){
	$MinW = 1;
}
?>
<div class="panel-group" id="accordion4" role="tablist" aria-multiselectable="true">
	<div class="panel panel-default">
    	<div class="panel-heading" role="tab" id="headingOne4" style="margin-bottom: 2px;">
			...
			<?php }else{ ?>
            	<a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion4" href="#collapseOne4" aria-expanded="false" aria-controls="collapseOne4">
			<?php } ?>
                	<i class="icon fa fa-globe" style="color:#0061C1"></i>
                    Major Works
                </a>
            </h4>
        </div>
            ...
            <?php
				...
				for($x2=0; $x2<count($ExpMajorStr); $x2+=2)
				{
					...
					if($MajorWorkId != "")
					{
						...
						{ 
							$workname = $MajorWorkName;
							$Majorbackcolor = "style='background-color:#fff;'";
						} 
						else 
						{ 
							$Majorbackcolor = ""; 
    ...
    <div class="panel panel-default">
        <div class="panel-heading" role="tab" id="headingTwo4">
        	<h4 class="panel-title" style="padding-top:5px;">
			<?php if($MinW == 1){ ?>
            	<a role="button" data-toggle="collapse" data-parent="#accordion4" href="#collapseTwo4" aria-expanded="true" aria-controls="collapseTwo4">
			<?php }else{ ?>
            ...
            <?php	
				...
				for($x3=0; $x3<count($ExpMinorStr); $x3+=2)
				{
					...
					if($MinorWorkId != "")
					{
						...
						{ 
							$workname = $MinorWorkName;
							$Minorbackcolor = "style='background-color:#fff;'";
						} 
						else 
						{ 
							$Minorbackcolor = ""; 
...
$alet_msg .= "<tr><td align='center'> MBook No. ".$mbookno_status."</td><td align='left'>".getzonename($sheetid_status,$zone_id_status).$mtype_status_print."</td><td style='color:red;'>".$ab_status.$Abstract_comment_print."</td></tr>";									
 ...
 <style>
	...
	h4.panel-title{margin:0px 0px !important;}
