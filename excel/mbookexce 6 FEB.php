    ...
    INNER JOIN subdivision     ON (mbook_header.subdiv_id = subdivision.subdiv_id)";
                $sqlquery = mysql_query($query);
				 ...
				 $objPHPExcel->getActiveSheet()->getStyle('A'.$currentcell.':I'.$currentcell)->getBorders()->getAllBorders()->setBorderStyle(PHPExcel_Style_Border::BORDER_THIN);
                     ...
                     if ($sdivid != $List->subdiv_id) {
                          if($First == 2) {
                            ...
                            $objPHPExcel->setActiveSheetIndex(0)->setCellValue('G'.$currentcell,"C/o to P6/MB79");
                            if($page == 4){$objPHPExcel->setActiveSheetIndex(0)->setCellValue('J'.$currentcell,"Page :". $page);$page =$page+1;}
                            else if($page == 5){$objPHPExcel->setActiveSheetIndex(0)->setCellValue('J'.$currentcell,"Page :". $page);$currentcell=$currentcell+1; }
                 ...
                 $currentcell=$currentcell+26;
                  $objPHPExcel->setActiveSheetIndex(0)->setCellValue('C'.$currentcell,"Summarty");
                  $currentcell=$currentcell+1;
                  $currentcell=$currentcell+26;
