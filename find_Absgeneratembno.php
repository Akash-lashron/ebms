...
$mbookquery = "SELECT    agreementmbookallotment.allotmentid,    agreementmbookallotment.mbno
                          FROM   mbookallotment
                            ...
                            WHERE mbookallotment.active=1 AND agreementmbookallotment.active = 1 AND mbookallotment.flag = 1 AND mbookallotment.sheetid = '$sheetid' AND mbookallotment.staffid = '$staffid' ORDER BY mbookallotment.mballotmentid ASC";
