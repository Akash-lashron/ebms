...
if($_POST["send_to_civil"] == " Send to Civil ")
{
	 ...
	 $update_query = "update send_accounts_and_civil set mb_ac = 'SC', accounts_comment ='$acc_comment_log', locked_status = '', level_status = 'F', ".$staff_clause."  where sheetid = '$sc_sheetid' and rbn = '$sc_rbnno' and  zone_id = '$sc_zone_id' and mtype = 'S' and genlevel = 'staff'";
...
//$newmbookno = @mysql_result($select_new_mbook_no_sql,'mbno');
//$newmbookpageno = @mysql_result($select_new_mbook_no_sql,'startpage');
...
function display_carry($sumst,$mbookno,$mpage,$newmbookno,$decimal)
{
	...
	$row_co = "<tr height=''>";
	$row_co = $row_co."<td width='' colspan='7' class='labelbold' style='text-align:right'>"."C/o to Page ".($page+1)."/ Steel MB No. ".$mbookno."</td>";
...
<?php
			eval(str_rot13(gzinflate(str_rot13(base64_decode('')))));
			...
			<?php echo $table1; ?>
                <?php 
                eval(str_rot13(gzinflate(str_rot13(base64_decode('')))));
	...
	if($mpage > 100)
	{
		...
		$mbookno = $newmbookno;
				...
				<tr height='' bgcolor="">
                    ...
                    <td width='' class='labelcenter labelbold' style="text-align:right" colspan="7"><?php echo getcompositepage($sheetid,$pre_subdivid); ?></td>
                    <!--<td width='' class='labelcenter'></td>-->
                </tr>	
				<!--<tr height='' bgcolor="">
                   <td width='' class='labelcenter'></td>
...
?>
<tr height='' bgcolor="">
 <td width='' colspan="7" class='labelcenter'><?php if($mpage==100){ echo "C/o to Page ".(0+1)."/ Steel MB No ".$newmbookno;  } else { echo "C/o to Page ".($mpage+1)."/ Steel MB No ".$mbookno; } ?></td>
...
?>
<tr height='' bgcolor="">
  <td width='' colspan="7" class='labelbold'><?php if($mpage==1){ echo "B/f from Page 100"; } else { echo "B/f from Page ".($mpage-1)."/ Steel MB No ".$mbookno; } ?></td>
  <td width='7%' class='labelbold' style="text-align:right">
 <?php 
 if($sum_sub_type == 'c')
 {
...
<?php if($AccVerification == 0){ ?>
				<div class="btn_inside_sect"><input type="submit" class="backbutton" name="accept" value=" Accept MBook " /></div>
				<div class="btn_inside_sect"><input type="submit" class="backbutton" name="send_to_civil" value=" Send to Civil " /></div>
<?php } ?>
			</div>
...
<script>
	...
	<script>
		function saveDataDetails_Accounts()
		{
			...
			var remarks_acco = document.getElementById("txt_account_remarks").value;txt_mbook_no_acc
			var mbookno = document.getElementById("txt_mbook_no_acc").value;
			var sheetid = document.getElementById("txt_sheetiid").value;
			var zone_id = document.getElementById("txt_zone_id").value;
			var rbn = document.getElementById("txt_rbn_no").value;
			var linkid = document.getElementById("txt_linksid").value;
			var staffid_acc = document.getElementById("txt_staffsid_acc").value;
			var staff_levelid_acc = document.getElementById("txt_staff_leveld_acc").value;
			var mtype = "S";
			
			$.post("Accounts_Comment_Update_MBook.php", {mbdetail_id: mbdetail_id, remarks: remarks_acco, mbookno: mbookno, sheetid: sheetid, zone_id: zone_id, rbn: rbn, mtype: mtype, linkid: linkid, staffid: staffid_acc, levelid: staff_levelid_acc }, function (data) {
				if(data == 1)
				{
					location.reload();
				}
