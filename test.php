                                ...
                                <table width="100%"  bgcolor="#E8E8E8" border="0" cellpadding="0" cellspacing="0" align="center" >
									...
									<tr>
										<td>&nbsp;</td> 
									 	...
									 	<td  class="labeldisplay">
											<select name="cmb_shortname" id="cmb_shortname" onChange="workorderdetail()" class="textboxdisplay" style="width:470px;height:22px;" tabindex="7">
									...
									<tr>
										<td>&nbsp;</td> 
									 	...
									 	<td  class="labeldisplay">
											<select name="cmb_act" id="cmb_act"  class="textboxdisplay" style="width:470px;height:22px;" tabindex="7">
									...
									<tr>
										<td>&nbsp;</td> 
									 	...
									 	<td  class="labeldisplay">
											<select name="cmb_item" id="cmb_item"  class="textboxdisplay" style="width:470px;height:22px;" tabindex="7">
									...
									<tr>
										<td>&nbsp;</td> 
									 	...
									 	<td  class="labeldisplay">
											<select name="cmb_disp" id="cmb_disp"  class="textboxdisplay" style="width:470px;height:22px;" tabindex="7">
									...
									<tr>
										<td>&nbsp;</td> 
									 	...
									 	<td  class="labeldisplay">
											<select name="cmb_plant" id="cmb_plant"  class="textboxdisplay" style="width:470px;height:22px;" tabindex="7">
